...
/*  TRACEABILITY : [cover parentID=SAS_AS_CRC022,SAS_AS_CRC024,AUTOSAR:12911,
                    ...
                    DS_NAS_CRC_PR131,SAS_NAS_ALL_PR70,SAS_NAS_ALL_PR749,
                    SAS_NAS_ALL_PR1652,
                    DS_AS_CRC005,DS_AS_CRC013,DS_AS_CRC036,DS_AS_CRC037,
                    DS_AS_CRC039,DS_AS_CRC009,
                    DS_NAS_CRC_PR228,DS_AS_CRC023,
                    DS_NAS_CRC_PR912,DS_NAS_CRC_PR123,
                    SAS_NAS_ALL_PR630_PR631,DS_NAS_CRC_PR730,
                    DS_AS403_CRC041,SAS_NAS_ALL_PR128,SAS_MCAL_CRC_0446,
                    SAS_MCAL_CRC_0448]
                    [/cover]                                                 */
/*******************************************************************************
**                      Includes                                              **
*******************************************************************************/
  ...
  #include "Crc.h"
  /* Inclusion of Safety Error ReCRC file */  
...
*******************************************************************************/
 /*macros */
  ...
  #define CRC_REG_CLEAR_MASK (0x00000000U)
...
/*Crc 32bit polynomial=0x04C11DB7 table initialization*/
   ...
   is allowed only for MemMap.h*/
    #include "MemMap.h"
    /*IFX_MISRA_RULE_08_07_STATUS=since data size is more its 
    not declared inside function */
...
** Traceability   :  [cover parentID=DS_AS403_CRC030,DS_AS403_CRC031,
        DS_AS403_CRC014,DS_AS403_CRC032,
      DS_AS403_CRC033,DS_MCAL_CRC_0447_1]                                     
      [/cover]                                                                
...
DS_AS403_CRC043,DS_MCAL_CRC_0447_2,DS_AS_CRC044]         
[/cover]
...
** Traceability   : [cover parentID=DS_AS_CRC002,DS_AS_CRC015,DS_AS403_CRC019,
    DS_AS_CRC002,
    DS_AS_CRC003,DS_AS_CRC015,DS_MCAL_CRC_0447_3]
[/cover]
...
#ifdef CRC_32_MODE
/*******************************************************************************
** Traceability   : [cover parentID=DS_AS_CRC003,DS_AS_CRC016,
          DS_AS403_CRC020,DS_AS_CRC010,
          DS_AS_CRC016,DS_MCAL_CRC_0447_4]                               
[/cover]
...
*******************************************************************************/
  ...
  uint32 Crc_Length,   uint8 Crc_StartValue8, uint8 Polynomial_8bit)
  {
    ...
    for (LoopCounter = CRC_LOOPCNT_MSGBYTE_INIT_VAL; LoopCounter < Crc_Length; 
         LoopCounter++)
    { 
    /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to access next 
    element of data*/
...
*******************************************************************************/
  ...
  #elif (CRC_8_MODE == CRC_HARDWARE_MODE)
/*******************************************************************************
** Traceability : [cover parentID=DS_MCAL_HE1_CRC_0443_1,DS_MCAL_HE2_CRC_0443_1,
                       DS_MCAL_HE1_CRC_0444_1,DS_MCAL_HE2_CRC_0444_1]
[/cover]
**                                                                            **
...
*******************************************************************************/
  ...
  uint32 Crc_Length, uint8 Crc_StartValue8,   boolean Crc_IsFirstCall)
  {
    ...
    uint8 CRC_RegBackup;
    uint8 Temp;
    CRC_RegBackup = (uint8)(CRC_SFR_RUNTIME_USER_MODE_READ32(FCE0_IN3_CRC.U)   \
      & (((uint32)IFX_FCE_IN3_CRC_CRC_MSK) << IFX_FCE_IN3_CRC_CRC_OFF));
    /* code for crc 8 hardware calculaion for 0x1D polynomials*/
   
    /*Configure CRC register*/
    if (Crc_IsFirstCall == (boolean)TRUE)
    {
      CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN3_CRC.U, CRC_INITIAL_VALUE8);
    }
    else
    {
      Temp = (uint8)(Crc_StartValue8 ^ CRC_CRC8_XOR_VALUE);
      CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN3_CRC.U, Temp);
    }
    ...
    /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to access next 
    element of data*/
      CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN3_IR.U,                         \
                                             (uint32)Crc_DataPtr[LoopCounter]);
    }
    Crc_StartValue8 = (uint8)(CRC_SFR_RUNTIME_USER_MODE_READ32(FCE0_IN3_RES.U) \
             & ((uint32)(IFX_FCE_IN3_RES_RES_MSK) << IFX_FCE_IN3_RES_RES_OFF));
  
    CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN3_CRC.U, CRC_RegBackup);
...
*******************************************************************************/
  ...
  #elif (CRC_16_MODE == CRC_HARDWARE_MODE)
/*******************************************************************************
** Traceability : [cover parentID=DS_MCAL_HE1_CRC_0443_2,DS_MCAL_HE2_CRC_0443_2,
                       DS_MCAL_HE1_CRC_0444_2,DS_MCAL_HE2_CRC_0444_2]
[/cover]
**                                                                            **
...
*******************************************************************************/
  ...
  uint32 Crc_Length,  uint16 Crc_StartValue16, boolean Crc_IsFirstCall)
  {
    ...
    CRC_RegBackup = (uint16)(CRC_SFR_RUNTIME_USER_MODE_READ32(FCE0_IN2_CRC.U)  \
             & ((uint32)(IFX_FCE_IN2_CRC_CRC_MSK) << IFX_FCE_IN2_CRC_CRC_OFF));
    ...
    if (Crc_IsFirstCall == (boolean)TRUE)
    {
      CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN2_CRC.U, CRC_INITIAL_VALUE16);
    }
    else
    {
      temp = Crc_StartValue16 ^ CRC_CRC16_XOR_VALUE;
      CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN2_CRC.U, temp);
    }
         ...
         CRC_TWO_U)
    {
      ...
      CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN2_IR.U, (uint32)tempVal);
    }
    Crc_StartValue16 = (uint16)(CRC_SFR_RUNTIME_USER_MODE_READ32               \
    (FCE0_IN2_RES.U) & 
                ((uint32)(IFX_FCE_IN2_RES_RES_MSK) << IFX_FCE_IN2_RES_RES_OFF));
    

    CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN2_CRC.U, CRC_RegBackup);
    return Crc_StartValue16;
  }
  #endif
...
*******************************************************************************/
  ...
  #elif  (CRC_32_MODE == CRC_HARDWARE_MODE)
/*******************************************************************************
** Traceability : [cover parentID=DS_MCAL_HE1_CRC_0443_3,DS_MCAL_HE2_CRC_0443_3,
                       DS_MCAL_HE1_CRC_0444_3,DS_MCAL_HE2_CRC_0444_3]
[/cover]
**                                                                            **
...
*******************************************************************************/
  ...
  uint32 Crc_Length, uint32 Crc_StartValue32, boolean Crc_IsFirstCall)
  {
    ...
    CRC_RegBackup = (uint32)(CRC_SFR_RUNTIME_USER_MODE_READ32                  \
    (FCE0_IN0_CRC.U) & (IFX_FCE_IN0_CRC_CRC_MSK << IFX_FCE_IN0_CRC_CRC_OFF));
    /* code for crc 32 hardware calculaion with 0x04C11DB7 polynomial*/    
    /*Configure CRC register*/
    if (Crc_IsFirstCall == (boolean)TRUE)
    {
      CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN0_CRC.U, CRC_INITIAL_VALUE32);
    }
    else
    {
      Crc_StartValue32 = Crc_StartValue32 ^ CRC_CRC32_XOR_VALUE;
      temp = (uint32)(Crc_lReflectCRC32(Crc_StartValue32,
      CRC_BITCNT_THIRTYTWO));
      CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN0_CRC.U, temp);
    }
 ...
 /*IFX_MISRA_RULE_17_04_STATUS=Pointer arithmetic is used to access next 
       ...
       CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN0_IR.U, tempVal);
    }
    Crc_StartValue32 = CRC_SFR_RUNTIME_USER_MODE_READ32(FCE0_IN0_RES.U);
    /*restore CRC reg to ensure reentrancy*/   
    CRC_SFR_RUNTIME_USER_MODE_WRITE32(FCE0_IN0_CRC.U, CRC_RegBackup); 
 ...
 #if (CRC_SAFETY_ENABLE == STD_ON) 
/******************************************************************************
** Traceability     : [cover parentID=DS_MCAL_CRC_0447_5]
[/cover]
** Syntax : static uint8  Crc_lCrcCalculationSafetyCheck                     **
**                                  (                                        **
**                                    const uint8* Crc_DataPtr               **
**                                    boolean Crc_IsFirstCall                **
**                                    uint32 Crc_Length                      **
...
{
  /* Verify any error is there for safety reCRC */  
  uint8 ErrorFlag;      
