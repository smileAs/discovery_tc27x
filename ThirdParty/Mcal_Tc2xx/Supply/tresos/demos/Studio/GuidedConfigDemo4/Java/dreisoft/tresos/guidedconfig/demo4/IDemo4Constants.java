 ...
 * @since 2009.a
 */
public interface IDemo4Constants {

    // page IDs
    public static final String PAGE_ID_0 = "DemoMultiPage";
    ...
    public static final String WIDGET_ID_BROWSER = "Browser";
    public static final String MEMEMTO_KEY_BROWSER = WIDGET_ID_BROWSER;

    public static final String WIDGET_ID_BUTTON = "Button";
    public static final String MEMEMTO_KEY_BUTTON = WIDGET_ID_BUTTON;
     ...
     * @since 2010.a
     */
    public static final SWTColumnDescription TABLE_COLUMN_DESCRIPTION_FLOAT = new SWTColumnDescription(
        MyEclipseNLS.LABEL_FLOAT(),
        IDemo4Constants.MEMENTO_COLUMN_FLOAT,
        WidgetFactory.TextFormat.FLOAT,
        -1,
        "1.1" );
     ...
     * @since 2010.a
     */
    public static final SWTColumnDescription TABLE_COLUMN_DESCRIPTION_COMBO = new SWTColumnDescription(
        MyEclipseNLS.LABEL_COMBO(),
        IDemo4Constants.MEMENTO_COLUMN_COMBO,
        100,
     ...
     * @since 2010.a
     */
    public static final SWTColumnDescription TABLE_COLUMN_DESCRIPTION_BOOL = new SWTColumnDescription(
        MyEclipseNLS.LABEL_BOOL(),
        IDemo4Constants.MEMENTO_COLUMN_BOOL,
     ...
     * @since 2010.a
     */
    public static final SWTColumnDescription TABLE_COLUMN_DESCRIPTION_STRING = new SWTColumnDescription(
        MyEclipseNLS.LABEL_TEXT(),
        IDemo4Constants.MEMENTO_COLUMN_STRING,
     ...
     * @since 2010.a
     */
    public static final SWTColumnDescription TABLE_COLUMN_DESCRIPTION_INT = new SWTColumnDescription(
        MyEclipseNLS.LABEL_INT(),
        IDemo4Constants.MEMENTO_COLUMN_INT,
     ...
     * @since 2010.a
     */
    public static final SWTTreeColumnDescription TREE_COLUMN_DESCRIPTION_DESC = new SWTTreeColumnDescription(
        MyEclipseNLS.LABEL_COLUMN_DESC(),
        IDemo4Constants.MEMENTO_COLUMN_DESC,
