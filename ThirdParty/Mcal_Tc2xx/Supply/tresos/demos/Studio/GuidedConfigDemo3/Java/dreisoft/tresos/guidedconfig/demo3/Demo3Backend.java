...
public class Demo3Backend extends AbstractBackend {
    ...
    public List<APIOperationStatus> doRun() {
        ...
        if( !rootMemento.getBoolean( Demo3Page.MEMENTOID_CHECKBOX ) ) return messages;
        ...
        if( targetConfigurationContext == null ) throw new IllegalArgumentException(
    ...
    public List<DCtxt> getChangedNodes() {
        ...
        if( m_pushEvent == null ) return changedNodes;
