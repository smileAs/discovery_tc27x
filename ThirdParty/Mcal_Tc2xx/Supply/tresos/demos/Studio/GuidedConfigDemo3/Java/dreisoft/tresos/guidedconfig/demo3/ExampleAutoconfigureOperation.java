 ...
 * All rights reserved
 *
 * NAME: test.tresos.plugin.guidedconfig.pushservice.operation.ExampleAutoconfigureOperation
 */
 ...
 * 
 * <p>
 * This operation serves the {@link Demo3Backend} to write to the project configuration.
 * </p>
 * 
 * <p>
...
public class ExampleAutoconfigureOperation extends AbstractConfigurablePushOperation {
     ...
     * 
     *        <p>
     *        The demo implementation serves the {@link Demo3Backend}.
     *        </p>
     * 
    ...
    public void doInvoke( AbstractPushEvent event ) {
        if( !(event instanceof ExampleAutoconfigureEvent) ) return;
