...
**                                                                           **
******************************************************************************/
/*  TRACEABILITY: [cover parentID=DS_AS_GPT278,DS_NAS_GPT_PR228,
    DS_NAS_GPT_PR912_1,DS_NAS_GPT_PR912_2,DS_NAS_GPT_PR912_3,
    DS_NAS_GPT_PR624_PR759_PR760_PR761,DS_AS_HisGen0001,SAS_NAS_ALL_PR749,
    SAS_NAS_ALL_PR128,SAS_NAS_ALL_PR630_PR631,SAS_NAS_ALL_PR471,
    SAS_NAS_ALL_PR470,SAS_NAS_ALL_PR70,SAS_NAS_ALL_PR1652,SAS_NAS_GPT_PR734]
**                                                                            **
**                                                                            **
**  [/cover]                                                                  */
/*******************************************************************************
...
#define ATOM_AGC_ENDIS_CTRL_MASK   (0x0000FFFFU)
...
#if (GPT_ONESHOT_USED == STD_ON)
IFX_LOCAL_INLINE void Gpt_lGtmHandleOsm(
                               Gpt_ChannelType Channel);
#endif
/*End of #if (GPT_ONESHOT_USED == STD_ON)*/
...
#if (GPT_ONESHOT_USED == STD_ON)
IFX_LOCAL_INLINE boolean Gpt_lModeOsm(Gpt_ModeType ChannelMode);
#endif
/*End of #if (GPT_ONESHOT_USED == STD_ON)*/

#if (GPT_ENABLE_DISABLE_NOTIFICATION_API == STD_ON)
IFX_LOCAL_INLINE uint8 Gpt_lGetNotifFlag(Gpt_ChannelType Channel);
IFX_LOCAL_INLINE boolean Gpt_lCheckForNotifCall(uint8 NotifFlag);
#endif
...
/*IFX_MISRA_RULE_08_07_STATUS= "Gpt_ChannelIndex" varaible is made extern
  in Gpt_Local.h, This violation is reported incorrectly by PC-lint tool*/
...
/*start unspecified size variable section*/
...
/*stop unspecified size variable section*/
...
/*IFX_MISRA_RULE_19_01_STATUS=File inclusion after pre-processor directives
  is allowed only for MemMap.h*/
#include "MemMap.h"
/*IFX_MISRA_RULE_08_07_STATUS= "Gpt_AsilChannelStatus" varaible is made extern
  in Gpt_Local.h, This violation is reported incorrectly by PC-lint tool*/
...
/*IFX_MISRA_RULE_19_01_STATUS=File inclusion after pre-processor directives
  is allowed only for MemMap.h*/
#include "MemMap.h"
/*IFX_MISRA_RULE_08_07_STATUS= "Gpt_QMChannelStatus" varaible is made extern
  in Gpt_Local.h, This violation is reported incorrectly by PC-lint tool*/
...
** Traceability : [cover parentID=DS_AS_GPT280_GPT257,DS_AS_GPT006_GPT068,
   ...
   DS_MCAL_GPT_500,DS_MCAL_GPT_502_1]
...
** Traceability : [cover parentID=DS_AS_GPT286,DS_AS_GPT117,
   ...
   DS_AS40X_GPT332_8,DS_AS_GPT275_1_GPT014,DS_MCAL_GPT_502_6]
...
** Traceability : [cover parentID=DS_AS_GPT287,DS_AS_GPT118,
   ...
   DS_AS_GPT015,DS_AS40X_GPT332_9,DS_MCAL_GPT_502_7]
...
** Traceability : [cover parentID=DS_AS_GPT282,DS_AS_GPT113,
   ...
   DS_AS40X_GPT332_4,DS_AS40X_GPT297_1,DS_AS40X_GPT299_1,DS_MCAL_GPT_502_2,
...
** Traceability : [cover parentID=DS_AS_GPT283,DS_AS_GPT114,
   ...
   DS_AS40X_GPT211_GPT223_GPT332_5,DS_MCAL_GPT_502_3,DS_AS321_GPT302,
...
** Traceability : [cover parentID=DS_AS_GPT288,DS_AS_GPT176_12_GPT231_GPT178_12,
   ...
   DS_MCAL_GPT_502_8,DS_MCAL_GPT_504]
...
** Traceability : [cover parentID=DS_AS_GPT289,DS_AS_GPT155,,
   ...
   DS_AS40X_GPT332_11,DS_AS_GPT157,DS_AS_GPT158,DS_MCAL_GPT_502_9]
...
** Traceability : [cover parentID=DS_AS_GPT290,DS_AS_GPT156,
   ...
   DS_AS_GPT230_2_GPT178,DS_AS40X_GPT332_12,DS_MCAL_GPT_502_10]
...
**                                   Gpt_ChannelType Channel,uint8 Gpt_Sid)   **
**                                                                            **
** Sync/Async: Synchronous                                                    **
**                                                                            **
** Reentrancy:  reentrant                                                     **
                         ...
                         uint8 InterruptFlag)
{
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_TOM_MODULE)
  {
    ...
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((TomChannelRegPtr->IRQ_EN.U), 0UL);
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((TomChannelRegPtr->IRQ_NOTIFY.U), \
                                                         GPT_CLEAR_INTERRUPTS);
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((TomChannelRegPtr->IRQ_EN.U), \
                                                                InterruptFlag);
  }
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_ATOM_MODULE)
  {
    ...
    /* Interrupts are disabled before clearing the notify bits so that any
    interruption after clearing the notify doesn't set the notify bits again*/
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((AtomChannelRegPtr->IRQ_EN.U),0UL);
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((AtomChannelRegPtr->IRQ_NOTIFY.U), \
                                                  GPT_CLEAR_INTERRUPTS);
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((AtomChannelRegPtr->IRQ_EN.U), \
                                                  InterruptFlag);
  }
...
#if (GPT_SAFETY_ENABLE == STD_ON)
/*******************************************************************************
** Syntax :static void Gpt_lSafeCheckMode(Gpt_ChannelType Channel)            **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
** Sync/Async:       Synchronous                                              **
...
static void Gpt_lSafeCheckMode(Gpt_ChannelType Channel)
{
  ...
  uint8 ChannelNumber;
    ...
    if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_TOM_MODULE)
    {
        ...
        InterruptFlag = (uint32)(GPT_SFR_RUNTIME_USER_MODE_READ32\
                                    (TomChannelRegPtr->IRQ_EN.U) & IRQ_EN_MASK);
        if( InterruptFlag != 1U)
        {
            /* Report Safety Error */
            SafeMcal_ReportError( GPT_MODULE_ID, GPT_INSTANCE_ID,
    ...
    if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_ATOM_MODULE)
    {
        ...
        /* Check if the IRQ bit is set */
        InterruptFlag = (uint32)(GPT_SFR_RUNTIME_USER_MODE_READ32\
                          (AtomChannelRegPtr->IRQ_EN.U) & IRQ_EN_MASK);
        if( InterruptFlag != 1U)
        {
            /* Report Safety Error */
            SafeMcal_ReportError( GPT_MODULE_ID, GPT_INSTANCE_ID,
...
** Syntax : static void Gpt_lChannelInit(void)                                **
** [/cover]                                                                   **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
...
for(Channel = 0U; Channel < Gpt_kConfigPtr->GptMaxChannels; Channel++)
{
    ...
    if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_TOM_MODULE)
    {
        ...
        GPT_SFR_INIT_USER_MODE_WRITE32((TomChannelRegPtr->CTRL.U),
        ((unsigned_int)((uint32)(LocalGptChannelPtr->ClockSelect) <<  \
                                                        CLOCK_DIV_POS)));
    }
    ...
    if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_ATOM_MODULE)
    {
        ...
        GPT_SFR_INIT_USER_MODE_WRITE32((AtomChannelRegPtr->CTRL.U),
        ((unsigned_int)((uint32)(LocalGptChannelPtr->ClockSelect) <<  \
                                              CLOCK_DIV_POS) | SOMP_BIT_POS));
    }
    ...
    #endif
    {
        ...
        QMIndex++;
    #endif
      /*if GPT_MAX_QM_CHANNELS is 0, do nothing*/
    }
...
#if (GPT_ONESHOT_USED == STD_ON)
/*******************************************************************************
** Syntax:static void Gpt_lGtmSetOsm(Gpt_ChannelType Channel)                 **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
** Sync/Async:       Synchronous                                              **
...
static void Gpt_lGtmSetOsm(Gpt_ChannelType Channel)
{
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_TOM_MODULE)
  {
    ...
    GPT_SFR_INIT_USER_MODE_MODIFY32((TomChannelRegPtr->CTRL.U), GPT_CLEARMASK,\
                                   ((unsigned_int)(1UL << GPT_GTM_CTRL_OSM)))
    /* Clear any pending interrupt */
    GPT_SFR_INIT_USER_MODE_WRITE32((TomChannelRegPtr->IRQ_NOTIFY.U),\
                                                        GPT_CLEAR_INTERRUPTS);
    /* Enable CCU0 Interrupt */
    GPT_SFR_INIT_USER_MODE_WRITE32((TomChannelRegPtr->IRQ_EN.U), 1UL);
  }
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_ATOM_MODULE)
  {
    ...
    /*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access.
    Permitted for special function registers.*/
    GPT_SFR_INIT_USER_MODE_MODIFY32(((*(Ifx_GTM_ATOMx*)(void*)\
      (MODULE_GTM.ATOM)).ATOM_CH[ModuleNo].CH[ChannelNo].CTRL.U),\
      GPT_CLEARMASK,((unsigned_int)(1UL << GPT_GTM_CTRL_OSM)))
    /* Clear any pending interrupt */
    /*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access.
    Permitted for special function registers.*/
    GPT_SFR_INIT_USER_MODE_WRITE32(((*(Ifx_GTM_ATOMx*)(void*)(MODULE_GTM.ATOM)).
...
static void Gpt_lGtmStopTimer(Gpt_ChannelType Channel)
{
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_TOM_MODULE)
  {
    ...
    /*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access.
    Permitted for special function registers.*/
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((((*(Ifx_GTM_TOMx*)(void*)\
            (MODULE_GTM.TOM)).TOM_TGC[ModuleNo]).TGC[GroupNo].ENDIS_STAT.U),\
            RegVal);
    /*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access.
    Permitted for special function registers.*/
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((((*(Ifx_GTM_TOMx*)(void*)\
            (MODULE_GTM.TOM)).TOM_TGC[ModuleNo]).TGC[GroupNo].ENDIS_CTRL.U),\
            (((unsigned_int)(~(RegValForCtrl))) & TOM_TGC_ENDIS_CTRL_MASK));
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_ATOM_MODULE)
  {
    ...
    /*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access.
    Permitted for special function registers.*/
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((((*(Ifx_GTM_ATOMx*)(void*)\
      (MODULE_GTM.ATOM)).ATOM_AGC[ModuleNo]).AGC_ENDIS_STAT.U),RegVal);
    /*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access.
    Permitted for special function registers.*/
    GPT_SFR_RUNTIME_USER_MODE_WRITE32(((*(Ifx_GTM_ATOMx*)(void*)\
      (MODULE_GTM.ATOM)).ATOM_AGC[ModuleNo].AGC_ENDIS_CTRL.U),\
      (((unsigned_int)(~(RegValForCtrl))) & TOM_TGC_ENDIS_CTRL_MASK));
  }
                            ...
                            Gpt_ChannelType Channel)
{
  ...
  {
    /*Read CM0 value*/
    Cm0Val = GPT_SFR_RUNTIME_USER_MODE_READ32(TomChannelRegPtr->CM0.U);
    /*Read CN0 value*/
    Cn0Val = GPT_SFR_RUNTIME_USER_MODE_READ32(TomChannelRegPtr->CN0.U);
    ...
    #if (GPT_ONESHOT_USED == STD_ON)
    NotifyStatus =  (uint8)(GPT_SFR_RUNTIME_USER_MODE_READ32\
                                        (TomChannelRegPtr->IRQ_NOTIFY.U) & 1U);

    OneShotModeStatus =((((uint32)GPT_SFR_RUNTIME_USER_MODE_READ32\
  ...
  {
    /*Read CM0 value*/
    Cm0Val = GPT_SFR_RUNTIME_USER_MODE_READ32(AtomChannelRegPtr->CM0.U);
    /*Read CN0 value*/
    Cn0Val = GPT_SFR_RUNTIME_USER_MODE_READ32(AtomChannelRegPtr->CN0.U);
    /* CN0 continues to count after reaching CM0. This is
       handled in the ISR. To avoid corner cases, due to ISR latency, the
       notify bit is also checked, and if it is set it would indicate the
       Timer count is complete */
    #if (GPT_ONESHOT_USED == STD_ON)
    NotifyStatus =  (uint8)(GPT_SFR_RUNTIME_USER_MODE_READ32(\
                             AtomChannelRegPtr->IRQ_NOTIFY.U) & 1U);
                           ...
                           Gpt_ChannelType Channel)
{
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_TOM_MODULE)
  {
    ...
    OneShotModeStatus = (((\
       (GPT_SFR_RUNTIME_USER_MODE_READ32(TomChannelRegPtr->CTRL.U)) &\
       (1UL << GPT_GTM_CTRL_OSM)) > 0UL )?(boolean)TRUE:(boolean)FALSE);
    /* CN0 continues to count after reaching CM0. This is
       handled in the ISR. To avoid corner cases, due to ISR latency, the
       notify bit is also checked, and if it is set it would indicate the
    ...
    if((OneShotModeStatus == (boolean)TRUE) && (NotifyStatus == 1U))
    {
      RetVal = GPT_SFR_RUNTIME_USER_MODE_READ32(TomChannelRegPtr->CM0.U);
    }
    else
    #endif
    /*End of #if (GPT_ONESHOT_USED == STD_ON)*/
    {
      /* Return CN0 value */
      RetVal = GPT_SFR_RUNTIME_USER_MODE_READ32(TomChannelRegPtr->CN0.U);
    }
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_ATOM_MODULE)
  {
    #if (GPT_ONESHOT_USED == STD_ON)
    OneShotModeStatus = (((\
       (GPT_SFR_RUNTIME_USER_MODE_READ32(AtomChannelRegPtr->CTRL.U)) &\
       (1UL << GPT_GTM_CTRL_OSM)) > 0UL )?(boolean)TRUE:(boolean)FALSE);
    ...
    NotifyStatus =  (uint8)(GPT_SFR_RUNTIME_USER_MODE_READ32(\
     ...
     if((OneShotModeStatus == (boolean)TRUE) && (NotifyStatus == 1U))
    {
      RetVal = GPT_SFR_RUNTIME_USER_MODE_READ32(AtomChannelRegPtr->CM0.U);
    }
    else
    #endif
    {
      /* Return CN0 value */
      RetVal = GPT_SFR_RUNTIME_USER_MODE_READ32(AtomChannelRegPtr->CN0.U);
    }
...
** Syntax :static Gtm_GptChannelStatusType Gpt_lGtmStartTimer (               **
**                           Gpt_ChannelType Channel                          **
**                           uint32 TimeOutVal                                **
**                                                    )                       **
** [/cover]                                                                   **
                                          ...
                                          )
{
  ...
  volatile unsigned_int *EndisPtr;           /* Holds Endis Register address*/
  #if (GPT_ONESHOT_USED == STD_ON)
  boolean OneShotModeStatus;                 /* Holds OSM status            */
  #endif
  uint8 ModuleNumber;                        /* Holds the module number     */
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_TOM_MODULE)
  {
    if((TimeOutVal <= GPT_GTM_TOM_TIMER_MAX) && (TimeOutVal > 0U))
    {
      ...
      #if (GPT_ONESHOT_USED == STD_ON)
      OneShotModeStatus = ((((GPT_SFR_RUNTIME_USER_MODE_READ32(\
             TomChannelRegPtr->CTRL.U)) &\
             (1UL << GPT_GTM_CTRL_OSM)) > 0UL )?(boolean)TRUE:(boolean)FALSE);
      #endif  /*End of #if (GPT_ONESHOT_USED == STD_ON)*/

    /* Clear CN0 register */
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((TomChannelRegPtr->CN0.U), 0U);
    /* Set CM0 with the Timeout value */
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((TomChannelRegPtr->CM0.U), TimeOutVal);
    ...
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((TomChannelRegPtr->SR0.U), TimeOutVal);
    /* Enable the Channel by setting the EndisStat and EndisCtrl register */
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((*EndisPtr), \
                        ((unsigned_int)(GPT_GTM_CHANNEL_ENABLE_UL <<  \
        (GPT_BITS_PER_CHANNEL * (ChannelNumber % GTM_TOM_CHANNELS_PER_TGC)))));

    /* Get address of TOMi_TGCx_ENDIS_CTRL register */
    EndisPtr = &(TomTgcRegPtr->ENDIS_CTRL.U);
    /* Update TOMi_TGCx_ENDIS_CTRL register. Reserve bit access is ensured*/
    GPT_SFR_RUNTIME_USER_MODE_WRITE32((*EndisPtr), (((unsigned_int)~(1UL <<  \
       (GPT_BITS_PER_CHANNEL * (ChannelNumber % GTM_TOM_CHANNELS_PER_TGC)))) & \
                                                      TOM_TGC_ENDIS_CTRL_MASK));
      #if (GPT_ONESHOT_USED == STD_ON)
  ...
  if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_ATOM_MODULE)
  {
    if((TimeOutVal <= GPT_GTM_ATOM_TIMER_MAX) && (TimeOutVal > 0U))
    {
     ...
     AtomChannelRegPtr =
      ...
      /* Clear CN0 register */
      GPT_SFR_RUNTIME_USER_MODE_WRITE32((AtomChannelRegPtr->CN0.U), 0U);
      /* Set CM0 with the Timeout value */
      GPT_SFR_RUNTIME_USER_MODE_WRITE32((AtomChannelRegPtr->CM0.U), TimeOutVal);
      /* Set Shadow register also with same TimeOut Value, this is a safety
      measure to avoid unintended update from shadow registers */
      GPT_SFR_RUNTIME_USER_MODE_WRITE32((AtomChannelRegPtr->SR0.U), TimeOutVal);
...
** Syntax :static void Gpt_lResetChannels (void)                              **
** [/cover]                                                                   **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
...
static void Gpt_lResetChannels(void)
{
  ...
  for(Channel = 0U; Channel < Gpt_kConfigPtr->GptMaxChannels; Channel++)
  {
    ...
    if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_TOM_MODULE)
    {
      ...
      GPT_SFR_DEINIT_USER_MODE_WRITE32((TomTgcRegPtr->ENDIS_STAT.U),\
            ((unsigned_int)(1UL << (GPT_BITS_PER_CHANNEL * \
            (ChannelNumber % GTM_TOM_CHANNELS_PER_TGC)))));
      /* Update TOMi_TGCx_ENDIS_CTRL register. Reserve bit access is ensured*/
      GPT_SFR_DEINIT_USER_MODE_WRITE32((TomTgcRegPtr->ENDIS_CTRL.U),\
            (((unsigned_int)(~(GPT_GTM_CHANNEL_ENABLE_UL << \
            (2U * (ChannelNumber % GTM_TOM_CHANNELS_PER_TGC))))) &\
            TOM_TGC_ENDIS_CTRL_MASK));
      GPT_SFR_DEINIT_USER_MODE_WRITE32((TomChannelRegPtr->CN0.U), 0U);
      GPT_SFR_DEINIT_USER_MODE_WRITE32((TomChannelRegPtr->CM0.U), 0U);
      /* Set Shadow register also with same value, this is a safety
         measure to avoid unintended update from shadow registers */
      GPT_SFR_DEINIT_USER_MODE_WRITE32((TomChannelRegPtr->SR0.U), 0U);
      GPT_SFR_DEINIT_USER_MODE_WRITE32((TomChannelRegPtr->CTRL.U), 0U);
      GPT_SFR_DEINIT_USER_MODE_WRITE32((TomChannelRegPtr->IRQ_EN.U), 0U);
      GPT_SFR_DEINIT_USER_MODE_WRITE32((TomChannelRegPtr->IRQ_NOTIFY.U), 0U);
    }
    if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_ATOM_MODULE)
    {
      /*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access.
        Permitted for special function registers.*/
      AtomChannelRegPtr = &((*(Ifx_GTM_ATOMx*)(void*)(MODULE_GTM.ATOM)).
                               ATOM_CH[ModuleNumber].CH[ChannelNumber]);
      /* Configure the channel parameters with Power on reset values*/
      /*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access.
        Permitted for special function registers.*/
      GPT_SFR_DEINIT_USER_MODE_WRITE32(((*(Ifx_GTM_ATOMx*)(void*)\
         (MODULE_GTM.ATOM)).ATOM_AGC[ModuleNumber].AGC_ENDIS_STAT.U),\
         ((unsigned_int)(1UL << (GPT_BITS_PER_CHANNEL * \
      ...
      Permitted for special function registers.*/
      GPT_SFR_DEINIT_USER_MODE_WRITE32(((*(Ifx_GTM_ATOMx*)(void*)\
       (MODULE_GTM.ATOM)).ATOM_AGC[ModuleNumber].AGC_ENDIS_CTRL.U),\
       (((unsigned_int)(~(GPT_GTM_CHANNEL_ENABLE_UL << (GPT_BITS_PER_CHANNEL *(\
        ChannelNumber % GTM_ATOM_CHANNELS_PER_AGC))))) &\
        ATOM_AGC_ENDIS_CTRL_MASK));
      /*IFX_MISRA_RULE_11_05_STATUS=volatile in terms of pointer access.
        Permitted for special function registers.*/
      GPT_SFR_DEINIT_USER_MODE_WRITE32((AtomChannelRegPtr->CM0.U), 0U);
      /* Set Shadow register also with same TimeOut Value, this is a safety
         measure to avoid unintended update from shadow registers */
      GPT_SFR_DEINIT_USER_MODE_WRITE32((AtomChannelRegPtr->SR0.U), 0U);
      GPT_SFR_DEINIT_USER_MODE_WRITE32((AtomChannelRegPtr->CTRL.U), 0U);
      GPT_SFR_DEINIT_USER_MODE_WRITE32((AtomChannelRegPtr->CN0.U), 0U);
      GPT_SFR_DEINIT_USER_MODE_WRITE32((AtomChannelRegPtr->IRQ_NOTIFY.U), 0U);
      }
...
** Traceability : NA                                                          **
**                                                                            **
** Syntax : static void Gpt_lSetChannelIdentifier                             **
...
#if (GPT_ONESHOT_USED == STD_ON)
/*******************************************************************************
** Syntax :IFX_LOCAL_INLINE void Gpt_lGtmHandleOsm(                           **
**                            Gpt_ChannelType Channel)                        **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
...
#if (GPT_ENABLE_DISABLE_NOTIFICATION_API == STD_ON)
/*******************************************************************************
** Syntax :IFX_LOCAL_INLINE uint8 Gpt_lGetNotifFlag(Gpt_ChannelType Channel)  **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
** Sync/Async:       Synchronous                                              **
...
/*******************************************************************************
** Syntax :IFX_LOCAL_INLINE boolean Gpt_lCheckForNotifCall(uint8 NotifFlag)   **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
** Sync/Async:       Synchronous                                              **
...
#if (GPT_ONESHOT_USED == STD_ON)
/*******************************************************************************
** Syntax :IFX_LOCAL_INLINE boolean Gpt_lModeOsm(Gpt_ModeType ChannelMode)    **
**                                                                            **
** Service ID:       none                                                     **
**                                                                            **
** Sync/Async:       Synchronous                                              **
...
#if (GPT_INITCHECK_API == STD_ON)
/*******************************************************************************
** Traceability    :   [cover parentID=DS_MCAL_GPT_501,
DS_MCAL_GPT_502_11,DS_NAS_GPT_PR123]                                          **
**                                                                            **
  ...
  if (Gpt_kConfigPtr == ConfigPtr)
  {
    ...
    for(Channel = 0U; Channel < Gpt_kConfigPtr->GptMaxChannels; Channel++)
    {
        ...
        if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_TOM_MODULE)
        {
            ...
            if (Gpt_lModeOsm(ChannelMode))
            {
              TempFlag = (unsigned_int)(1UL << GPT_GTM_CTRL_OSM);
            }
            #endif
            TempFlag |= (uint32)
            ...
            CompareFlag &= ((~TempFlag) ^ \
            (uint32)GPT_SFR_INIT_USER_MODE_READ32((TomChannelRegPtr->CTRL.U)));
            #if (GPT_ONESHOT_USED == STD_ON)
            if (Gpt_lModeOsm(ChannelMode))
            {
               TempFlag = 0UL;
               /* Check to verify clear of channel Notify bits */
               CompareFlag &= ((~TempFlag) ^ (uint32)\
               GPT_SFR_INIT_USER_MODE_READ32((TomChannelRegPtr->IRQ_NOTIFY.U)));
               TempFlag = 1UL;
               /* Check to verify interrupt enable for the channel */
               CompareFlag &= ((~TempFlag) ^ (uint32)\
                 GPT_SFR_INIT_USER_MODE_READ32((TomChannelRegPtr->IRQ_EN.U)));
        ...
        if(Gpt_ChannelIdentifier[Channel].ModuleId == GTM_ATOM_MODULE)
        {
            ...
            has to be verified in Gpt_InitCheck */
            CompareFlag &= ((~TempFlag) ^ \
            (uint32)GPT_SFR_INIT_USER_MODE_READ32((AtomChannelRegPtr->CTRL.U)));
            #if (GPT_ONESHOT_USED == STD_ON)
            if (Gpt_lModeOsm(ChannelMode))
            {
              TempFlag = 0UL;
              /* Check to verify clear of channel Notify bits */
              CompareFlag &= ((~TempFlag) ^ (uint32)\
                                GPT_SFR_INIT_USER_MODE_READ32\
                                ((AtomChannelRegPtr->IRQ_NOTIFY.U)));
              TempFlag = 1UL;
              /* Check to verify interrupt enable for the channel */
              CompareFlag &= ((~TempFlag) ^ (uint32)\
                                GPT_SFR_INIT_USER_MODE_READ32\
...
/*******************************************************************************
** Syntax : static uint32 Gpt_lCheckChannelIdentifier(                        **
              Gpt_GtmGlobalChannelNoType GlobalChannelNumber,                 **
                                  Gpt_ChannelType Channel)                    **
**                                                                            **
** Service ID:       none                                                     **
...
/*******************************************************************************
** Traceability    :    [cover parentID=DS_MCAL_GPT_505]                      **
**                                                                            **
