...
**                                                                            **
**  TRACEABILITY :
    [cover parentID=SAS_NAS_MSC_PR1071,SAS_NAS_ALL_PR746,SAS_NAS_ALL_PR748]
**  [/cover]                                                                  **
**                                                                            **
*******************************************************************************/
...
#include "Det.h"
     ...
     (MSC_USER_MODE_RUNTIME_API_ENABLE == STD_ON) ||                           \
     (MSC_USER_MODE_DEINIT_API_ENABLE == STD_ON) ||                            \
     (MSC_RUNNING_IN_USER_0_MODE_ENABLE == STD_ON))
     #include "Msc_Protect.h"
#endif
...
#define MSC_SID_ENABLEINTERRUPTS                       ((uint8)0x0FU)
...
#define MSC_SFR_INIT_WRITE32(reg,value)                                        \
                                   (MSC_INIT_WRITE32((reg), (value)))
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_INIT_RESETENDINIT()                 (MSC_INIT_RESETENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_INIT_SETENDINIT()                   (MSC_INIT_SETENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_INIT_MODIFY32(reg,clearmask,setmask)                       \
                       MSC_INIT_MODIFY32((reg),(clearmask),(setmask))
#if (MSC_RUNNING_IN_USER_0_MODE_ENABLE == STD_ON)
  /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define MSC_SFR_INIT_USER_MODE_READ32(reg)                                 \
                                    (MSC_INIT_USER_MODE_OS_API_READ32(reg))
  /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define MSC_SFR_INIT_USER_MODE_WRITE32(reg,value)                        \
               (MSC_INIT_USER_MODE_OS_API_WRITE32((reg),(value)))
  /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define MSC_SFR_INIT_USER_MODE_MODIFY32(reg,clearmask,setmask)           \
            MSC_INIT_USER_MODE_OS_API_MODIFY32((reg),(clearmask),(setmask));
#else
  /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define MSC_SFR_INIT_USER_MODE_READ32(reg)                 (reg)
  /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define MSC_SFR_INIT_USER_MODE_MODIFY32(reg,clearmask,setmask)            \
...
#endif /* MSC_RUNNING_IN_USER_MODE_ENABLE == STD_ON  */
#else
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_INIT_WRITE32(reg, value)                                    \
...
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_INIT_RESETENDINIT()                   (Mcal_ResetENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_INIT_SETENDINIT()                     (Mcal_SetENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_INIT_USER_MODE_READ32(reg)             (reg)
...
/*IFX_MISRA_RULE_19_04_STATUS=First level of indirection is used to support
 ...
 initialiser*/
  ...
  /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define MSC_SFR_RUNTIME_USER_MODE_READ32(reg)                                \
                                      (MSC_RUNTIME_USER_MODE_OS_API_READ32(reg))
/*IFX_MISRA_RULE_19_04_STATUS=First level of indirection is used to support
 modification of OS protected calls, so it cannot be expand to a braced
 initialiser*/
 /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define MSC_SFR_RUNTIME_USER_MODE_MODIFY32(reg,clearmask,setmask)           \
            MSC_RUNTIME_USER_MODE_OS_API_MODIFY32((reg),(clearmask),(setmask));
   /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define MSC_SFR_RUNTIME_USER_MODE_WRITE32(reg,value)                      \
               (MSC_RUNTIME_USER_MODE_OS_API_WRITE32((reg),(value)))
#else
  /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
  #define MSC_SFR_RUNTIME_USER_MODE_READ32(reg)                 (reg)
 /*IFX_MISRA_RULE_19_04_STATUS=First level of indirection is used to support
 modification of OS protected calls, so it cannot be expand to a braced
 initialiser*/
 /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
...
#define MSC_SFR_RUNTIME_USER_MODE_READ32(reg)             (reg)
    ...
    /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
    calls definition, it is declared as a function like macro*/
    #define MSC_SFR_DEINIT_USER_MODE_READ32(reg)                 \
                                      (MSC_DEINIT_USER_MODE_OS_API_READ32(reg))
#else
    /*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
    calls definition, it is declared as a function like macro*/
    #define MSC_SFR_DEINIT_USER_MODE_READ32(reg)                 (reg)
#endif
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_DEINIT_WRITE32(reg,value)                                      \
                                   (MSC_DEINIT_WRITE32((reg), (value)))
/*IFX_MISRA_RULE_19_04_STATUS=First level of indirection is used to support
 modification of OS protected calls, so it cannot be expand to a braced
 initialiser*/
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_DEINIT_MODIFY32(reg,clearmask,setmask)                         \
                       MSC_DEINIT_MODIFY32((reg),(clearmask),(setmask))
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_DEINIT_RESETENDINIT()                (MSC_DEINIT_RESETENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_DEINIT_SETENDINIT()                   (MSC_DEINIT_SETENDINIT())
#else
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_DEINIT_WRITE32(reg, value)                                     \
...
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_DEINIT_RESETENDINIT()                     (Mcal_ResetENDINIT())
/*IFX_MISRA_RULE_19_07_STATUS=To support user modification of OS protected
  calls definition, it is declared as a function like macro*/
#define MSC_SFR_DEINIT_SETENDINIT()                   (Mcal_SetENDINIT())
...
*/
typedef enum Msc_UpstreamRegType
{
  MSC_UD0,
  MSC_UD1,
  MSC_UD2,
...
*/
typedef enum Msc_TxDevSelectType
{
  MSC_TX_DEVICE_0,
  MSC_TX_DEVICE_1,
  MSC_TX_DEVICE_2,
...
*/
typedef enum Msc_RxDevSelectType
{
  MSC_RX_DEVICE_0,
  MSC_RX_DEVICE_1,
  MSC_RX_DEVICE_2,
...
*/
typedef enum Msc_RxTimeoutStatusType
{
  MSC_TIMEOUT_NOT_OK,
...
extern const Msc_ConfigType Msc_ConfigRoot[MSC_CONFIG_COUNT];
...
*******************************************************************************/
extern Std_ReturnType Msc_EnableInterrupts(uint8 ModNum);
...
/*******************************************************************************
** Traceability    : [cover parentID=DS_NAS_MSC_PR63_18,DS_NAS_MSC_PR63_19,
                      DS_NAS_MSC_PR128]                                       **
**                                                                            **
