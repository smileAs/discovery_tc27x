 ...
 **********************************************************************************************************************/
/*! \brief        Indication of a received ARP message.
 *  \description  <br>This callback function is called by the lower layer (EthIf) when a message arrives.
 ...
 *  \context      interrupt or task level
 **********************************************************************************************************************/
extern FUNC(void, IPV4_CODE) IpV4_Arp_TxConfirmation(
    uint8 CtrlIdx,
    uint8 BufIdx );
