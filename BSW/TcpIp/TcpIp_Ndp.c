  ...
  if (E_OK == IpV6_Ndp_VNCLookup(IpCtrlIdx, SrcAddrPtr, &NcEntryIdx))
  {
    ...
    if (NULL_PTR != SourceLinkLayerAddressOptPtr) /* source link-layer address included? */
    {
      if ((IPV6_REACHABLE_STATE_INCOMPLETE == IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].State) || /* PRQA S 3415 */ /* MD_IpV6_3415 */
        (FALSE == IpV6_CmpLLAddr(&SourceLinkLayerAddressOptPtr->addr[0], &IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].LinkLayerAddress[0]))) /* different link-layer address? */
      {
  ...
  else if (IPV6_LADDR_STATE_OPTIMISTIC == MatchingSrcAddrState)
  {
    ...
    if (IPV6_ADDR_TYPE_UNSPECIFIED == SrcAddrType)
    {
      /* "The node MUST NOT reply to a Neighbor Solicitation for an Optimistic Address
        ...
        */
      IpV6_VHandleDADFailure(IPV6_CTRL_VAR(IpV6_SourceAddressConfig)[CtrlAddrIdxTgt].IpAddrId, IPV6_DAD_FAIL_NS);
...
# endif
  ...
  if ((ResponseNaRSOFlags & IPV6_NDP_NA_FLAG_SOLICITED) != 0)
  {
    ...
    if (NULL_PTR != SrcLinkLayerAddrPtr)
    {
      ...
      if ((IPV6_REACHABLE_STATE_INCOMPLETE == IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].State) || /* PRQA S 3415 */ /* MD_IpV6_3415 */
          (FALSE == IpV6_CmpLLAddr(&IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].LinkLayerAddress[0], SrcLinkLayerAddrPtr)))
      {
        IpV6_Ndp_VNCUpdateEntry(IpCtrlIdx, NcEntryIdx, IPV6_REACHABLE_STATE_STALE);
...
# endif
      { /* PRQA S 3201 */ /* MD_IpV6_3201 */
        /* DAD for non-temporary address failed */
        IpV6_VHandleDADFailure(IPV6_CTRL_VAR(IpV6_SourceAddressConfig)[CtrlAddrIdxTgt].IpAddrId, IPV6_DAD_FAIL_NA);
        IpV6_VSATRemoveEntry(IpCtrlIdx, CtrlAddrIdxTgt);
      }
    }
    else
#endif
    {
      /* someone send neighbor advertisement with an address which is used by us */
  ...
  if ((NULL_PTR != TgtLLAddrPtr) && /* PRQA S 3415 */ /* MD_IpV6_3415 */
      (FALSE == IpV6_CmpLLAddr(TgtLLAddrPtr, &IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].LinkLayerAddress[0])))
  {
  ...
  uint16                  LenByte)
{
  ...
  if (NULL_PTR  != TgtLLAddrPtr)
  {
    ...
    {
      if ((IPV6_REACHABLE_STATE_INCOMPLETE == IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].State) || /* PRQA S 3415 */ /* MD_IpV6_3415 */
          (FALSE == IpV6_CmpLLAddr(&IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].LinkLayerAddress[0], TgtLLAddrPtr)))
      {
        IpV6_Ndp_VNCUpdateLinkLayerAddress(IpCtrlIdx, NcEntryIdx, TgtLLAddrPtr);
        IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].State = IPV6_REACHABLE_STATE_STALE;
      }
  ...
  uint16                  LenByte)
{
  ...
  if (FALSE == IpV6_CmpLLAddr(&TgtLLAddrOptPtr->addr[0], &ThisTgtLLAddr[0]))
  {
  ...
  if ((IPV6_REACHABLE_STATE_INCOMPLETE == IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].State) || /* PRQA S 3415 */ /* MD_IpV6_3415 */
     (FALSE == IpV6_CmpLLAddr(&IPV6_CTRL_VAR(IpV6_NeighborCache)[NcEntryIdx].LinkLayerAddress[0], SrcLLAddrOptPtr->addr)))
  {
    IpV6_Ndp_VNCUpdateEntry(IpCtrlIdx, NcEntryIdx, IPV6_REACHABLE_STATE_STALE);
  ...
  uint16                  LenByte)
{
  ...
  {
    if (TRUE == IpV6_CmpLLAddr(TgtLLAddrOptPtr->addr, IPV6_CTRL_VAR(IpV6_Ndp_PendingInvNs).TargetPhysAddr))
    {
  ...
  boolean                   ForceUnspecSrcAddr)
{
  ...
  uint16                                          IcmpBufLen;
  uint16                                          IcmpPayloadLen = 0;
  IpV6_AddrType                                   DestAddr;    /* PRQA S 0759 */ /* MD_IpV6_0759 */
