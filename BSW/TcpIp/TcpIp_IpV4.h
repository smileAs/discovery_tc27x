...
#define IPV4_SW_MAJOR_VERSION         5u
#define IPV4_SW_MINOR_VERSION         0u
...
#define IPV4_IP_TOS_REL_MASK  0x04u  /* Relibility */
#define IPV4_IP_TOS_REL_NORM  0x00u  /* Normal Relibility */
#define IPV4_IP_TOS_REL_HIGH  0x04u  /* High Relibility */
 ...
 *  \param[in]     SockIdx               Index of the TcpIp socket.
 ...
 *  \param[inout]  LenBytePtr            In:  Pointer to the payload length in bytes.<br />
 *                                       Out: Length of the first IP payload buffer in bytes (see notes).
 *  \param[in]     TxReqDescrPtr         Pointer to a TX request descriptor.
 ...
 *  \param[in]   TxReqDescrPtr          Pointer to TX request descriptor that was used at IpV4_Ip_ProvideTxBuffer() call.
 ...
 *  \details      Only the required number of buffers for transmitting LenByte bytes will be used.
 ...
 *  \param[in]    SockIdx               TcpIp Sscket index.
 *  \param[in]    TxReqDescrPtr         Pointer to the TX request descriptor used in ProvideTxBuffer call.
 *  \param[in]    LenByte               Number of bytes to transmit.
 *                                      This implementations allows two special cases:
 *                                       1: The value of LenByte may be larger than requested by IpV4_Ip_ProvideTxBuffer() if
 *                                          there was enough space left in the last provided buffer fragment.
 *                                       2: The value of LenByte may be less than requested by IpV4_ProvideTxBuffer().
 ...
 *  \param[in]    Protocol              IP protocol value
 *  \param[in]    DestAddr              IP address of the destination.
 *  \param[in]    TxConf                Enable TX confirmation.
 *  \param[in]    UlTxReqTabIdx         Upper layer TX request identifier.
 ...
 *  \note         A previous call of IpV4_Ip_ProvideTxBuffer() must have been successful.
 *  \context      TASK
 **********************************************************************************************************************/
 ...
 *  \return       E_OK                  Default router address returned.
 *  \return       E_NOT_OK              Default router address could not be returned.
 *  \note
 *  \context      task level
 **********************************************************************************************************************/
