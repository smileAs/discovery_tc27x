...
#define IPV4_ASSERT(CONDITION)           TCPIP_ASSERT(CONDITION)
#define IPV4_ASSERT_UNREACHABLE()        TCPIP_ASSERT_MSG(FALSE, "This statement should never be executed!")
#define IPV4_ASSERT_UNREACHABLE_MSG(MSG) TCPIP_ASSERT_MSG(FALSE, (MSG))
