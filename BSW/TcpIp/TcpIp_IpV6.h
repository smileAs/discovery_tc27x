...
#define IPV6_SW_MAJOR_VERSION         5u
#define IPV6_SW_MINOR_VERSION         0u
...
FUNC(void, IPV6_CODE) IpV6_GetVersionInfo(P2VAR(Std_VersionInfoType, AUTOMATIC, IPV6_APPL_DATA) VersionInfoPtr);
