...
#define DEM_CFG_NO_STORAGE_CONDITION_GROUP       (DEM_CFG_NO_STORAGECONDITIONGROUPTABLEIDXOFEVENTTABLE)  /*!< No storage condition groups */
/*!
 * \}
 */
...
#define DEM_CFG_DATA_FROM_OBD_RATIO                                            (28U)  /*!< Data element maps to the ratio (Numerator and Denominator) */
#define DEM_CFG_DATA_FROM_CBK                                                  (29U)  /*!< Data element maps to an application callback (configured size) */
#define DEM_CFG_DATA_FROM_CBK_WITH_EVENTID                                     (30U)  /*!< Data element maps to an application callback with EventId argument (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_BOOLEAN                                      (31U)  /*!< Data element maps to a Sender Receiver callback with data type boolean (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_SINT8                                        (32U)  /*!< Data element maps to a Sender Receiver callback with data type sint8 (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_SINT16                                       (33U)  /*!< Data element maps to a Sender Receiver callback with data type sint16 Motorola (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_SINT32                                       (34U)  /*!< Data element maps to a Sender Receiver callback with data type sint32 Motorola (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_SINT16_INTEL                                 (35U)  /*!< Data element maps to a Sender Receiver callback with data type sint16 Intel (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_SINT32_INTEL                                 (36U)  /*!< Data element maps to a Sender Receiver callback with data type sint32 Intel (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_SINT8_N                                      (37U)  /*!< Data element maps to a Sender Receiver callback with data type sint8 Array (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_UINT8                                        (38U)  /*!< Data element maps to a Sender Receiver callback with data type uint8 (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_UINT16                                       (39U)  /*!< Data element maps to a Sender Receiver callback with data type uint16 Motorola (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_UINT32                                       (40U)  /*!< Data element maps to a Sender Receiver callback with data type uint32 Motorola (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_UINT16_INTEL                                 (41U)  /*!< Data element maps to a Sender Receiver callback with data type uint16 Intel (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_UINT32_INTEL                                 (42U)  /*!< Data element maps to a Sender Receiver callback with data type uint32 Intel (configured size) */
#define DEM_CFG_DATA_FROM_SR_PORT_UINT8_N                                      (43U)  /*!< Data element maps to a Sender Receiver callback with data type uint8 Array (configured size) */
#define DEM_CFG_DATAELEMENT_INVALID                                            (44U)  /*!< Data element does not map to data */
/*!
 * \}
 */
...
/*!
* \defgroup  Dem_Cfg_DenominatorGroupType  Event OBD Readiness groups
* \brief     Enumeration labels defining event OBD readiness groups
* \{
*/
#define DEM_CFG_READINESS_NONE                   (0U)  /*!< Event is not assigned to a readiness group */
#define DEM_CFG_READINESS_MISF                   (1U)  /*!< OBD readiness group DEM_OBD_RDY_MISF */
#define DEM_CFG_READINESS_FLSYS                  (2U)  /*!< OBD readiness group DEM_OBD_RDY_FLSYS */
#define DEM_CFG_READINESS_FLSYS_NONCONT          (2U)  /*!< OBD readiness group DEM_OBD_RDY_FLSYS_NONCONT; assigned to same value because state is assigned to same bit in PID01 and PID41 */
#define DEM_CFG_READINESS_CMPRCMPT               (3U)  /*!< OBD readiness group DEM_OBD_RDY_CMPRCMPT */
#define DEM_CFG_READINESS_CAT                    (4U)  /*!< OBD readiness group DEM_OBD_RDY_CAT */
#define DEM_CFG_READINESS_HCCAT                  (5U)  /*!< OBD readiness group DEM_OBD_RDY_HCCAT */
#define DEM_CFG_READINESS_HTCAT                  (6U)  /*!< OBD readiness group DEM_OBD_RDY_HTCAT */
#define DEM_CFG_READINESS_NOXCAT                 (7U)  /*!< OBD readiness group DEM_OBD_RDY_NOXCAT */
#define DEM_CFG_READINESS_EVAP                   (8U)  /*!< OBD readiness group DEM_OBD_RDY_EVAP */
#define DEM_CFG_READINESS_SECAIR                 (9U)  /*!< OBD readiness group DEM_OBD_RDY_SECAIR */
#define DEM_CFG_READINESS_BOOSTPR                (10U)  /*!< OBD readiness group DEM_OBD_RDY_BOOSTPR */
#define DEM_CFG_READINESS_O2SENS                 (11U)  /*!< OBD readiness group DEM_OBD_RDY_O2SENS */
#define DEM_CFG_READINESS_EGSENS                 (12U)  /*!< OBD readiness group DEM_OBD_RDY_EGSENS */
#define DEM_CFG_READINESS_O2SENSHT               (13U)  /*!< OBD readiness group DEM_OBD_RDY_O2SENSHT */
#define DEM_CFG_READINESS_PMFLT                  (14U)  /*!< OBD readiness group DEM_OBD_RDY_PMFLT */
#define DEM_CFG_READINESS_EGR                    (15U)  /*!< OBD readiness group DEM_OBD_RDY_ERG */
#define DEM_CFG_READINESS_ERG                    (15U)  /*!< Compatibility define for typo in Autosar */
#define DEM_CFG_READINESS_GROUP_COUNT            (16U)  /*!< Number of readiness groups assigned to different numbers - including DEM_CFG_READINESS_NONE */
/*!
* \}
*/
...
* \brief     Enumeration labels defining the Dtr Update Kind
* \{
*/
...
typedef struct Dem_Cfg_ComplexIterType_tag Dem_Cfg_EventStorageConditionGroupIterType;
...
typedef struct Dem_Cfg_ComplexIterType_tag Dem_Cfg_EventDtrIterType;
...
/*! Iterator type for iteration over MIDs */
typedef Dem_Cfg_SimpleIterType Dem_Cfg_MidIterType;
