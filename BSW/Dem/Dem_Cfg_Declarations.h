 ...
 *                Pointer to the iterator
 *
 * \return        An EventId using time based de-bouncing with the high resolution
 *                timer
 *
 * \pre           IterPtr has been initialized
 *
 ...
 * \brief         Init the iterator
 *
 * \details       Initializes the iterator to enumerate all EventIds using
 *                hi-res time based de-bouncing
 *
 * \param[out]    IterPtr
 *                Pointer to the iterator
 *
 ...
 *                Pointer to the iterator
 *
 * \return        An EventId using time based de-bouncing with the low resolution
 *                timer
 *
 * \pre           IterPtr has been initialized
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Get the low-res de-bounce time base
 *
 * \details       Get the low-res de-bounce time base
 *
 * \return        The low-res de-bounce time base in main function 'ticks'
 *
 * \pre           IterPtr has been initialized
 ...
 *
 * \pre           -
 * \config        ( ((DEM_CFG_SUPPORT_DCM == STD_ON) && (DEM_CFG_SUPPORT_ERECS == STD_ON))
 *               || (DEM_CFG_SUPPORT_SRECS == STD_ON)
 *               || (DEM_CFG_SUPPORT_OBDII == STD_ON)
 *               || (DEM_CFG_SUPPORT_WWHOBD == STD_ON)
 *               || (DEM_FEATURE_NEED_TIME_SERIES == STD_ON) )
 ...
 *                The DtrId must be in range [0..Dem_Cfg_GlobalDtrCount()-1[.
 *
...
#if (DEM_CFG_SUPPORT_DCM == STD_ON) && (DEM_CFG_SUPPORT_DTR == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_DtrUaSId
*****************************************************************************/
/*!
...
Dem_Cfg_EventIsCombined(
  CONST(Dem_EventIdType, AUTOMATIC)  EventId
   ...
   || ((DEM_CFG_SUPPORT_API_VERSION_4_2_1 == STD_ON) && (DEM_CFG_RESET_DEBOUNCE_ON_ENABLE_ENABLE_CONDITIONS == STD_ON)) )
/* ****************************************************************************
 * Dem_Cfg_EventDebounceContinuous
 *****************************************************************************/
/*!
 * \brief         Test if the event uses de-bounce continuous
 *
 * \details       Test if the events de-bounce counter continues while enable
 ...
 *
 * \return        TRUE
 *                The event uses de-bounce continuous
 * \return        FALSE
 *                The event does not use de-bounce continuous
 *
 * \pre           -
 * \config        DEM_FEATURE_NEED_DEBOUNCE == STD_ON
 *             || (DEM_CFG_SUPPORT_API_VERSION_4_2_1 == STD_ON
 ...
 *****************************************************************************/
/*!
 * \brief         Test if the event uses de-bounce reset
 *
 * \details       Test if the events de-bounce counter resets when enable
 ...
 *
 * \return        TRUE
 *                The event uses de-bounce reset
 * \return        FALSE
 *                The event does not use de-bounce reset
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_API_VERSION_4_2_1 == STD_ON
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
 ...
 *****************************************************************************/
/*!
 * \brief         Get the de-bounce algorithm of the event
 *
 * \details       Get the de-bounce algorithm of the event
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 ...
 *
 * \return        TRUE
 *                Dem_Cfg_EventDtrIterGet() will return a valid element
 *                on this iterator
 * \return        FALSE
 *                Dem_Cfg_EventDtrIterGet() is undefined on this iterator
 *
 * \pre           IterPtr has been initialized
 * \config        DEM_CFG_SUPPORT_DTR == STD_ON
 *
 ...
 *
 * \return        TRUE
 *                Dem_Cfg_EventERecIterGet() will return a valid element
 *                on this iterator
 * \return        FALSE
 *                Dem_Cfg_EventERecIterGet() is undefined on this iterator
 *
 * \pre           IterPtr has been initialized
 * \config        DEM_CFG_SUPPORT_ERECS == STD_ON
 *
...
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_EventERecIterExists(
  CONSTP2CONST(Dem_Cfg_EventERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
  );
#endif

#if (DEM_CFG_SUPPORT_ERECS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_EventERecIterGet
 *****************************************************************************/
/*!
 * \brief         Get the element pointed to by the iterator
 *
 ...
 *                Pointer to the iterator
 *
 * \return        Handle to Extended Data Record descriptor table
 *
 * \pre           IterPtr has been initialized
 * \config        DEM_CFG_SUPPORT_ERECS == STD_ON
 *
...
#if (DEM_CFG_SUPPORT_ERECS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_EventERecIterInit
 *****************************************************************************/
/*!
 * \brief         Init the iterator
 *
 * \details       Initializes the iterator to enumerate extended data records
 *                configured for an event
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
...
Dem_Cfg_EventERecIterInit(
  CONST(Dem_EventIdType, AUTOMATIC)  EventId,
  CONSTP2VAR(Dem_Cfg_EventERecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
  );
#endif

#if (DEM_CFG_SUPPORT_ERECS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_EventERecIterNext
 *****************************************************************************/
/*!
 * \brief         Move the iterator to the next element
 *
...
/* ****************************************************************************
 * Dem_Cfg_EventEnableConditionGroup
 *****************************************************************************/
/*!
...
Dem_Cfg_EventEnableConditionGroup(
  CONST(Dem_EventIdType, AUTOMATIC)  EventId
  );                                                                                                                             /* PRQA S 0779 */ /* MD_DEM_5.1 */

/* ****************************************************************************
 * Dem_Cfg_EnableConditionGroupIterExists
 *****************************************************************************/
/*!
 * \brief         Test if the iterator points to a valid element
 *
 ...
 *
 * \return        TRUE
 *                Dem_Cfg_EnableConditionGroupIterGet() will return a valid element
 *                on this iterator
 * \return        FALSE
 *                Dem_Cfg_EnableConditionGroupIterGet() is undefined on this iterator
 *
 * \pre           IterPtr has been initialized
 *
 * \context       TASK|ISR2
...
/* ****************************************************************************
 * Dem_Cfg_EnableConditionGroupIterGet
 *****************************************************************************/
/*!
 * \brief         Get the element pointed to by the iterator
 *
...
/* ****************************************************************************
 * Dem_Cfg_EnableConditionGroupIterInit
 *****************************************************************************/
/*!
 * \brief         Init the iterator
 *
...
/* ****************************************************************************
 * Dem_Cfg_EnableConditionGroupIterNext
 *****************************************************************************/
/*!
 * \brief         Move the iterator to the next element
 *
...
/* ****************************************************************************
 * Dem_Cfg_GlobalControlDtcSettingGroup
 *****************************************************************************/
/*!
 * \brief         Get the enable condition group only containing 'ControlDtcSetting'
 *
 * \details       Get the enable condition group only containing 'ControlDtcSetting'
 *
 * \return        Enable condition group only containing 'ControlDtcSetting'
 *
 * \pre           -
 *
 * \context       TASK|ISR2
...
/* ****************************************************************************
 * Dem_Cfg_EventStorageConditionGroup
 *****************************************************************************/
/*!
...
#if (DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_StorageConditionGroupIterExists
 *****************************************************************************/
/*!
 * \brief         Test if the iterator points to a valid element
 *
 ...
 *
 * \return        TRUE
 *                Dem_Cfg_StorageConditionGroupIterGet() will return a valid element
 *                on this iterator
 * \return        FALSE
 *                Dem_Cfg_StorageConditionGroupIterGet() is undefined on this iterator
 *
 * \pre           IterPtr has been initialized
 * \config        DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON
 *
...
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_StorageConditionGroupIterExists(
  CONSTP2CONST(Dem_Cfg_EventStorageConditionGroupIterType, AUTOMATIC, AUTOMATIC) IterPtr
  );
#endif

#if (DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_StorageConditionGroupIterGet
 *****************************************************************************/
/*!
 * \brief         Get the element pointed to by the iterator
 *
...
#if (DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_StorageConditionGroupIterInit
*****************************************************************************/
/*!
 * \brief         Init the iterator
 *
...
Dem_Cfg_StorageConditionGroupIterInit(
  ...
  CONSTP2VAR(Dem_Cfg_EventStorageConditionGroupIterType, AUTOMATIC, AUTOMATIC) IterPtr
  );                                                                                                                             /* PRQA S 0779 */ /* MD_DEM_5.1 */
#endif

#if (DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_StorageConditionGroupIterNext
*****************************************************************************/
/*!
 * \brief         Move the iterator to the next element
 *
 ...
 *
 * \pre           Event must be configured for counter based de-bouncing
...
/* ****************************************************************************
 * Dem_Cfg_EventFailedTime
 *****************************************************************************/
/*!
 * \brief         Get the failed timeout for the event
 *
 * \details       Get the failed timeout for the event
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 ...
 *
 * \pre           Event must be configured for time based de-bouncing
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
 ...
 *
 * \pre           -
 * \config        (DEM_FEATURE_NEED_MULTIHEAL == STD_ON)
 *             || (DEM_FEATURE_NEED_IMMEDIATEHEAL == STD_ON)
 *             || ( (DEM_CFG_AGING_AFTER_HEALING_ALL_DTC == STD_ON)
 *               && (DEM_CFG_ISCONST_HEALINGTARGET != STD_ON) )
 *
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 ...
 *
 * \pre           IterPtr has been initialized
 * \config        DEM_CFG_SUPPORT_J1939_NODES == STD_ON
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
 ...
 *****************************************************************************/
/*!
 * \brief         Get the jump-down de-bounce value configured for the event
 *
 * \details       Get the jump-down de-bounce value configured for the event
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        The de-bounce value used for jump-down
 *
 * \pre           The event must be configured for counter based de-bouncing
 * \config        DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 ...
 *****************************************************************************/
/*!
 * \brief         Get the jump-up de-bounce value configured for the event
 *
 * \details       Get the jump-up de-bounce value configured for the event
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        The de-bounce value used for jump-up
 *
 * \pre           The event must be configured for counter based de-bouncing
 * \config        DEM_CFG_SUPPORT_DEBOUNCE_COUNTER == STD_ON
 *
...
/* ****************************************************************************
 * Dem_Cfg_EventPassedTime
 *****************************************************************************/
/*!
 * \brief         Get the passed timeout for the event
 *
 * \details       Get the passed timeout for the event
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 ...
 *
 * \pre           Event must be configured for pre-storage
 ...
 *
 * \return        TRUE
 *                Dem_Cfg_EventSRecIterGet() will return a valid element
 *                on this iterator
 * \return        FALSE
 *                Dem_Cfg_EventSRecIterGet() is undefined on this iterator
 *
 * \pre           IterPtr has been initialized
 * \config        DEM_CFG_SUPPORT_SRECS == STD_ON
 *
...
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_EventSRecIterExists(
  CONSTP2CONST(Dem_Cfg_EventSRecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
  );
#endif

#if (DEM_CFG_SUPPORT_SRECS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_EventSRecIterGet
 *****************************************************************************/
/*!
 * \brief         Get the element pointed to by the iterator
 *
 ...
 *                Pointer to the iterator
 *
 * \return        Handle to Snapshot Record descriptor table
 *
 * \pre           IterPtr has been initialized
 * \config        DEM_CFG_SUPPORT_SRECS == STD_ON
 *
...
#if (DEM_CFG_SUPPORT_SRECS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_EventSRecIterInit
 *****************************************************************************/
/*!
 * \brief         Init the iterator
 *
 * \details       Initializes the iterator to enumerate snapshot record descriptors
 *                configured for an event
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
...
Dem_Cfg_EventSRecIterInit(
  CONST(Dem_EventIdType, AUTOMATIC)  EventId,
  CONSTP2VAR(Dem_Cfg_EventSRecIterType, AUTOMATIC, AUTOMATIC)  IterPtr
  );
#endif

#if (DEM_CFG_SUPPORT_SRECS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_EventSRecIterNext
 *****************************************************************************/
/*!
 * \brief         Move the iterator to the next element
 *
...
Dem_Cfg_EventSRecUdsSize(
  CONST(Dem_EventIdType, AUTOMATIC)  EventId
   ...
   || ((DEM_CFG_SUPPORT_DCM == STD_ON) && (DEM_CFG_SUPPORT_SEVERITY == STD_ON)) )
/* ****************************************************************************
...
#if ( ((DEM_FEATURE_NEED_DEMSC_CALLBACKS == STD_ON) && ((DEM_CFG_SUPPORT_ERECS == STD_ON) || (DEM_CFG_SUPPORT_SRECS == STD_ON))) \
   || ((DEM_FEATURE_NEED_STATISTICAL_DATA == STD_ON) && (DEM_CFG_DATA_SIGNIFICANCE == STD_ON)) \
   || ((DEM_CFG_SUPPORT_DCM == STD_ON) && (DEM_FEATURE_NEED_OBD == STD_ON) && (DEM_CFG_SUPPORT_OBD_HIDE_OCCURRENCES == STD_ON)) )
/* ****************************************************************************
 ...
 *
 * \pre           -
 * \config        ( ( (DEM_FEATURE_NEED_DEMSC_CALLBACKS == STD_ON)
 *                 && ( (DEM_CFG_SUPPORT_ERECS == STD_ON)
 *                   || (DEM_CFG_SUPPORT_SRECS == STD_ON) ) )
 *             || ( (DEM_FEATURE_NEED_STATISTICAL_DATA == STD_ON)
...
#if (DEM_FEATURE_NEED_EVENT_PRECONFIRMED == STD_OFF) && (DEM_CFG_STORAGE_AT_FDC == STD_ON) && (DEM_FEATURE_NEED_DEBOUNCE_TIME == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_EventStorageTime
 *****************************************************************************/
/*!
 ...
 *****************************************************************************/
/*!
 * \brief         Test if the event stores the de-bounce counter in NV
 *
 * \details       Test if the event stores the de-bounce counter in NV
 *
 * \param[in]     EventId
 *                Unique handle of the Event.
 *                The EventId must be in range [1..Dem_Cfg_GlobalEventCount()[.
 *
 * \return        TRUE
 *                The event stores the de-bounce counter in NV
 * \return        TRUE
 *                The event does not stores the de-bounce counter in NV
 *
 * \pre           -
 ...
 *****************************************************************************/
/*!
 * \brief         Get the number of events storing the de-bounce counter in NV
 *
 * \details       Get the number of events storing the de-bounce counter in NV
 *
 * \return        The number of events storing the de-bounce counter in NV
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_DEBOUNCE_NV == STD_ON
 *
...
/* ****************************************************************************
 * Dem_Cfg_GlobalEnableConditionCount
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_Cfg_GlobalEnableConditionGroupCount
 *****************************************************************************/
/*!
...
/* ****************************************************************************
 * Dem_Cfg_EnableConditionInitValue
*****************************************************************************/
/*!
 ...
 *****************************************************************************/
/*!
 * \brief         Get the raw size of the OBD-II freeze frame
 *
 * \details       Get the data size of the OBD-II freeze frames excluding all
 *                data not stored in NVRam
 *
 * \return        The raw size in bytes of the OBD-II freeze frame
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_OBDII == STD_ON
 *
 ...
 *****************************************************************************/
/*!
 * \brief         Get the number of events configured for pre-storage
 *
 * \details       Get the number of events configured for pre-storage
 *
 * \return        The number of events configured for pre-storage
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_PRESTORED_FF == STD_ON
 *
...
#if (DEM_CFG_SUPPORT_PRESTORED_FF == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_GlobalPrestorageMaxCount
 *****************************************************************************/
/*!
 * \brief         Get the number of pre-storage slots
 *
 * \details       Get the number of pre-storage slots
 *
...
/* ****************************************************************************
 * Dem_Cfg_GlobalQueueMaxCount
 *****************************************************************************/
/*!
 * \brief         Get the maximum number of DTCs queued chronologically
 *
 * \details       Get the maximum number of DTCs queued chronologically
 *
 * \return        The maximum number of DTCs queued chronologically
 *
 * \pre           -
...
Dem_Cfg_GlobalRslIndicator(
  void
   ...
   || ( (DEM_CFG_SUPPORT_SECONDARY == STD_ON) \
 ...
 *             || DEM_CFG_SUPPORT_DCM == STD_ON
 *             || DEM_CFG_CLEAR_SINGLE_DTCS == STD_ON
 *             || DEM_CFG_SUPPORT_SECONDARY == STD_ON && DEM_CFG_SUPPORT_J1939_READ_DTC == STD_ON
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
...
#if (DEM_CFG_SUPPORT_DCM == STD_ON) && ((DEM_CFG_SUPPORT_SEVERITY == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON))
/* ****************************************************************************
 ...
 * \pre           -
 * \config        (DEM_CFG_SUPPORT_DCM == STD_ON)
 *             && ((DEM_CFG_SUPPORT_SEVERITY == STD_ON) || (DEM_CFG_SUPPORT_WWHOBD == STD_ON))
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
...
#if (DEM_CFG_SUPPORT_SRECS == STD_ON) && (DEM_DEV_RUNTIME_CHECKS == STD_ON)
/* ****************************************************************************
 ...
 *                mask (SAM)
 *
 * \return        The supported event status mask
 *
 * \pre           -
 *
 * \context       TASK|ISR2
...
#if (DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_GlobalStorageConditionCount
 *****************************************************************************/
/*!
...
#if (DEM_CFG_SUPPORT_DTR == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_GlobalSupportedMidCount
*****************************************************************************/
/*!
 * \brief         Get the number of used standardized Mids
 *
 * \details       Get the number of used standardized Mids
 *
 * \return        The number of used standardized Mids
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_DTR == STD_ON
 *
...
#if (DEM_CFG_SUPPORT_STORAGE_CONDITIONS == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_StorageConditionInitValue
*****************************************************************************/
/*!
 ...
 *****************************************************************************/
/*!
 * \brief         Get the NV Block handle of the de-bounce data block
 *
 * \details       Get the NV Block handle of the de-bounce data block
 *
 * \return        NV Block handle of the de-bounce data block
 *
 * \pre           -
 * \config        DEM_CFG_USE_NVM == STD_ON
...
DEM_LOCAL_INLINE FUNC(boolean, DEM_CODE)
Dem_Cfg_MidIterExists(
  CONSTP2CONST(Dem_Cfg_MidIterType, AUTOMATIC, AUTOMATIC) IterPtr
  );
#endif
...
DEM_LOCAL_INLINE FUNC(void, DEM_CODE)
Dem_Cfg_MidIterInit(
  CONST(uint8, AUTOMATIC) MidTableStartIndex,
  CONSTP2VAR(Dem_Cfg_MidIterType, AUTOMATIC, AUTOMATIC) IterPtr
);
#endif
 ...
 * \pre           -
 * \config        DEM_FEATURE_NEED_IUMPR == STD_ON
 *             && (DEM_FEATURE_NEED_SUPPRESSION == STD_OFF || (DEM_DEV_RUNTIME_CHECKS == STD_ON)
 *
 * \context       TASK|ISR2
 * \synchronous   TRUE
 * \reentrant     TRUE
...
*                Unique handle of the Ratio
*
* \return        The reporting type \ref Dem_IumprReadinessGroupType
*
* \pre           -
* \config        DEM_CFG_SUPPORT_IUMPR == STD_ON
*
...
#if (DEM_CFG_SUPPORT_DTR == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_SupportedMidMask
*****************************************************************************/
/*!
 * \brief         Get the Supported Mid Mask for the supported Mid
 *
 * \details       Get the Supported Mid Mask for the supported Mid
 *
 * \param[in]     SupportedMid
 *
 * \return        Supported Mid Mask for the supported Mid.
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_DTR == STD_ON
 *
...
DEM_LOCAL_INLINE FUNC(uint32, DEM_CODE)
Dem_Cfg_SupportedMidMask(
  CONST(uint16, AUTOMATIC) SupportedMid
  );
#endif

#if (DEM_CFG_SUPPORT_DCM == STD_ON) && (DEM_CFG_SUPPORT_DTR == STD_ON)
/* ****************************************************************************
 * Dem_Cfg_SupportedMidStartIndexMidTable
*****************************************************************************/
/*!
 * \brief         Get the Start Index of the Mid table for the supported Mid
 *
 * \details       Get the Start Index of the Mid table for the supported Mid
 *
 * \param[in]     SupportedMid
 *
 * \return        Start Index of the Mid table for the supported Mid.
 *
 * \pre           -
 * \config        DEM_CFG_SUPPORT_DCM == STD_ON &&
 *                DEM_CFG_SUPPORT_DTR == STD_ON
...
DEM_LOCAL_INLINE FUNC(uint8, DEM_CODE)
Dem_Cfg_FindJ1939NodeFromNmNode(
  CONST(uint8, AUTOMATIC)  NmNodeId
  );
#endif

#if ( ((DEM_CFG_SUPPORT_DTCSUPPRESSION == STD_ON) && (DEM_CFG_SUPPORT_J1939 == STD_ON)) \
   || (DEM_CFG_SUPPORT_J1939_CLEAR_DTC == STD_ON) )
/* ****************************************************************************
 ...
 *
 * \details       Test if the DTC number is a configured UDS 'groupOfDTC'
 *                number and return the internal representation of that group.
 *
 * \param[in]     DTC
 *                The DTC number
 *
 * \return        DEM_CFG_GROUPMASK_NONE
 *                DTC number doen't represent any configured Dtc Group.
 * \return        DEM_CFG_GROUPMASK_EMISSION
 *                DTC number represents the OBD-II emission related group.
 * \return        DEM_CFG_GROUPMASK_POWERTRAIN
 *                DTC number represents the Powertrain Group.
 * \return        DEM_CFG_GROUPMASK_CHASSIS
 *                DTC number represents the Chassis Group.
 * \return        DEM_CFG_GROUPMASK_BODY
 *                DTC number represents the Body Group.
 * \return        DEM_CFG_GROUPMASK_NETWORK
 *                DTC number represents the Network Communication Group.
 * \return        DEM_CFG_GROUPMASK_ALLDTCS
 *                DTC number represents all DTCs.
 *
