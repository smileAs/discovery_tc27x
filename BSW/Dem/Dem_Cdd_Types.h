...
# define DEM_EVENT_STATUS_PREPASSED_CONDITIONS_NOT_FULFILLED      (0x07U)      /*!< Monitor status report: test passed, de-bouncing required, similar conditions not fulfilled */
#endif
#if !defined (DEM_EVENT_STATUS_PREFAILED_CONDITIONS_NOT_FULFILLED)
# define DEM_EVENT_STATUS_PREFAILED_CONDITIONS_NOT_FULFILLED      (0x08U)      /*!< Monitor status report: test failed, de-bouncing required, similar conditions not fulfilled */
#endif

#if !defined (Rte_TypeDef_Dem_DebouncingStateType)
typedef uint8                                    Dem_DebouncingStateType;      /*!< Type for monitor de-bouncing status */
#endif
#if !defined (DEM_TEMPORARILY_DEFECTIVE)
# define DEM_TEMPORARILY_DEFECTIVE               (0x01U)                       /*!< De-bouncing not completed, the monitor is currently failing */
#endif
#if !defined (DEM_FINALLY_DEFECTIVE)
# define DEM_FINALLY_DEFECTIVE                   (0x02U)                       /*!< De-bouncing completed, the monitor has reported a failed result */
#endif
#if !defined (DEM_TEMPORARILY_HEALED)
# define DEM_TEMPORARILY_HEALED                  (0x04U)                       /*!< De-bouncing not completed, the monitor is currently passing */
#endif
#if !defined (DEM_TEST_COMPLETE)
# define DEM_TEST_COMPLETE                       (0x08U)                       /*!< De-bouncing completed */
#endif
...
#if !defined (Rte_TyeDef_Dem_IumprReadinessGroupType)
