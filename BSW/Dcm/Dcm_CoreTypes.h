...
# define DCM_CORETYPES_MINOR_VERSION                                 2u
...
# if (DCM_VARMGR_MULTI_SVC_EXCLUSIVE_ENABLED  == STD_ON) || \
     (DCM_VARMGR_MULTI_SVC_INCLUSIVE_ENABLED  == STD_ON)                                                                                             /* COV_DCM_UNSUPPORTED TF tf xf */
...
#  if !defined (DCM_PDUR_API_401_ENABLED)                                                                                                            /* COV_DCM_UNSUPPORTED TX */
#   define DCM_PDUR_API_401_ENABLED                                  STD_OFF
#  endif
#  if !defined (DCM_PDUR_API_403_ENABLED)                                                                                                            /* COV_DCM_UNSUPPORTED TX */
#   define DCM_PDUR_API_403_ENABLED                                  STD_OFF
#  endif
#  if !defined (DCM_PDUR_API_412_ENABLED)                                                                                                            /* COV_DCM_SUPPORT_ALWAYS XF */
...
struct DCM_DIAGDATACONTEXTTYPE_TAG
{
  ...
  Dcm_MsgLenType  AvailLen; /*!< Keeps the difference between Size and Usage */
};
...
#  endif
  boolean                    ComMChannelState[DCM_NET_MAX_NUM_COMM_CHANNELS_CONST];     /*!< The DCM related ComM channel communication state (TRUE - "DiagActive", FALSE - "DiagInactive") */
#  if (DCM_MODE_COMMCTRL_ENABLED == STD_ON)
  Dcm_CommunicationModeType  CommControlState[DCM_NET_MAX_NUM_ALL_COMM_CHANNELS_CONST]; /*!< The ComM channel related communication state (e.g. DCM_ENABLE_RX_TX_NORM etc.) */
#  endif
