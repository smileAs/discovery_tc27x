 ...
 *  07.02.00  2017-01-03  visvkr  ESCAN00089919 Service 0x86: Check RxPduId read from NvM
...
# define DCM_CORE_MAJOR_VERSION                                      7u
# define DCM_CORE_MINOR_VERSION                                      2u
...
# define DCM_EXT_SID_NETREGISTERACTIVECONNECTION                     (Dcm_ExtendedSidType)0x0a
# define DCM_EXT_SID_CFGMODEMGRRULESGETENTRY                         (Dcm_ExtendedSidType)0x0b
# define DCM_EXT_SID_MODECHECK                                       (Dcm_ExtendedSidType)0x0c
# define DCM_EXT_SID_MODEMONITORCONTROLDTCSETTING                    (Dcm_ExtendedSidType)0x0d
# define DCM_EXT_SID_MODEMONITORCOMMUNICATIONCONTROL                 (Dcm_ExtendedSidType)0x0e
# define DCM_EXT_SID_TSKGETTASKINFO                                  (Dcm_ExtendedSidType)0x0f
# define DCM_EXT_SID_TSKGETTASKCONTEXT                               (Dcm_ExtendedSidType)0x10
# define DCM_EXT_SID_TSKREGISTERACTIVETASK                           (Dcm_ExtendedSidType)0x11
# define DCM_EXT_SID_TSKUNREGISTERACTIVETASK                         (Dcm_ExtendedSidType)0x12
# define DCM_EXT_SID_TSKGETSCHEDULERCONTEXT                          (Dcm_ExtendedSidType)0x13
# define DCM_EXT_SID_TMRGETTIMERINFO                                 (Dcm_ExtendedSidType)0x14
# define DCM_EXT_SID_TMRSETTIMER                                     (Dcm_ExtendedSidType)0x15
# define DCM_EXT_SID_DIAGGETPOSTPROCESSORFUNC                        (Dcm_ExtendedSidType)0x16
# define DCM_EXT_SID_DIAGGETUPDATEFUNC                               (Dcm_ExtendedSidType)0x17
# define DCM_EXT_SID_DIAGGETCANCELFUNC                               (Dcm_ExtendedSidType)0x18
# define DCM_EXT_SID_DIAGPUTSTARTUPFBLRESBUFFER                      (Dcm_ExtendedSidType)0x19
# define DCM_EXT_SID_DIAGCOMMITDATA                                  (Dcm_ExtendedSidType)0x1a
# define DCM_EXT_SID_DIAGREVERTDATA                                  (Dcm_ExtendedSidType)0x1b
# define DCM_EXT_SID_DIAGPROVIDEDATAASU8                             (Dcm_ExtendedSidType)0x1c
# define DCM_EXT_SID_CFGSVC11SUBFUNCINFOGETENTRY                     (Dcm_ExtendedSidType)0x1d
# define DCM_EXT_SID_CFGSVC19SUBFUNCINFOGETENTRY                     (Dcm_ExtendedSidType)0x1e
# define DCM_EXT_SID_CFGSVC27SUBFUNCINFOGETENTRY                     (Dcm_ExtendedSidType)0x1f
# define DCM_EXT_SID_CFGSVC28SUBFUNCINFOGETENTRY                     (Dcm_ExtendedSidType)0x20
# define DCM_EXT_SID_CFGSVC2CSUBFUNCINFOGETENTRY                     (Dcm_ExtendedSidType)0x21
# define DCM_EXT_SID_CFGSVC86SUBFUNCINFOGETENTRY                     (Dcm_ExtendedSidType)0x22
# define DCM_EXT_SID_NETREGISTERCOMMACTIVITY                         (Dcm_ExtendedSidType)0x23
# define DCM_EXT_SID_NETUNREGISTERCOMMACTIVITY                       (Dcm_ExtendedSidType)0x24
# define DCM_EXT_SID_NETUNREGISTERACTIVECONNECTION                   (Dcm_ExtendedSidType)0x25
# define DCM_EXT_SID_NETALLOCATEORGETTRANSPOBJECT                    (Dcm_ExtendedSidType)0x26
# define DCM_EXT_SID_NETGETTRANSPOBJOFCONNECTION                     (Dcm_ExtendedSidType)0x27
# define DCM_EXT_SID_UTIMEMCOPYBUFFER                                (Dcm_ExtendedSidType)0x28
# define DCM_EXT_SID_NETRXINDINTERNAL                                (Dcm_ExtendedSidType)0x29
# define DCM_EXT_SID_DIAGSETREQDATAASU8AT                            (Dcm_ExtendedSidType)0x2A
# define DCM_EXT_SID_DIAGSETRESDATAASU8AT                            (Dcm_ExtendedSidType)0x2B
# define DCM_EXT_SID_DIAGGETRESDATAAT                                (Dcm_ExtendedSidType)0x2C
# define DCM_EXT_SID_DIAGGETREAMINGRESLENWITHOFFSET                  (Dcm_ExtendedSidType)0x2D
# define DCM_EXT_SID_CFGSVC85SUBFUNCINFOGETENTRY                     (Dcm_ExtendedSidType)0x2E
# define DCM_EXT_SID_CFGDIAGSERVICEINFOGETENTRY                      (Dcm_ExtendedSidType)0x2F
# define DCM_EXT_SID_DIAGPROVIDERESDATA                              (Dcm_ExtendedSidType)0x30
# define DCM_EXT_SID_DIAGUPDATERESLENGTH                             (Dcm_ExtendedSidType)0x31
# define DCM_EXT_SID_DIAGSETNEWREQBASETOCURPROGRESS                  (Dcm_ExtendedSidType)0x32
# define DCM_EXT_SID_DIAGSETNEWRESBASETOCURPROGRESS                  (Dcm_ExtendedSidType)0x33
# define DCM_EXT_SID_NETGETPROTOCOLNOTIFICATIONINFO                  (Dcm_ExtendedSidType)0x34
/* ----------------------------------------------
 ...
 *                Dcm_PbRamNetPeriodicTxObject[].IsReserved,
