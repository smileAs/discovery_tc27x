...
))
{
  ...
  *(volatile uint32*)TimerConfig->CounterRegisterAddress = TimerConfig->ReloadValue;                                    /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_PWA_GPTCONFIG */

  /* #20 Initial the reload register with the reload value. */
  *(volatile uint32*)TimerConfig->ReloadRegisterAddress = TimerConfig->ReloadValue;                                     /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_PWA_GPTCONFIG */

  /* #30 Configure the reload register. */
  *(volatile uint32*)TimerConfig->ReloadConfRegisterAddress = TimerConfig->ReloadConfRegisterValue;                     /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_PWA_GPTCONFIG */

  /* #40 Configure the counter register. */
  *(volatile uint32*)TimerConfig->CounterConfRegisterAddress = TimerConfig->CounterConfRegisterValue;                   /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_PWA_GPTCONFIG */
  ...
  *(volatile uint32*) (TimerConfig->InterruptSRCRegisterAddress) = tempSRC;                                             /* PRQA S 0303 */ /* MD_Os_Hal_0303 */ /* SBSW_OS_HAL_PWA_GPTCONFIG */
}
...
))
{
  ...
  return (*(volatile uint32*)TimerConfig->InterruptSRCRegisterAddress) & OS_HAL_INT_SRC_SRR_MASK;                       /* PRQA S 0303 */ /* MD_Os_Hal_0303 */
}
