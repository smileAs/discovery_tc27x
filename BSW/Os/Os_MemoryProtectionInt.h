 ...
 *
 *
 *  \trace       CREQ-263, CREQ-264, CREQ-1201
 *  \trace       SPEC-63903
 *
 *
...
#if !defined(OS_MEMORYPROTECTIONINT_H)                                                                                  /* PRQA S 0883 */ /* MD_Os_0883 */
 ...
 *                  for the core.This function is called in Init-Step3 and Init-Step4 in order to handle the situation
 *                  that Init-Step3 is optional.
 *
 *
 *  \param[in]      CoreConfig  Configuration for core's memory protection mechanism. Parameter must not be NULL,
 *                              if Memory protection is enabled.
 *
 *  \context        OS_INTERNAL
 *
