 ...
 *  \details      (EXTENDED status:) If the given object ID is invalid, the function reports an error and goes into shutdown.
 *
 ...
 *  \details      This service returns the state of all event bits of the given task, not the events that the task is waiting for.
 *
