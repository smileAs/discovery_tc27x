...
))
{
  ...
  else
  {
    ...
    if(dyn->State != OS_SCHTSTATUS_RUNNING)
    {
      ...
      *ScheduleStatus = (ScheduleTableStatusType)dyn->State;                                                            /* SBSW_OS_PWA_PRECONDITION */
    }
    /* #40 Otherwise: */
    else
    {
        ...
        case OS_SCHT_SYNC_KIND_EXPLICIT:
          {
            ...
            if(Os_SchTIsSynchronous(scheduleTableSync) != 0)                                                            /* SBSW_OS_SCHT_SCHTISSYNCHRONOUS_001 */
            {
...
))
{
  ...
  else
  {
    ...
    if(Os_SchTHasNextScheduleTable(ScheduleTable) != 0)                                                                 /* SBSW_OS_FC_PRECONDITION */
    {
...
{
  return (P2CONST(Os_SchTConfigType, AUTOMATIC, OS_CONST))Job;                                                          /* PRQA S 0310 */ /* MD_Os_3305 */
}
...
{
  Os_Assert((Os_StdReturnType)(ExPo->Kind == OS_SCHT_EXPO_KIND_EXECUTE_SYNC));
  return (P2CONST(Os_SchTExPoSyncConfigType, AUTOMATIC, OS_CONST))ExPo;                                                 /* PRQA S 0310 */ /* MD_Os_3305 */
}
...
{
  return (P2VAR(Os_SchTType, AUTOMATIC, OS_VAR_NOINIT))Os_JobGetDyn(&(ScheduleTable->Job));                             /* PRQA S 0310 */ /* MD_Os_3305 */ /* SBSW_OS_FC_PRECONDITION */
}
...
{
  return (P2CONST(Os_SchTSyncConfigType, AUTOMATIC, OS_CONST))ScheduleTable;                                            /* PRQA S 0310 */ /* MD_Os_3305 */
}
...
{
  return (P2VAR(Os_SchTSyncType, AUTOMATIC, OS_VAR_NOINIT))Os_SchTGetDyn(&(ScheduleTable->SchT));                       /* PRQA S 0310 */ /* MD_Os_3305 */ /* SBSW_OS_FC_PRECONDITION */
}
...
))
{
  ...
  Os_Assert((Os_StdReturnType)(dyn->ExPo->Next != NULL_PTR));
...
))
{
  ...
  /* #10 If no synchronization point has been provided: */
  if(OS_LIKELY(dynSync->SyncState == OS_SCHTSYNCSTATUS_NOT_PROVIDED))
  {
    P2VAR(Os_SchTType, AUTOMATIC, OS_VAR_NOINIT) dyn;
    ...
    /* #40 If the schedule table has been waiting for a synchronization point: */
    if(dyn->State == OS_SCHTSTATUS_WAITING)                                                                             /* PRQA S 0715 */ /* MD_Os_0715 */
    {
      ...
      /* #50 Set the first synchronization point. */
      ...
      /* #60 Set schedule table state to RUNNING. */
...
{
  return (Os_StdReturnType)(ScheduleTable->SyncKind == OS_SCHT_SYNC_KIND_EXPLICIT);
}
...
))
{
  ...
  return (Os_StdReturnType)(dynSync->SyncState == OS_SCHTSYNCSTATUS_SYNC);
}
...
))
{
  ...
  return (Os_StdReturnType)((dyn->Next != ScheduleTable) && (dyn->Next != NULL_PTR));
}
...
))
{
  ...
  if(ScheduleTable != dyn->Next)
  {
    ...
    if(Os_SchTIsSynchronizedExplicit(ScheduleTable) != 0)                                                               /* SBSW_OS_FC_PRECONDITION */
    {
      P2CONST(Os_SchTSyncConfigType, AUTOMATIC, OS_CONST) scheduleTableSync;
      P2VAR(Os_SchTSyncType, AUTOMATIC, OS_VAR_NOINIT) dynSync;
...
{
  return ((Os_StdReturnType)(Os_SchTGetDyn(ScheduleTable)->State == OS_SCHTSTATUS_STOPPED));                            /* SBSW_OS_FC_PRECONDITION */
}
...
{
  return ((Os_StdReturnType)(Os_SchTGetDyn(ScheduleTable)->State != OS_SCHTSTATUS_NEXT));                               /* SBSW_OS_FC_PRECONDITION */
}
...
{
  return ((Os_StdReturnType)(Os_SchTGetDyn(ScheduleTable)->State != OS_SCHTSTATUS_WAITING));                            /* SBSW_OS_FC_PRECONDITION */
}
...
{
  return Os_ErrExtendedCheck((Os_StdReturnType)(ScheduleTable->SyncKind != OS_SCHT_SYNC_KIND_IMPLICIT));
}
...
{
  return Os_ErrExtendedCheck((Os_StdReturnType)(Value <= UpperBound));
}
...
))
{
  ...
  if(Os_SchTIsSynchronizedExplicit(ScheduleTable) != 0)                                                                 /* SBSW_OS_FC_PRECONDITION */
  {
    ...
    /* #50 Set current synchronization timestamp to zero. */
    dynSync->SyncTimeStamp = 0;                                                                                         /* SBSW_OS_SCHT_SCHTSYNCGETDYN_002 */

    /* #60 If given state is RUNNING: */
    if(InitialState == OS_SCHTSTATUS_RUNNING)
    {
      /* Async start. */
      /* #70 Set schedule tables's current counter time stamp to schedule table's counter time stamp. */
...
))
{
  ...
  if(dyn->SyncState != OS_SCHTSYNCSTATUS_NOT_PROVIDED)
  {
    ...
    withinPrecision = ((Os_StdReturnType)( (        dyn->Deviation    <= ScheduleTableSync->Precision)
...
))
{
  ...
  /* #10 Activate all configured tasks. */
  {
    ...
    for(taskIdx = ((TaskType)0); taskIdx < ExPo->TaskCount; ++taskIdx)
    {
...
))
{
  ...
  /* #30 Modify the relative offset to the next expiry point in accordance to the synchronization parameters. */
  {
    ...
    if(dyn->Deviation <= OS_TIMER_TICKTYPE_MAX)
    {
...
))
{
  ...
  if((Lhs < ScheduleTableSync->DurationHalf) && (Rhs >= ScheduleTableSync->DurationHalf))
  {
    ...
    if(result >= ScheduleTableSync->DurationHalf)                                                                       /* COV_OS_NOFUNCCALL */
    {
  ...
  else if((Lhs >= ScheduleTableSync->DurationHalf) && (Rhs < ScheduleTableSync->DurationHalf))                          /* COV_OS_NOFUNCCALL */
  {
...
))
{
  ...
  /* #20 Tell the counter to handle the schedule table's job after the relative time defined
...
))
{
  ...
  /* #20 Tell the counter to handle the schedule table's job after the absolute time defined
...
)
{
  ...
  if(OS_UNLIKELY(Os_ThreadCheckCallContext(currentThread, OS_APICONTEXT_STARTSCHEDULETABLEREL) == OS_CHECK_FAILED))     /* SBSW_OS_SCHT_THREADCHECKCALLCONTEXT_001 */
  {
  ...
  else
  {
    ...
    {
      P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) callerCore = Os_ThreadGetCore(currentThread);                  /* SBSW_OS_SCHT_THREADGETCORE_001 */

      /* #40 If the given schedule table belongs to the local core call \ref Os_SchTStartScheduleTableRel(). */
      if(OS_LIKELY(Os_AppIsMemberOfCore(scheduleTable->OwnerApplication, callerCore) != 0))                             /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_SCHT_APPISMEMBEROFCORE_001 */
      {
...
)
{
  ...
  if(OS_UNLIKELY(Os_ThreadCheckCallContext(currentThread, OS_APICONTEXT_STARTSCHEDULETABLEABS) == OS_CHECK_FAILED))     /* SBSW_OS_SCHT_THREADCHECKCALLCONTEXT_001 */
  {
    status = OS_STATUS_CALLEVEL;
  }
  else if(OS_UNLIKELY(Os_SchTCheckId(ScheduleTableID) == OS_CHECK_FAILED ))
...
)
{
  ...
  /* #10 Check of schedule table ID and get schedule table configuration pointer. */
  /* #20 Perform checks of caller core/thread status (correct call context and interrupt status). */
  if(OS_UNLIKELY(Os_ThreadCheckCallContext(currentThread, OS_APICONTEXT_STOPSCHEDULETABLE) == OS_CHECK_FAILED))         /* SBSW_OS_SCHT_THREADCHECKCALLCONTEXT_001 */
  {
    status = OS_STATUS_CALLEVEL;
  }
  else if(OS_UNLIKELY(Os_SchTCheckId(ScheduleTableID) == OS_CHECK_FAILED ))
  ...
  else
  {
    ...
    else
    {
      ...
      callerCore = Os_ThreadGetCore(currentThread);                                                                     /* SBSW_OS_SCHT_THREADGETCORE_001 */
...
)
{
  ...
  /* #10 Check of schedule table ID and get schedule table configuration pointer. */
  /* #20 Perform checks of caller core/thread status (correct call context and interrupt status). */
  if(OS_UNLIKELY(Os_ThreadCheckCallContext(currentThread, OS_APICONTEXT_NEXTSCHEDULETABLE) == OS_CHECK_FAILED))         /* SBSW_OS_SCHT_THREADCHECKCALLCONTEXT_001 */
  {
    status = OS_STATUS_CALLEVEL;
  }
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_JobCheckAssignedToSameCounter(                                                               /* COV_OS_NOFUNCCALL *//* SBSW_OS_FC_PRECONDITION */
            &(scheduleTable_From->Job), &(scheduleTable_To->Job)) == OS_CHECK_FAILED))
    {
      status = OS_STATUS_ID_DIFFERENT_COUNTER;
    }
    else if(OS_UNLIKELY(Os_ErrExtendedCheck(                                                                            /* COV_OS_NOFUNCCALL */
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_AppIsMemberOfCore(scheduleTable_From->OwnerApplication, callerCore) != 0))                        /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_SCHT_APPISMEMBEROFCORE_001 */
      {
        Os_IntStateType interruptState;
...
)
{
  ...
  /* #10 Perform checks. */
  if(OS_UNLIKELY(Os_ThreadCheckCallContext(currentThread,                                                               /* SBSW_OS_SCHT_THREADCHECKCALLCONTEXT_001 */
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_AppCheckIsCoreLocal                                                                          /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_SCHT_APPCHECKISCORELOCAL_001 */ /* SBSW_OS_SCHT_THREADGETCORE_001 */
        (scheduleTable->OwnerApplication, Os_ThreadGetCore(currentThread))== OS_CHECK_FAILED))
    {
    ...
    else if(OS_UNLIKELY(Os_SchTCheckIsSynchronizedExplicitly(scheduleTable) == OS_CHECK_FAILED))                        /* COV_OS_NOFUNCCALL *//* SBSW_OS_SCHT_SCHTCHECKISSYNCHRONIZEDEXPLICITLY_001 */
    {
      status = OS_STATUS_ID_TYPE_1;
    }
    else if(OS_UNLIKELY(Os_SchTCheckIsStopped(scheduleTable) == OS_CHECK_FAILED))                                       /* COV_OS_NOFUNCCALL *//* SBSW_OS_SCHT_SCHTCHECKISSTOPPED_001 */
    {
      status = OS_STATUS_STATE_1;
    }
    else
...
)
{
  ...
  /* #10 Perform checks. */
  if(OS_UNLIKELY(Os_ThreadCheckCallContext(currentThread, OS_APICONTEXT_SYNCSCHEDULETABLE) == OS_CHECK_FAILED))         /* SBSW_OS_SCHT_THREADCHECKCALLCONTEXT_001 */
  {
    status = OS_STATUS_CALLEVEL;
  }
  else if(OS_UNLIKELY(Os_SchTCheckId(ScheduleTableID) == OS_CHECK_FAILED ))
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_AppCheckIsCoreLocal(scheduleTable->OwnerApplication, Os_ThreadGetCore(currentThread))        /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED */ /* SBSW_OS_SCHT_APPCHECKISCORELOCAL_001 */ /* SBSW_OS_SCHT_THREADGETCORE_001 */
                          == OS_CHECK_FAILED))
    {
      status = OS_STATUS_CORE;
    }
    ...
    else if(OS_UNLIKELY(Os_SchTCheckIsNotStopped(scheduleTable) == OS_CHECK_FAILED))                                    /* COV_OS_NOFUNCCALL *//* SBSW_OS_SCHT_SCHTCHECKISNOTSTOPPED_001 */
    {
      status = OS_STATUS_STATE_STOPPED;
    }
    else if(OS_UNLIKELY(Os_SchTCheckIsNotNexted(scheduleTable) == OS_CHECK_FAILED))                                     /* COV_OS_NOFUNCCALL *//* SBSW_OS_SCHT_SCHTCHECKISNOTNEXTED_001 */
    {
    ...
    else
    {
      ...
      if(OS_UNLIKELY(Os_SchTCheckUpperBound(Value, scheduleTableSync->Duration-1) == OS_CHECK_FAILED))
      {
...
)
{
  ...
  /* #10 Perform checks. */
  if(OS_UNLIKELY(Os_ThreadCheckCallContext(currentThread, OS_APICONTEXT_SETSCHEDULETABLEASYNC) == OS_CHECK_FAILED))     /* SBSW_OS_SCHT_THREADCHECKCALLCONTEXT_001 */
  {
    status = OS_STATUS_CALLEVEL;
  }
  else if(OS_UNLIKELY(Os_SchTCheckId(ScheduleTableID) == OS_CHECK_FAILED ))
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_SchTCheckIsNotWaiting(scheduleTable) == OS_CHECK_FAILED))                                    /* COV_OS_NOFUNCCALL *//* SBSW_OS_SCHT_SCHTCHECKISNOTWAITING_001 */
    {
...
#  pragma warning 541   /* This suppresses the warning with regard to "possibly uninitialized variable" for the
                           local variable "status". This can be suppressed, since Status is always initialized
                           inside the function. The function either returns status with a valid value or gets
                           stuck in KernelPanic. */
# endif
/***********************************************************************************************************************
...
)
{
  ...
  /* #10 Perform checks. */
  if(OS_UNLIKELY(Os_ThreadCheckCallContext(currentThread, OS_APICONTEXT_GETSCHEDULETABLESTATUS) == OS_CHECK_FAILED))    /* SBSW_OS_SCHT_THREADCHECKCALLCONTEXT_001 */
  {
    status = OS_STATUS_CALLEVEL;
  }
  else if(OS_UNLIKELY(Os_SchTCheckId(ScheduleTableID) == OS_CHECK_FAILED ))
...
)
{
  ...
  /* #10 If the given mode is one of the given schedule table's autostart modes: */
  if((autostartConfig->ApplicationModes & AppMode) != 0)
  {
...
)
{
  ...
  /* #10 If the given schedule table is in state NEXT, restore the previous schedule table next pointer to the initial one.*/
  if(dyn->State == OS_SCHTSTATUS_NEXT)
  {
    P2VAR(Os_SchTType, AUTOMATIC, OS_VAR_NOINIT) dynPrevious;
    dynPrevious = Os_SchTGetDyn(dyn->Previous);                                                                         /* SBSW_OS_SCHT_SCHTGETDYN_003 */
  ...
  else if (dyn->State == OS_SCHTSTATUS_RUNNING)
  {
    ...
    if(Os_SchTHasNextScheduleTable(SchT) != 0)                                                                          /* SBSW_OS_FC_PRECONDITION */
    {
...
{
  /* #10 Call internal function for starting the given schedule table relatively.  */
...
{
  /* #10 Call internal function for starting the given schedule table absolutely.  */
...
{
  /* #10 Call internal function for stopping the given schedule table.  */
...
{
  /* #10 Call internal function for nexting the given schedule tables.  */
  return Os_SchTNextScheduleTable(ScheduleTable_From, ScheduleTable_To);                                                /* SBSW_OS_FC_PRECONDITION */
}

# if defined (OS_CFG_COMPILER_TASKING)
#  pragma warning 541   /* This suppresses the warning with regard to "possibly uninitialized variable" for the
                           return value. This can be suppressed, since the function Os_SchTGetScheduleTableStatus
                           either returns the status or gets stuck in Os_ErrKernelPanic. */
# endif
/***********************************************************************************************************************
...
{
  /* #10 Call internal function for getting the given schedule table's state.  */
...
)
{
  ...
  do
  {
    ...
    /* #10 Perform expiry point actions. */
  ...
  while((currentSchT != NULL_PTR) && (relativeOffsetToNext == 0));
...
\ID SBSW_OS_SCHT_APPISMEMBEROFCORE_001
 \DESCRIPTION    Os_AppIsMemberOfCore is called with the OwnerApplication of a ScheduleTable and the return value of
                 Os_ThreadGetCore. ScheduleTable is the return value of Os_SchTId2SchT.
 \COUNTERMEASURE \M [CM_OS_SCHTGETAPPLICATION_M]
...
\ID SBSW_OS_SCHT_THREADGETCORE_001
...
\ID SBSW_OS_SCHT_APPCHECKISCORELOCAL_001
 \DESCRIPTION    Os_AppCheckIsCoreLocal function is called with the return values of Os_SchTId2SchT and
                 Os_ThreadGetCore.
 \COUNTERMEASURE \M [CM_OS_SCHTGETAPPLICATION_M]
                 \M [CM_OS_THREADGETCORE_M]
