...
#if !defined(OS_THREADINT_H)                                                                                            /* PRQA S 0883 */ /* MD_Os_0883 */
 ...
 * */
  ...
  /*! Tells whether the thread is initialized during startup or not. */
 ...
 *  Os_ThreadIsTpIsr()
 **********************************************************************************************************************/
/*! \brief        Returns whether the given thread is an Timing Protection ISR (!0) or not (0).
 *  \details      --no details--
 *
 *  \param[in]    Thread  Thread to query. Parameter must not be NULL.
 *
