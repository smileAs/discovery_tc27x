 ...
 *  Level                     | Description
 *  ------------------------- | ----------------------------------
 *  Standard Status           | For use in production phase. The OS does not check for invalid service calls or invalid parameters.
 *  Extended Status           | For use in test phase. The OS performs error checks to validate service calls and parameters.
 *  Service Protection        | Service protection prevents OS-Applications from corrupting the OS. It is an extension to Extended Status and requires additional checks. AUTOSAR requires service protection to be active in SC3 and SC4. Service protection checks are, e.g. illegal address, null-pointer, call level
 *  Assertion                 | Assertions perform OS internal plausibility checks which shall help to find invalid OS states during OS development and test. Error behavior for assertions is freeze. Assertions should not be enabled in production phase.
 *
 *
 *  Error Types
 *  -----------
...
#if !defined (OS_ERRORINT_H)                                                                                            /* PRQA S 0883 */ /* MD_Os_0883 */
 ...
 *  Os_ErrIsValueLo()
 **********************************************************************************************************************/
/*! \brief          Checks whether the provided ID (signed or unisgned) is below the provided compare value.
 *  \details        --no details--
 *
 ...
 *  \pre          -
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE,                                                /* PRQA S 3219 */ /* MD_Os_3219 */
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(Os_ExceptionContextRefType, OS_CODE)
Os_ErrorGetParameter_ExceptionContextRefType(Os_ErrorParmIndexType ParamIndex);
