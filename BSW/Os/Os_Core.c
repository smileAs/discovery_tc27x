 ...
 **********************************************************************************************************************/
OS_LOCAL FUNC(void, OS_CODE) Os_CorePreStartInit(void);
...
OS_LOCAL FUNC(void, OS_CODE) Os_CorePreStartInit(void)
{
  ...
  Os_MpCoreInit(core->MemoryProtection);                                                                                /* SBSW_OS_CORE_MPCOREINIT_001 */
...
FUNC(OS_LOCAL_INLINE void, OS_CODE) Os_CoreInit(void)
{
  ...
  /* #140 Synchronize with started AUTOSAR cores. */
  Os_BarrierSynchronizeInternal(core->Barrier);                                                                         /* SBSW_OS_CORE_BARRIERSYNCHRONIZE_001 */
...
FUNC(void, OS_CODE) Os_Api_Init(void)
{
  ...
  /* #10 If we are the hardware initialization core. */
...
)
{
  ...
  /* #10 Set last unhandled exception source ID to given ID. */
...
\ID SBSW_OS_CORE_SYSTEMINTERRUPTHANDLINGINIT_001
 ...
 \COUNTERMEASURE \M [CM_OS_SYSTEMGET_N]
