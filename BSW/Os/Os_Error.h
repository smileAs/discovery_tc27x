...
#if !defined(OS_ERROR_H)                                                                                                /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_ERROR_H
...
))
{
  ...
  if(OS_UNLIKELY(Os_ErrIsProtectionPropagationRequired(Status) != 0))
  {
    /* #20 Report the error. */
...
{
  /* #10 If there was an error: */
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0))
  {
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE StatusType, OS_CODE, OS_ALWAYS_INLINE,                                     /* PRQA S 3219 */ /* MD_Os_3219 */
Os_ErrReportCallTrustedFunction,
(
  Os_StatusType Status,
...
{
  /* #10 If there was an error: */
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0))                                                             /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    /* #20 Create error parameter object. */
    Os_ErrorParamsType errorParameters;
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE StatusType, OS_CODE, OS_ALWAYS_INLINE,                                     /* PRQA S 3219 */ /* MD_Os_3219 */ /* COV_OS_UNSUPPORTED93813 */
Os_ErrReportCallFastTrustedFunction,
(
  Os_StatusType Status,
...
{
  /* #10 If there was an error: */
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0))                                                             /* COV_OS_UNSUPPORTED93813 */
  {
    /* #20 Create error parameter object. */
    Os_ErrorParamsType errorParameters;
...
))
{
  ...
  {
    /* #20 Create error parameter object. */
    Os_ErrorParamsType errorParameters;                                                                                 /* PRQA S 3196 */ /* MD_Os_3196_Param */

    /* #30 Report the error and get the error return code. */
    Os_TrapErrApplicationError(OSServiceId_AllowAccess, Status, &errorParameters);                                      /* PRQA S 3348 */ /* MD_Os_3348_Param */ /* SBSW_OS_FC_POINTER2LOCAL */
  }
...
))
{
  ...
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0))
  {
    ...
    /* #30 Report the error and get the error return code. */
    Os_TrapErrApplicationError(OSServiceId_AlarmActionIncrementCounter, Status, &errorParameters);                      /* PRQA S 3348 */ /* MD_Os_3348_Param */ /* SBSW_OS_FC_POINTER2LOCAL */
  }
}
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE StatusType, OS_CODE, OS_ALWAYS_INLINE,                                     /* PRQA S 3219 */ /* MD_Os_3219 */ /* COV_OS_UNSUPPORTED93797 */
Os_ErrReportBarrierSynchronize,
(
  Os_StatusType Status,
...
{
  /* #10 If there was an error: */
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0))                                                             /* COV_OS_UNSUPPORTED93797 */
  {
    /* #20 Create error parameter object. */
    Os_ErrorParamsType errorParameters;
...
))
{
  ...
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0))
  {
    ...
    /* #30 Report the error and get the error return code. */
    Os_TrapErrApplicationError(OSServiceId_TerminateTask, Status, &errorParameters);                                    /* PRQA S 3348 */ /* MD_Os_3348_Param */ /* SBSW_OS_FC_POINTER2LOCAL */
  }
...
))
{
  ...
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0))
  {
    ...
    /* #30 Report the error and get the error return code. */
    Os_TrapErrApplicationError(OSServiceId_Schedule, Status, &errorParameters);                                         /* PRQA S 3348 */ /* MD_Os_3348_Param */ /* SBSW_OS_FC_POINTER2LOCAL */
  }
...
{
  return ((Os_StdReturnType)(Id < Compare));
}
...
))
{
  ...
  return ((!Os_ErrIsExtendedStatusEnabled()) || (Value));
}
...
))
{
   ...
   * Otherwise Value indicates whether the check failed or not. */
  return ((!Os_ErrIsServiceProtectionEnabled()) || (Value));
}
...
{
  if(Os_ErrIsAssertEnabled() != 0)                                                                                      /* COV_OS_INVSTATE */
  {
    if (OS_UNLIKELY(!(Condition)))
    {
      Os_ErrKernelPanic();
    }
  }
...
{
  return Os_ErrExtendedCheck((Os_StdReturnType)(Pointer != NULL_PTR));
}
...
{
  return Os_ErrExtendedCheck((Os_StdReturnType)((Value == TRUE) || (Value == FALSE)));                                  /* COV_OS_NOFUNCCALL */
}
...
))
{
  ...
  return (Os_StdReturnType)((Os_HookIsErrorHookEnabled()) && (OsStatus != OS_STATUS_OK));
}
...
))
{
  ...
  return (Os_StdReturnType)((Os_ErrIsServiceProtectionEnabled()) && (OsStatus != OS_STATUS_OK));
}
...
{
  return (OS_CFG_ASSERTIONS == STD_ON);
}
...
{
  return (OS_CFG_SERVICE_PROTECTION == STD_ON);
}
...
{
  return (OS_CFG_EXTENDED_STATUS == STD_ON);
}
