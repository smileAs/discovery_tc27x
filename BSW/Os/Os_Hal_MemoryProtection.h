...
))
{
  ...
  if(CoreConfig->MpuDataRegionCount > 0)
  {
  ...
  if(CoreConfig->MpuCodeRegionCount > 0)
  {
...
{
  /* #10 If there are MPU data regions configured which need to be reprogrammed: */
  if(AppConfig->MpuDataRegionCount > 0)
  {
    /* #20 Set up data regions */
  ...
  /* #50 If there are MPU code regions configured which need to be reprogrammed: */
  if(AppConfig->MpuCodeRegionCount > 0)                                                                                 /* COV_OS_HALUNSUPPORTEDCODEREGIONS */
  {
    /* #60 Set up code regions */
...
{
  /* #10 If there are MPU data regions configured which need to be reprogrammed: */
  if(ThreadConfig->MpuDataRegionCount > 0)
  {
    /* #20 Set up data regions */
  ...
  /* #50 If there are MPU code regions configured which need to be reprogrammed: */
  if(ThreadConfig->MpuCodeRegionCount > 0)                                                                              /* COV_OS_HALUNSUPPORTEDCODEREGIONS */
  {
    /* #60 Set up code regions */
...
))
{
  ...
  {
    Os_Hal_SetDataRegion(StartSlot + Index,                                                                             /* COV_OS_HALCOREASSEMBLERINSTRUCTIONDATACASE */
...
))
{
  ...
  for(Index=0; Index<Count; Index++)
  {
    Os_Hal_SetCodeRegion(StartSlot + Index,                                                                             /* COV_OS_HALUNSUPPORTEDCODEREGIONS */
        RegionsConfig[Index].StartAddress,
        RegionsConfig[Index].EndAddress);
  }
}                                                                                                                       /* PRQA S 6030 */ /* MD_MSR_STCYC */
