 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_ServiceStackPoolInit                                                                             /* PRQA S 3447 */ /* MD_Os_3447 */
(
  P2CONST(Os_ServiceStackPoolConfigType, AUTOMATIC, OS_CONST) StackPool
);
 ...
 *  \pre            -
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_ServiceInitInternal                                                                              /* PRQA S 3447 */ /* MD_Os_3447 */
(
  P2CONST(Os_ServiceConfigType, AUTOMATIC, OS_CONST) Service
 ...
 *  \pre            -
 **********************************************************************************************************************/
OS_LOCAL_INLINE FUNC(void, OS_CODE) Os_ServiceNtfInit                                                                   /* PRQA S 3447 */ /* MD_Os_3447 */
(
  P2CONST(Os_ServiceNtfConfigType, AUTOMATIC, OS_CONST) NonTrustedFunction
);
 ...
 *
 */
FUNC(void, OS_CODE) Os_ServiceStackPoolInit
(
  P2CONST(Os_ServiceStackPoolConfigType, AUTOMATIC, OS_CONST) StackPool
)
{
...
{
  volatile Os_StdReturnType accessible;

  /* #10 If the application is accessible, the service function is accessible. */
  accessible = Os_AppCheckIsAccessible(ServiceFunction->OwnerApplication);                                              /* SBSW_OS_SF_APPCHECKISACCESSIBLE_001 */

  /* #20 If the application is not accessible: */
  if(OS_UNLIKELY(accessible == OS_CHECK_FAILED))
  {
    /* #30 The service function is nevertheless accessible, if called during pre start phase. */
    if(OS_UNLIKELY(Os_CoreOsIsPrestarted(Os_AppGetCore(ServiceFunction->OwnerApplication)) != 0))                       /* SBSW_OS_SF_COREOSISPRESTARTED_001 */ /* SBSW_OS_SF_APPGETCORE_001 */
    {
...
{
  return (Os_StdReturnType)(StackPool->Dyn->AccessCounter[CurrentApplication] > 0);                                     /* PRQA S 3689 */ /* MD_Os_3689 */
}
...
{
  return (Os_StdReturnType)(Service->ServiceType == OS_SERVICE_TRUSTEDFUNCTION);
}
...
{
  return (Os_StdReturnType)(Service->ServiceType == OS_SERVICE_NONTRUSTEDFUNCTION);
}
...
))                                                                                                                      /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
{
  ...
  return (P2CONST(Os_ServiceTfConfigType, AUTOMATIC, OS_CONST)) Service;                                                /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
))
{
  ...
  return (P2CONST(Os_ServiceNtfConfigType, AUTOMATIC, OS_CONST)) Service;                                               /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  Os_Assert((Os_StdReturnType)(ServiceCall->Service->ServiceType == OS_SERVICE_NONTRUSTEDFUNCTION));
  return (P2VAR(Os_ServiceNtfCallType, AUTOMATIC, OS_VAR_NOINIT)) ServiceCall;                                          /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return ((Os_StdReturnType)(TrustedFunction->Context != NULL_PTR));
}
...
)
{
  ...
  else
  {
    ...
    StackPool->Dyn->AccessCounter[CurrentApplication]--;                                                                /* PRQA S 3689 */ /* MD_Os_3689 */ /* SBSW_OS_SF_ACCESSCOUNTER_001 */
...
)
{
  ...
  StackPool->Dyn->AccessCounter[Application]++;                                                                         /* PRQA S 3689 */ /* MD_Os_3689 */ /* SBSW_OS_SF_ACCESSCOUNTER_001 */
}
...
)
{
  ...
  Os_Hal_InterruptStateType userInterruptState;
  Os_Hal_ContextType tfContext;
  ...
  if(OS_UNLIKELY(Os_ServiceCheckIsAccessible(&(TrustedFunction->Base)) == OS_CHECK_FAILED))                             /* COV_OS_HALPLATFORMTESTEDASMULTICORE */ /* SBSW_OS_SF_SERVICECHECKISACCESSIBLE_001 */
  {
  ...
  else
  {
    ...
    /* #70 Trusted function specific call behavior. */
    {
      ...
      if(Os_ServiceTfNeedsModeSwitch(TrustedFunction) != 0)                                                             /* COV_OS_HALPLATFORMTESTEDASMULTICORE */ /* SBSW_OS_FC_PRECONDITION */
      {
        serviceCall.ServiceCallContext = &tfContext;
        ...
        /* #100 Prepare trusted function context. Set its parameter and interrupt state. */
        Os_Hal_ContextInit(TrustedFunction->Context, &tfContext);                                                       /* SBSW_OS_CORE_HAL_CONTEXTINIT_001 */
        Os_Hal_ContextSetParameter(&tfContext, &serviceCall);                                                           /* SBSW_OS_FC_POINTER2LOCAL */
        Os_Hal_ContextSetInterruptState(&tfContext, &userInterruptState);                                               /* SBSW_OS_FC_POINTER2LOCAL */

        /*! Internal comment removed.
 *
 *
 * */
        /* #110 Switch to prepared context. */
        Os_Hal_ContextCall(&(serviceCall.CallerContext), &tfContext);                                                   /* SBSW_OS_FC_POINTER2LOCAL */
      }
      /* #120 Otherwise: */
      else
      {
        ...
        /* #140 Call the trusted function directly. */
        TrustedFunction->Callback(FunctionIndex, FunctionParams);                                                       /* SBSW_OS_SF_CALLBACK_001 */
      }
    }

    /* #150 Suspend interrupts. */
    Os_IntSuspend(&interruptState);                                                                                     /* SBSW_OS_FC_POINTER2LOCAL */

    /* #160 General service function epilogue. */
    Os_ServiceEpilogue(&serviceCall, currentThread);                                                                    /* SBSW_OS_SF_SERVICEEPILOGUE_001 */

    /* #170 If the owner application of the trusted function has delayed timing protection configured. */
    if(hasTpDelay != 0)
    {
      /* #180 Tell timing protection to stop delay violations. */
...
)
{
  ...
  /* #30 Check whether the service is accessible. */
  if(OS_UNLIKELY(Os_ServiceCheckIsAccessible(&(NonTrustedFunction->Base)) == OS_CHECK_FAILED))                          /* COV_OS_HALPLATFORMTESTEDASMULTICORE */ /* SBSW_OS_SF_SERVICECHECKISACCESSIBLE_001 */
  {
    status = OS_STATUS_NOTACCESSIBLE_1;
  }
  ...
  else
  {
    ...
    else
    {
      ...
      /* #70 Non-Trusted function specific call behavior. */
      ntfCall.Base.ServiceCallContext = &ntfContext;
      ...
      /* #90 Prepare non-trusted function context. Set its parameter, stack and interrupt state. */
      Os_Hal_ContextInit(NonTrustedFunction->Context, &ntfContext);                                                     /* SBSW_OS_CORE_HAL_CONTEXTINIT_002 */
      Os_Hal_ContextSetParameter(&ntfContext, &ntfCall);                                                                /* SBSW_OS_FC_POINTER2LOCAL */
      Os_Hal_ContextSetStack(&ntfContext, ntfCall.Stack->HwConfig);                                                     /* SBSW_OS_CORE_HAL_CONTEXTSETSTACK_001 */
      Os_Hal_ContextSetInterruptState(&ntfContext, &userInterruptState);                                                /* SBSW_OS_FC_POINTER2LOCAL */
 ...
 * */
      ...
      Os_Hal_ContextCallOnStack(&(ntfCall.Base.CallerContext), &ntfContext);                                            /* SBSW_OS_FC_POINTER2LOCAL */

      /* #110 Suspend interrupts. */
      Os_IntSuspend(&interruptState);                                                                                   /* SBSW_OS_FC_POINTER2LOCAL */

      /* #120 General service return behavior. */
      Os_ServiceEpilogue(&ntfCall.Base, currentThread);                                                                 /* SBSW_OS_SF_SERVICEEPILOGUE_001 */

      /* #130 Release the stack. */
      Os_ServiceStackPoolReleaseStack(                                                                                  /* SBSW_OS_SF_SERVICESTACKPOOLRELEASESTACK_001 */
          NonTrustedFunction->StackPool, ntfCall.Stack, currentApplication);

      status = OS_STATUS_OK;
    }
  }

  /* #140 Resume interrupts. */
  Os_IntResume(&interruptState);                                                                                        /* SBSW_OS_FC_POINTER2LOCAL */
...
)
{
  ...
  if(Os_ServiceIsNtf(Service) != 0)                                                                                     /* SBSW_OS_FC_PRECONDITION */
  {
    /* #20 Initialize the non-trusted function. */
    Os_ServiceNtfInit(Os_Service2Ntf(Service));                                                                         /* PRQA S 0310 */ /* MD_Os_0310 */ /* SBSW_OS_FC_PRECONDITION */ /* SBSW_OS_SF_SERVICENTFINIT_001 */
  }
}
...
{
  /* #10 Unmarshal service call details and call service with given service parameters. */
...
)
{
  ...
  /* #10 For each service call: */
  while(serviceCall != OS_SERVICECALL_LIST_END)
  {
    /* #20 If the service call is a NTF: */
    if(Os_ServiceIsNtf(serviceCall->Service) != 0)                                                                      /* SBSW_OS_SF_SERVICEISNTF_001 */
    {
      P2CONST(Os_ServiceStackPoolConfigType, AUTOMATIC, OS_CONST) stackPool;
      P2CONST( Os_ServiceStackConfigType, AUTOMATIC, OS_CONST) stack;
...
)
{
  ...
  if(OS_UNLIKELY(Os_ServiceCheckTfId(FunctionIndex) == OS_CHECK_FAILED))                                                /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreCheckIsLocalCore(ownerCore, localCore) == OS_CHECK_FAILED))                                   /* COV_OS_HALPLATFORMTESTEDASMULTICORE *//* SBSW_OS_SF_CORECHECKISLOCALCORE_001 */
    {
...
)
{
  ...
  /* #10 Perform error checks. */
  if(OS_UNLIKELY(Os_ServiceCheckNtfId(FunctionIndex) == OS_CHECK_FAILED))
  {
    status = OS_STATUS_SERVICEID;
  }
  ...
  else
  {
    ...
    if(OS_UNLIKELY(Os_CoreCheckIsLocalCore(ownerCore, localCore) == OS_CHECK_FAILED))                                   /* COV_OS_HALPLATFORMMULTICOREUNSUPPORTED *//* SBSW_OS_SF_CORECHECKISLOCALCORE_001 */
    {
      status = OS_STATUS_ACCESSRIGHTS_1;
    }
    else
...
)                                                                                                                       /* COV_OS_UNSUPPORTED93813 */
{
  ...
  /* #10 Perform error checks. */
  if(OS_UNLIKELY(Os_ServiceCheckFtfId(FunctionIndex) == OS_CHECK_FAILED))                                               /* COV_OS_UNSUPPORTED93813 */
  {
    status = OS_STATUS_SERVICEID;
  }
  else
...
\ID SBSW_OS_SF_CORECHECKISLOCALCORE_001
 \DESCRIPTION    Os_CoreCheckIsLocalCore is called with the return value of Os_AppGetCore and Os_ThreadGetCore.
 \COUNTERMEASURE \M [CM_OS_THREADGETCORE_M]
                 \M [CM_OS_APPGETCORE_M]
