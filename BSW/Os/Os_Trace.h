...
#if !defined(OS_TRACE_H)                                                                                                /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_TRACE_H
...
#if !defined(OS_VCAST_INSTRUMENTATION_OS_TRACE)
...
# define OS_VTH_ACTIVATION(TaskId, DestCoreId, CallerCoreId)  \
  ...
  OS_IGNORE_UNREF_PARAM(CallerCoreId);                                                                                  /* PRQA S 3412 */ /* MD_Os_3412_Stub */
#endif
...
( void ))
{
  return (Os_StdReturnType)(OS_CFG_OSTIMINGHOOKS == STD_ON);
}
...
( void ))
{
  return (Os_StdReturnType)(OS_CFG_ORTI_ADDITIONAL == STD_ON);
}
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    if(Thread != NULL_PTR)
    {
      ...
      Os_Assert(
        (Os_StdReturnType)((Thread->Type == OS_TRACE_THREAD_TYPE_TASK) || (Thread->Type == OS_TRACE_THREAD_TYPE_ISR))); /* COV_OS_INVSTATE */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    Os_Assert((Os_StdReturnType)(Task->Type == OS_TRACE_THREAD_TYPE_TASK));
    ...
    OS_VTH_SCHEDULE((OS_TRACE_INVALID_THREAD)               ,                                                           /* SBSW_OS_TRACE_COREGETID_001 */
                    (OS_VTHP_THREAD_PREEMPT)                ,
                    (Task->Id)                              ,
                    (OS_VTHP_TASK_ACTIVATION)               ,
                    (Os_CoreGetId(Os_CoreGetCurrentCore()))  )
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    Os_Assert((Os_StdReturnType)(Current != NULL_PTR));
    Os_Assert((Os_StdReturnType)(Next    != NULL_PTR));
    ...
    /* - #40 Call the Vector timing hook (user code) for scheduling: OS_VTH_SCHEDULE(). */
    /* variable values are casted in order to assure that they cannot be written in the hook */
    OS_VTH_SCHEDULE( (Current->Id)                           ,                                                          /* SBSW_OS_TRACE_COREGETID_001 */
  ...
  if (Os_TraceIsOrtiTaskIsrTracingEnabled() != 0)
  {
...
))
{
  ...
  if (Os_TraceIsOrtiTaskIsrTracingEnabled() != 0)
  {
    ...
    if (Next->Type == OS_TRACE_THREAD_TYPE_ISR)
    {
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    Os_Assert((Os_StdReturnType)(KilledIsr != NULL_PTR));
    ...
    OS_VTH_FORCED_TERMINATION((KilledIsr->Id), (Os_CoreGetId(Os_CoreGetCurrentCore())))                                 /* SBSW_OS_TRACE_COREGETID_001 */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    Os_Assert((Os_StdReturnType)(KilledTask != NULL_PTR));
    ...
    if(IsTaskSuspended == 0)
    {
      ...
      OS_VTH_FORCED_TERMINATION((KilledTask->Id), (Os_CoreGetId(Os_CoreGetCurrentCore())))                              /* SBSW_OS_TRACE_COREGETID_001 */
...
#  pragma warning 588      /* This suppresses the warning with regard to "dead assignment to coreId". This can
                              be suppressed here, since coreId will be used in some configurations. */
# endif
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* variable values are casted in order to assure that they cannot be written in the hook */
    OS_VTH_ACTIVATION((Task->Id), ((CoreIdType) coreId), ((CoreIdType) coreId))                                         /* PRQA S 3112 */ /* MD_Os_3112_Hook */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* variable values are casted in order to assure that they cannot be written in the hook */
    OS_VTH_SETEVENT((Task->Id)                ,                                                                         /* PRQA S 3112 */ /* MD_Os_3112_Hook */
                   ((EventMaskType) EventMask),
                   ((boolean) StateChanged)   ,
                   ((CoreIdType) coreId)      ,
                   ((CoreIdType) coreId)       )
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    OS_VTH_GOT_RES((ResId), (Os_CoreGetId(Os_CoreGetCurrentCore())))                                                    /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    OS_VTH_REL_RES((ResId), (Os_CoreGetId(Os_CoreGetCurrentCore())))                                                    /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
...
# if defined (OS_CFG_COMPILER_TASKING)
#  pragma warning 549   /* This suppresses the warning with regard to "condition always true" by checking against
...
{
  /* - #10 Check if timing hooks are enabled. */
  if(Os_TraceIsTimingHookEnabled() != 0)                                                                                /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) coreAsr;
    ...
    Os_Assert((Os_StdReturnType)(Spinlock != NULL_PTR));
    ...
    if (Spinlock->SpinlockId < Os_TraceGetNumberOfConfiguredSpinlocks())
    {
      /* - #40 For configured spinlocks call: OS_VTH_REQ_SPINLOCK(). */
      OS_VTH_REQ_SPINLOCK((Spinlock->SpinlockId), (Os_CoreGetId(Os_CoreGetCurrentCore())))                              /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
    }
    else
    {
      /* - #50 For internal spinlocks call: OS_VTH_REQ_ISPINLOCK(). */
      OS_VTH_REQ_ISPINLOCK((Spinlock->SpinlockId), (Os_CoreGetId(Os_CoreGetCurrentCore())))                             /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
    }
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)                                                                                /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    ...
    if (Spinlock->SpinlockId < Os_TraceGetNumberOfConfiguredSpinlocks())
    {
      ...
      OS_VTH_GOT_SPINLOCK((Spinlock->SpinlockId), (Os_CoreGetId(Os_CoreGetCurrentCore())))                              /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
    }
    else
    {
      /* - #50 For internal   spinlocks call: OS_VTH_IGOT_SPINLOCK(). */
      OS_VTH_GOT_ISPINLOCK((Spinlock->SpinlockId), (Os_CoreGetId(Os_CoreGetCurrentCore())))                             /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
    }
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)                                                                                /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
  {
    ...
    if (Spinlock->SpinlockId < Os_TraceGetNumberOfConfiguredSpinlocks())
    {
      ...
      OS_VTH_REL_SPINLOCK((Spinlock->SpinlockId), (Os_CoreGetId(Os_CoreGetCurrentCore())))                              /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
    }
    else
    {
      /* #50 For internal   spinlocks call: OS_VTH_REL_ISPINLOCK(). */
      OS_VTH_REL_ISPINLOCK((Spinlock->SpinlockId), (Os_CoreGetId(Os_CoreGetCurrentCore())))                             /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
    }
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    OS_VTH_DISABLEDINT((OS_VTHP_ALLINTERRUPTS), (Os_CoreGetId(Os_CoreGetCurrentCore())))                                /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* - #30 Call the vector timing hook for interrupt locks: OS_VTH_DISABLEDINT(). */
    OS_VTH_DISABLEDINT((OS_VTHP_CAT2INTERRUPTS), (Os_CoreGetId(Os_CoreGetCurrentCore())))                               /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    OS_VTH_ENABLEDINT((OS_VTHP_ALLINTERRUPTS), (Os_CoreGetId(Os_CoreGetCurrentCore())))                                 /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* - #30 Call the vector timing hook for interrupt locks: OS_VTH_ENABLEDINT(). */
    OS_VTH_ENABLEDINT((OS_VTHP_CAT2INTERRUPTS), (Os_CoreGetId(Os_CoreGetCurrentCore())))                                /* PRQA S 3112 */ /* MD_Os_3112_Hook */ /* SBSW_OS_TRACE_COREGETID_001 */
...
))
{
  ...
  if (Os_TraceIsOrtiServiceTracingEnabled() != 0)
  {
    P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) core;

    core = Os_Core2AsrCore(Os_CoreGetCurrentCore());                                                                    /* SBSW_OS_TRACE_CORE2ASRCORE_001 */
    Os_CoreAsrGetTrace(core)->OrtiCurrentServiceId = ((uint8) ServiceId) + 1;                                           /* SBSW_OS_TRACE_COREASRGETTRACE_001 */ /* SBSW_OS_TRACE_COREASRGETTRACE_002 */
  }
}
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_TraceSpinlockIdType, OS_CODE, OS_ALWAYS_INLINE,                         /* PRQA S 3219 */ /* MD_Os_3219 */
