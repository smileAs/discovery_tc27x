...
#if !defined(OSINT_H)                                                                                                   /* PRQA S 0883 */ /* MD_Os_0883 */
# define OSINT_H
 ...
 *  \trace      SPEC-63736
 **********************************************************************************************************************/
#define ALARMCALLBACK(AlarmCbkName) void Os_Cbk_##AlarmCbkName(void)                                                    /* PRQA S 0342, 3453 */ /* MD_Os_0342_OsekMacro, MD_MSR_19.7 */
 ...
 *  \trace      SPEC-63736
 **********************************************************************************************************************/
# define TASK(TaskName)       void Os_Task_##TaskName(void)                                                             /* PRQA S 0342 */  /* MD_Os_0342_OsekMacro */
 ...
 *  \trace      SPEC-63736
 **********************************************************************************************************************/
# define ISR(IsrName)       void Os_Isr_##IsrName(void)                                                                 /* PRQA S 0342 */  /* MD_Os_0342_OsekMacro */
 ...
 *  \param[in]  IsrName  The ISR name.
 **********************************************************************************************************************/
# define OS_ISR1(IsrName)       OS_HAL_ISR1_DEFINE(IsrName)                                                             /* PRQA S 3453 */  /* MD_Os_3453_Decl */
...
# define OS_STATUS_TYPE_VARIANT(Status, Variant)                                                                       \
    ((uint32) (((uint32)(Variant)) << (sizeof(StatusType)*8)) | (uint32)(Status))                                       /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \trace        SPEC-2088243
 **********************************************************************************************************************/
# define OSMEMORY_IS_READABLE(x)                                                                                       \
  ( ((uint32)(x)) & ((uint32)(OS_MEM_ACCESS_TYPE_READ)) )                                                               /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \trace        SPEC-2088243
 **********************************************************************************************************************/
# define OSMEMORY_IS_WRITEABLE(x)                                                                                      \
  ( ((uint32)(x)) & ((uint32)(OS_MEM_ACCESS_TYPE_WRITE)) )                                                              /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \trace        SPEC-2088243
 **********************************************************************************************************************/
# define OSMEMORY_IS_EXECUTABLE(x)                                                                                     \
  ( ((uint32)(x)) & ((uint32)(OS_MEM_ACCESS_TYPE_EXECUTE)) )                                                            /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \trace        SPEC-2088243
 **********************************************************************************************************************/
# define OSMEMORY_IS_STACKSPACE(x)                                                                                     \
  ( ((uint32)(x)) & ((uint32)(OS_MEM_ACCESS_TYPE_STACK)) )                                                              /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
typedef enum
{
  ...
  /*! Invalid calling context. */
  OS_STATUS_CALLEVEL_SHARED_STACK             = (OS_STATUS_TYPE_VARIANT(E_OS_CALLEVEL, 1)),
  /*! Invalid calling context. */
  OS_STATUS_CALLEVEL_CROSS_CORE_SYNC          = (OS_STATUS_TYPE_VARIANT(E_OS_CALLEVEL, 2)),
  /*! OS object is accessed in the wrong order. */
  OS_STATUS_ORDER                             = (OS_STATUS_TYPE_VARIANT(E_OS_RESOURCE, 1)),
  /*! Tried to release a resource in an non LIFO order. */
  OS_STATUS_LIFO_TOP_IS_SPINLOCK              = (OS_STATUS_TYPE_VARIANT(E_OS_RESOURCE, 2)),
  /*! Tried to release a spinlock in an non LIFO order. */
  OS_STATUS_LIFO_TOP_IS_RESOURCE              = (OS_STATUS_TYPE_VARIANT(E_OS_RESOURCE, 3)),
  /*! No access for object given in parameter 1. */
  OS_STATUS_ACCESSRIGHTS_1                    = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 1)),
  /*! No access for object given in parameter 2. */
  OS_STATUS_ACCESSRIGHTS_2                    = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 2)),
  /*! Application state for object given in parameter 1 is not accessible. */
  OS_STATUS_NOTACCESSIBLE_1                   = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 3)),
  /*! Application state for object given in parameter 2 is not accessible. */
  OS_STATUS_NOTACCESSIBLE_2                   = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 4)),
  /*! ID given in parameter 1 does not belong to an extended task. */
  OS_STATUS_NOEXTENDEDTASK_1                  = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 5)),
  /*! ID given in parameter 2 does not belong to an extended task. */
  OS_STATUS_NOEXTENDEDTASK_2                  = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 6)),
  /*! The caller is not an extended task. */
  OS_STATUS_NOEXTENDEDTASK_CALLER             = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 7)),
  /*! The given lock is already locked. */
  OS_STATUS_LOCKED                            = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 8)),
  /*! The given object has an invalid priority. */
  OS_STATUS_PRIORITY                          = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 9)),
  /*! The caller is not the owner of the accessed object in parameter 1. */
  OS_STATUS_NOT_THE_OWNER_1                   = (OS_STATUS_TYPE_VARIANT(E_OS_ACCESS, 10)),
  /*! ID given in parameter 1 is invalid. */
  OS_STATUS_ID_1                              = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 1)),
  /*! ID given in parameter 2 is invalid. */
  OS_STATUS_ID_2                              = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 2)),
  /*! Type given in parameter 1- is invalid. */
  OS_STATUS_ID_TYPE_1                         = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 3)),
  /*! Type given objects are assigned to different counters. */
  OS_STATUS_ID_DIFFERENT_COUNTER              = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 4)),
  /*! Type given objects have different synchronization types. */
  OS_STATUS_ID_DIFFERENT_SYNC                 = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 5)),
  /*! The requested hook is not available. */
  OS_STATUS_HOOK_NOT_AVAILABLE                = (OS_STATUS_TYPE_VARIANT(E_OS_ID, 6)),
  /*! OS object is currently unlocked. */
  OS_STATUS_UNLOCKED                          = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 1)),
  /*! OS object given in parameter 1 is currently not in use. */
  OS_STATUS_NOFUNC_1                          = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 2)),
  /*! OS object given in parameter 2 is currently not in use. */
  OS_STATUS_NOFUNC_2                          = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 3)),
  /*! OS object given in parameter 1 is currently not in use. */
  OS_STATUS_SPINLOCK_ORDER                    = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 4)),
  /*! OS object given in parameter 1 is currently stopped. */
  OS_STATUS_STOPPED_1                         = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 5)),
  /*! OS object given in parameter 2 is currently not stopped. */
  OS_STATUS_NOT_STOPPED_2                     = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 6)),
  /*! OS object given in parameter 1 is currently nexted. */
  OS_STATUS_NEXTED_1                          = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 7)),
  /*! Operation not permitted when killing is disabled. */
  OS_STATUS_KILLING_IS_DISABLED               = (OS_STATUS_TYPE_VARIANT(E_OS_NOFUNC, 8)),
  /*! OS object is not in correct state to perform the requested operation. */
  OS_STATUS_STATE_1                           = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 1)),
  /*! OS object is not in correct state to perform the requested operation. */
  OS_STATUS_STATE_2                           = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 2)),
  /*! OS object is in stopped state and not allowed to perform the requested operation. */
  OS_STATUS_STATE_STOPPED                     = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 3)),
  /*! OS object is in running state and not allowed to perform the requested operation. */
  OS_STATUS_STATE_RUNNING                     = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 4)),
  /*! OS object is in next state and not allowed to perform the requested operation. */
  OS_STATUS_STATE_NEXTED                      = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 5)),
  /*! OS object is in waiting state and not allowed to perform the requested operation. */
  OS_STATUS_STATE_WAITING                     = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 6)),
  /*! The current application is not in the restarting state. */
  OS_STATUS_STATE_NO_RESTART                  = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 7)),
  /*! Termination requested for an application which is already terminated. */
  OS_STATUS_STATE_ALREADY_TERMINATED          = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 8)),
  /*! The application is restarting AND the caller does not belong to the application. */
  OS_STATUS_STATE_RESTARTING_NO_MEMBER        = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 9)),
  /*! Restart requested for an application which is already restarting. */
  OS_STATUS_STATE_ALREADY_RESTARTING          = (OS_STATUS_TYPE_VARIANT(E_OS_STATE, 10)),
  /*! Value given in parameter 1 is zero. */
  OS_STATUS_VALUE_IS_ZERO_1                   = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 1)),
  /*! Value given in parameter 2 is zero. */
  OS_STATUS_VALUE_IS_ZERO_2                   = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 2)),
  /*! Value given in parameter 1 is to high. */
  OS_STATUS_VALUE_IS_TOO_HIGH_1               = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 3)),
  /*! Value given in parameter 2 is to high. */
  OS_STATUS_VALUE_IS_TOO_HIGH_2               = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 4)),
  /*! Value given in parameter 3 is to high. */
  OS_STATUS_VALUE_IS_TOO_HIGH_3               = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 5)),
  /*! Value given in parameter 1 is out of bounds. */
  OS_STATUS_VALUE_IS_OUT_OF_BOUNDS_1          = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 6)),
  /*! Value given in parameter 2 is out of bounds. */
  OS_STATUS_VALUE_IS_OUT_OF_BOUNDS_2          = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 7)),                                /* PRQA S 0779 */ /* MD_Os_0779 */
  /*! Value given in parameter 1 is to low. */
  OS_STATUS_VALUE_IS_TOO_LOW_1                = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 8)),
  /*! Value given in parameter 2 is to low. */
  OS_STATUS_VALUE_IS_TOO_LOW_2                = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 9)),
  /*! Value given in parameter 3 is to low. */
  OS_STATUS_VALUE_IS_TOO_LOW_3                = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 10)),
  /*! Value given in parameter 2 has to be TRUE or FALSE. */
  OS_STATUS_VALUE_IS_NOT_BOOLEAN              = (OS_STATUS_TYPE_VARIANT(E_OS_VALUE, 11)),
  /*! The data passed to the receiver of a cross core request is invalid. */
  OS_STATUS_CORE_CROSS_DATA                   = (OS_STATUS_TYPE_VARIANT(E_OS_CORE, 1)),
  /*! Pointer given in parameter 1 is null. */
  OS_STATUS_PARAM_POINTER_1                   = (OS_STATUS_TYPE_VARIANT(E_OS_PARAM_POINTER, 1)),
  /*! Pointer given in parameter 2 is null. */
  OS_STATUS_PARAM_POINTER_2                   = (OS_STATUS_TYPE_VARIANT(E_OS_PARAM_POINTER, 2)),
  /*! Pointer given in parameter 3 is null. */
  OS_STATUS_PARAM_POINTER_3                   = (OS_STATUS_TYPE_VARIANT(E_OS_PARAM_POINTER, 3)),
  /*! Not enough Non-Trusted Function stacks configured to execute an additional Non-Trusted Function instance. */
  OS_STATUS_NO_NTFSTACK_POOL_EMPTY            = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_NO_NTFSTACK, 1)),
  /*! Not enough Non-Trusted Function stacks configured for the caller application. */
  OS_STATUS_NO_NTFSTACK_APPLIMIT_EXCEEDED     = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_NO_NTFSTACK, 2)),
  /*! Hardware does not support to clear an interrupt pending flag */
  OS_STATUS_UNIMPLEMENTED_CLEARPENDING        = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_UNIMPLEMENTED_FUNCTIONALITY, 1)),
  /*! The functionality of exception context manipulation is not implemented for this hardware */
  OS_STATUS_UNIMPLEMENTED_EXCEPTIONCONTEXT    = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_UNIMPLEMENTED_FUNCTIONALITY, 2)),
  /*! The calling Task is not configured to participate in the given barrier */
  OS_STATUS_NO_BARRIER_PARTICIPANT            = (OS_STATUS_TYPE_VARIANT(E_OS_SYS_NO_BARRIER_PARTICIPANT, 1))
