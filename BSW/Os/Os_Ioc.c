 ...
 *  \return     Status code.
 **********************************************************************************************************************/
#define OS_IOC_INTERNAL_STATUS(Status)                                                                                 \
  ((uint32) (((uint32)(Status)) << (sizeof(Std_ReturnType)*8)) | (uint32)0xFF)                                          /* PRQA S 3453 */ /* MD_Os_3453_Decl */
...
typedef enum
{
  ...
  /*! Queue overflow detected, send was unsuccessful. */
  OS_IOC_E_INTERNAL_LIMIT               = IOC_E_LIMIT,
  /*! Channel is inactive because of an earlier detected internal error. */
  OS_IOC_E_INTERNAL_CHANNEL_CLOSED      = OS_IOC_INTERNAL_STATUS(1),
  /*! Channel shall be closed because of internal error (e.g. read/write-index out of range). */
  OS_IOC_E_INTERNAL_CLOSE_CHANNEL       = OS_IOC_INTERNAL_STATUS(2)
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 **********************************************************************************************************************/
FUNC(void, OS_CODE) Os_IocInitInternal                                                                                  /* PRQA S 3447 */ /* MD_Os_3447 */
(
  P2CONST(Os_IocConfigType, AUTOMATIC, OS_CONST) Ioc
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE, Os_IocHasCallbacks,
(
  void
))
{
  /* #10 Return the general configuration switch. */
  return (OS_CFG_IOC_HAS_CALLBACKS != STD_OFF);
}
...
))
{
  ...
  return (P2CONST(Os_IocWriteConfigType, AUTOMATIC, OS_CONST))Ioc;                                                      /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  /* #10 Perform cast on given pointer. */
  return (P2CONST(Os_Ioc08ReceiveConfigType, AUTOMATIC, OS_CONST))Ioc;                                                  /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  /* #10 Perform cast on given pointer. */
  return (P2CONST(Os_Ioc16ReceiveConfigType, AUTOMATIC, OS_CONST))Ioc;                                                  /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  /* #10 Perform cast on given pointer. */
  return (P2CONST(Os_Ioc32ReceiveConfigType, AUTOMATIC, OS_CONST))Ioc;                                                  /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  /* #10 Perform cast on given pointer. */
  return (P2CONST(Os_IocRefReceiveConfigType, AUTOMATIC, OS_CONST))Ioc;                                                 /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_Ioc08MultiReceiveConfigType, AUTOMATIC, OS_CONST))Ioc;                                             /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_Ioc16MultiReceiveConfigType, AUTOMATIC, OS_CONST))Ioc;                                             /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_Ioc32MultiReceiveConfigType, AUTOMATIC, OS_CONST))Ioc;                                             /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_IocRefMultiReceiveConfigType, AUTOMATIC, OS_CONST))Ioc;                                            /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_Ioc08SendConfigType, AUTOMATIC, OS_CONST))Ioc;                                                     /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_Ioc16SendConfigType, AUTOMATIC, OS_CONST))Ioc;                                                     /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_Ioc32SendConfigType, AUTOMATIC, OS_CONST))Ioc;                                                     /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2CONST(Os_IocRefSendConfigType, AUTOMATIC, OS_CONST))Ioc;                                                    /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  /* #10 Call initialization functions of sub classes */
  switch(Ioc->SubClass)
  {
    case Ioc08Receive:
...
{
  return (Os_StdReturnType)(Ioc->Dyn->State == OS_IOCCHANNELSTATE_ENABLED);
}
...
{
  return (P2VAR(Os_IocMultiReceiveType volatile, AUTOMATIC, OS_VAR_NOINIT))(Ioc->Base.Dyn);                             /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2VAR(Os_IocReceiveType volatile, AUTOMATIC, OS_VAR_NOINIT))(Ioc->Base.Dyn);                                  /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
{
  return (P2VAR(Os_IocSendType volatile, AUTOMATIC, OS_VAR_NOINIT))(Ioc->Base.Dyn);                                     /* PRQA S 0310 */ /* MD_Os_0310 */
}
...
))
{
  ...
  /* #10 Perform checks. */
  if(OS_UNLIKELY(Os_IocChannelIsEnabled(&(Ioc->Ioc.Base)) == 0))                                                        /* COV_OS_INVSTATE *//* SBSW_OS_FC_PRECONDITION */
  {
    status = OS_IOC_E_INTERNAL_CHANNEL_CLOSED;
  }
  else if(OS_UNLIKELY(Os_IocChannelIsEnabled(&(Ioc->Ioc.Send->Base)) == 0))                                             /* COV_OS_INVSTATE *//* SBSW_OS_IOC_IOCCHANNELISENABLED_001 */
  {
    status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;
  }
  else if(OS_UNLIKELY(Os_Fifo08IndicesInRangeOnRead(&(Ioc->FifoRead)) == 0))                                            /* COV_OS_INVSTATE *//* SBSW_OS_FC_PRECONDITION */
  {
    status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;
  }
  else if(OS_UNLIKELY(Os_Fifo08IsEmpty(&(Ioc->FifoRead)) != 0))                                                         /* SBSW_OS_FC_PRECONDITION */
  {
...
))
{
  ...
  else if(OS_UNLIKELY(Os_Fifo16IndicesInRangeOnRead(&(Ioc->FifoRead)) == 0))                                            /* COV_OS_INVSTATE *//* SBSW_OS_FC_PRECONDITION */
  {
    status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;
  }
  else if(OS_UNLIKELY(Os_Fifo16IsEmpty(&(Ioc->FifoRead)) != 0))                                                         /* SBSW_OS_FC_PRECONDITION */
  {
    if(OS_UNLIKELY(Os_IocCheckNoDataLost(&(Ioc->Ioc)) == OS_CHECK_FAILED))                                              /* SBSW_OS_FC_PRECONDITION */
    {
      status = OS_IOC_E_INTERNAL_LOST_AND_NO_DATA;
...
))
{
  ...
  else if(OS_UNLIKELY(Os_Fifo32IndicesInRangeOnRead(&(Ioc->FifoRead)) == 0))                                            /* COV_OS_INVSTATE *//* SBSW_OS_FC_PRECONDITION */
  {
    status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;
  }
  else if(OS_UNLIKELY(Os_Fifo32IsEmpty(&(Ioc->FifoRead)) != 0))                                                         /* SBSW_OS_FC_PRECONDITION */
  {
    if(OS_UNLIKELY(Os_IocCheckNoDataLost(&(Ioc->Ioc)) == OS_CHECK_FAILED))                                              /* SBSW_OS_FC_PRECONDITION */
    {
      status = OS_IOC_E_INTERNAL_LOST_AND_NO_DATA;
...
))
{
  ...
  else if(OS_UNLIKELY(Os_FifoRefIndicesInRangeOnRead(&(Ioc->FifoRead)) == 0))                                           /* COV_OS_INVSTATE *//* SBSW_OS_FC_PRECONDITION */
  {
    status = OS_IOC_E_INTERNAL_CLOSE_CHANNEL;
  }
  else if(OS_UNLIKELY(Os_FifoRefIsEmpty(&(Ioc->FifoRead)) != 0))                                                        /* SBSW_OS_FC_PRECONDITION */
  {
    if(OS_UNLIKELY(Os_IocCheckNoDataLost(&(Ioc->Ioc)) == OS_CHECK_FAILED))                                              /* SBSW_OS_FC_PRECONDITION */
    {
      status = OS_IOC_E_INTERNAL_LOST_AND_NO_DATA;
 ...
 *
 */
FUNC(Std_ReturnType, OS_CODE) Os_Ioc08MultiReceive                                                                      /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      for(receiveChannelCounter = 0; receiveChannelCounter < Ioc->Ioc.ReceiveChannelCount; receiveChannelCounter++)
      {
        ...
        currentReceiveIdx++;
        if (currentReceiveIdx >= Ioc->Ioc.ReceiveChannelCount)
        {
          currentReceiveIdx = 0;
        }
      }
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY((Os_IocChannelIsEnabled(&(Ioc->Ioc.Receive->Base)) == 0)))                                      /* COV_OS_INVSTATE *//* SBSW_OS_IOC_IOCCHANNELISENABLED_002 */
    {
      Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                              /* SBSW_OS_FC_PRECONDITION */
      status = IOC_E_LIMIT;
    }
    else if(OS_UNLIKELY((Os_Fifo08IndicesInRangeOnWrite(&(Ioc->FifoWrite)) == 0)))                                      /* COV_OS_INVSTATE *//* SBSW_OS_FC_PRECONDITION */
    {
      Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                              /* SBSW_OS_FC_PRECONDITION */
      status = IOC_E_LIMIT;
    }
 ...
 *
 */
FUNC(Std_ReturnType, OS_CODE) Os_Ioc16MultiReceive                                                                      /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY((Os_Fifo16IndicesInRangeOnWrite(&(Ioc->FifoWrite)) == 0)))                                      /* COV_OS_INVSTATE *//* SBSW_OS_FC_PRECONDITION */
    {
      Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                              /* SBSW_OS_FC_PRECONDITION */
      status = IOC_E_LIMIT;
    }
 ...
 *
 */
FUNC(Std_ReturnType, OS_CODE) Os_Ioc32MultiReceive                                                                      /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY((Os_IocChannelIsEnabled(&(Ioc->Ioc.Receive->Base)) == 0)))                                      /* COV_OS_INVSTATE *//* SBSW_OS_IOC_IOCCHANNELISENABLED_001 */
    {
      Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                              /* SBSW_OS_FC_PRECONDITION */
      status = IOC_E_LIMIT;
    }
    else if(OS_UNLIKELY((Os_Fifo32IndicesInRangeOnWrite(&(Ioc->FifoWrite)) == 0)))                                      /* COV_OS_INVSTATE *//* SBSW_OS_FC_PRECONDITION */
    {
      Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                              /* SBSW_OS_FC_PRECONDITION */
      status = IOC_E_LIMIT;
    }
 ...
 *
 */
FUNC(Std_ReturnType, OS_CODE) Os_IocRefMultiReceive                                                                     /* COV_OS_HALPLATFORMTESTEDASMULTICORE */
(
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY((Os_FifoRefIndicesInRangeOnWrite(&(Ioc->FifoWrite)) == 0)))                                     /* COV_OS_INVSTATE *//* SBSW_OS_FC_PRECONDITION */
    {
      Os_IocSendCloseChannel(&(Ioc->Ioc));                                                                              /* SBSW_OS_FC_PRECONDITION */
      status = IOC_E_LIMIT;
    }
