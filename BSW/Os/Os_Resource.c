...
)
{
  ...
  while(Os_LockListIsEmpty(it) == 0)                                                                                    /* SBSW_OS_RES_LOCKLISTISEMPTY_001 */
  {
    ...
    if(Os_LockListIsTopRes(it) != 0)                                                                                    /* COV_OS_HALPLATFORMTESTEDASMULTICORE */ /* SBSW_OS_RES_LOCKLISTISTOPRES_001 */
    {
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_LockListCheckTopIsRes(lockList) == OS_CHECK_FAILED))                                         /* COV_OS_HALPLATFORMTESTEDASMULTICORE *//* SBSW_OS_RES_LOCKLISTCHECKTOPISRES_002 */
    {
