 ...
 *  schedule table expiry point. In any case, it is signaled to the external tracing tool be a call of the
 *  macro OS_VTH_ACTIVATION().
 *
...
#if !defined(OS_TRACEINT_H)                                                                                             /* PRQA S 0883 */ /* MD_Os_0883 */
...
typedef enum
{
  ...
  OsOrtiApiIdInitMemory                  = 0x9Au,  /*!< Os_InitMemory() */
  OsOrtiApiIdInit                        = 0x9Cu,  /*!< Os_Init() */
