...
# define OS_FLATTEN                  
# define PS_PURE                     
# define OS_LIKELY(x)                (x)                                                                                /* PRQA S 3453 */ /* MD_MSR_19.7 */
# define OS_UNLIKELY(x)              (x)                                                                                /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 */
# define OS_HAL_EXPAND(x)  OS_HAL_EXPAND1(x)                                                                            /* PRQA S 3453 */ /* MD_MSR_19.7 */
# define OS_HAL_EXPAND1(x) (x)                                                                                          /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mfcr(x)           Os_Hal_DummyRead(x)                                                                   /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mtcr(x, y)        (void)Os_Hal_DummyRead(y)                                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Clz(x)            Os_Hal_DummyRead(x)                                                                   /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mta11(x)          (void)Os_Hal_DummyRead(x)                                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mta10(x)          (void)Os_Hal_DummyRead(x)                                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mta8(x)           (void)Os_Hal_DummyRead(x)                                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mta2(x)           (void)Os_Hal_DummyRead(x)                                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 *  \pre           -
 */
# define Os_Hal_Mta4(x)           (void)Os_Hal_DummyRead(x)                                                             /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
# define Os_Hal_DeclareTrapFunction(name, parameters, id) \
         OS_FUNC_ATTRIBUTE_DECLARATION(void, OS_CODE, OS_HAL_NOINLINE, name, parameters)                                /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_Hal_Mfa10, (void))                   /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
{
  return 0;
}
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_Hal_Mfa11, (void))                   /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
{
  return 0;
}
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_Hal_Mfa8, (void))                    /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
{
  return 0;
}
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_Hal_CmpSwap,                         /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
(volatile uint32* x, uint32 y, uint32 z))
{
  if(*x == z)
  {
...
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE uint32, OS_CODE, OS_ALWAYS_INLINE, Os_Hal_DummyRead, (uint32 x))           /* PRQA S 3219 */ /* MD_Os_Hal_3219 */
{
