 ...
 *
 *  ###ISR1 Problem
 *  ISR1 bypass the OS. For this reason an ISR1 may get terminated in case it is executed, while the budget of a
 *  monitored entity is exhausted.
 *
...
#if !defined (OS_TIMINGPROTECTIONINT_H)                                                                                 /* PRQA S 0883 */ /* MD_Os_0883 */
...
#define OS_TP_CASTCONFIG_TPOWNERTHREAD_2_TPTHREAD(tpOwnerThread)                                                       \
    (&((tpOwnerThread).Base))                                                                                           /* PRQA S 3453 */ /* MD_MSR_19.7 */

/*! Type cast from Os_TpThreadConfigType to Os_TpThreadConfigType* (for symmetry reasons and to ease generation. */
#define OS_TP_CASTCONFIG_TPTHREAD_2_TPTHREAD(tpThread)                                                                 \
    (&((tpThread)))                                                                                                     /* PRQA S 3453 */ /* MD_MSR_19.7 */
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE                                                                           /* PRQA S 3219 */ /* MD_Os_3219 */
