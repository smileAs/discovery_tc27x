 ...
 * \brief		Primitives definition on the Aurix TC2xx platform
 *
 * \{
 *
 * \file       Os_Hal_InterruptController_AurixTC2xx_IRInt.h
...
#if !defined(OS_HAL_INTERRUPTCONTROLLER_AURIXTC2XX_IRINT_H)
# define OS_HAL_INTERRUPTCONTROLLER_AURIXTC2XX_IRINT_H
...
# define OS_HAL_INT_SRC_TOS_MASK            0x00001800UL
...
#endif /* OS_HAL_INTERRUPTCONTROLLER_AURIXTC2XX_IRINT_H */

/*!
 * \}
 */
/**********************************************************************************************************************
 *  END OF FILE: Os_Hal_InterruptController_AurixTC2xx_IRInt.h
 *********************************************************************************************************************/
