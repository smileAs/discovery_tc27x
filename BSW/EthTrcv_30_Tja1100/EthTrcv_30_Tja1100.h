...
/* supported version */
# define ETHTRCV_30_TJA1100_SW_MAJOR_VERSION                           1U
...
# define ETHTRCV_30_TJA1100_SID_GET_VERSION_INFO                    (0x09U) /*!< Service ID: EthTrcv_30_Tja1100_GetVersionInfo() */
...
# define ETHTRCV_30_TJA1100_SID_SET_PHY_TEST_MODE                   (0x10U) /*!< Service ID: EthTrcv_30_Tja1100_SetPhyTestMode() */
# define ETHTRCV_30_TJA1100_SID_SET_PHY_LOOPBACK_MODE               (0x11U) /*!< Service ID: EthTrcv_30_Tja1100_SetPhyLoopbackMode() */
# define ETHTRCV_30_TJA1100_SID_GET_PHY_SIGNAL_QUALITY              (0x12U) /*!< Service ID: EthTrcv_30_Tja1100_GetPhySignalQuality() */
...
FUNC(void, ETHTRCV_30_TJA1100_CODE) EthTrcv_30_Tja1100_Init(
    P2CONST(EthTrcv_30_Tja1100_ConfigType, AUTOMATIC, AUTOMATIC) CfgPtr);
 ...
 *  \pre         EthTrcv_30_Tja1100_Init() has been called .
 *  \context     TASK
 *  \reentrant   TRUE
 *  \synchronous TRUE
 *********************************************************************************************************************/
 ...
 *  \synchronous TRUE
 *********************************************************************************************************************/
FUNC(void, ETHTRCV_30_TJA1100_CODE) EthTrcv_30_Tja1100_MainFunction(
    void );
