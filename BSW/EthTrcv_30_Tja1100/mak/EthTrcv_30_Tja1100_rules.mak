###############################################################################
# File Name  : EthTrcv_30_Tja1100_rules.mak                                   #
...
# ----------   ------- ------  -----------------------------------------------#
# 2011/09/26   1.00    vishaw  Created                                        #
# 2011/09/29   1.01    vishaw  ESCAN00054283 -                                #
#                              Renamed EthTrcv_30_Tja1100_FILES to            #
#                                      EthTrcv_30_Tja1100_FILES               #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += EthTrcv_30_Tja1100
EthTrcv_30_Tja1100_FILES    = EthTrcv_30_Tja1100\EthTrcv_30_Tja1100.c EthTrcv_30_Tja1100\EthTrcv_30_Tja1100_LL.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += EthTrcv_30_Tja1100\EthTrcv_30_Tja1100.c EthTrcv_30_Tja1100\EthTrcv_30_Tja1100_LL.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\EthTrcv_30_Tja1100_Lcfg.c $(GENDATA_DIR)\EthTrcv_30_Tja1100_HwCfg.c
