 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Eth_30_Tricore.h
 *        \brief  Public header file of the Eth_30_Tricore Ethernet controller driver
 *
 ...
 *                                              Eth_30_Tricore_MulticastBucketCounters, Eth_30_Tricore_PromiscuousModeCounter
 *********************************************************************************************************************/

# if !defined(ETH_30_TRICORE_H)
# define     ETH_30_TRICORE_H
...
/* ETH ApiIds */
# define ETH_30_TRICORE_SID_INIT                        (0x01U) /*!< Service ID: Eth_30_Tricore_Init() */
# define ETH_30_TRICORE_SID_CONTROLLER_INIT             (0x02U) /*!< Service ID: Eth_30_Tricore_ControllerInit() */
# define ETH_30_TRICORE_SID_SET_CONTROLLER_MODE         (0x03U) /*!< Service ID: Eth_30_Tricore_SetControllerMode() */
# define ETH_30_TRICORE_SID_GET_CONTROLLER_MODE         (0x04U) /*!< Service ID: Eth_30_Tricore_GetControllerMode() */
# define ETH_30_TRICORE_SID_WRITE_MII                   (0x05U) /*!< Service ID: Eth_30_Tricore_WriteMii() */
# define ETH_30_TRICORE_SID_READ_MII                    (0x06U) /*!< Service ID: Eth_30_Tricore_ReadMii() */
# define ETH_30_TRICORE_SID_GET_COUNTER_STATE           (0x07U) /*!< Service ID: Eth_30_Tricore_GetCounterState() */
# define ETH_30_TRICORE_SID_GET_PHYS_ADDR               (0x08U) /*!< Service ID: Eth_30_Tricore_GetPhysAddr() */
# define ETH_30_TRICORE_SID_PROVIDE_TX_BUFFER           (0x09U) /*!< Service ID: Eth_30_Tricore_ProvideTxBuffer() */
# define ETH_30_TRICORE_SID_TRANSMIT                    (0x0AU) /*!< Service ID: Eth_30_Tricore_Transmit() */
# define ETH_30_TRICORE_SID_UPDATE_PHYS_ADDR_FILTER     (0x12U) /*!< Service ID: Eth_30_Tricore_UpdatePhysAddrFilter() */
# define ETH_30_TRICORE_SID_SET_PHYS_ADDR               (0x13U) /*!< Service ID: Eth_30_Tricore_SetPhysAddr() */
# define ETH_30_TRICORE_SID_RECEIVE                     (0x0BU) /*!< Service ID: Eth_30_Tricore_Receive() */
# define ETH_30_TRICORE_SID_TX_CONFIRMATION             (0x0CU) /*!< Service ID: Eth_30_Tricore_TxConfirmation() */
# define ETH_30_TRICORE_SID_GET_VERSION_INFO            (0x0DU) /*!< Service ID: Eth_30_Tricore_GetVersionInfo() */

/* ETH DET errors */
# define ETH_30_TRICORE_E_NO_ERROR                       (0x00U) /*!< used to check if no error occurred - use a value unequal to any error code */
# define ETH_30_TRICORE_E_INV_CTRL_IDX                   (0x01U) /*!< Error code: API called with wrong controller index */
# define ETH_30_TRICORE_E_NOT_INITIALIZED                (0x02U) /*!< Error code: API called while module was not initialized correctly */
# define ETH_30_TRICORE_E_INV_POINTER                    (0x03U) /*!< Error code: API called with wrong pointer parameter (NULL_PTR) */
# define ETH_30_TRICORE_E_INV_PARAM                      (0x04U) /*!< Error code: API called with invalid parameter */
# define ETH_30_TRICORE_E_INV_CONFIG                     (0x05U)
# define ETH_30_TRICORE_E_INV_MODE                       (0x06U) /*!< Error code: API called while module was in an invalid mode */
# define ETH_30_TRICORE_E_FRAMES_LOST                    (0x07U)
 ...
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_ControllerInit(
  uint8 CtrlIdx,
  uint8 CfgIdx);
 ...
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_SetControllerMode(
  uint8        CtrlIdx,
 ...
 *              - If API optimization is enabled, parameter CtrlIdx is void
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_GetControllerMode(
        uint8                                          CtrlIdx,
 ...
 *              - If API optimization is enabled, parameter CtrlIdx is void
 **********************************************************************************************************************/
FUNC(void, ETH_30_TRICORE_CODE) Eth_30_Tricore_GetPhysAddr(
        uint8                                   CtrlIdx,
 ...
 *              - If API optimization is enabled, parameter CtrlIdx is void
 *********************************************************************************************************************/
FUNC (void, ETH_30_TRICORE_CODE) Eth_30_Tricore_SetPhysAddr(
          uint8                                   CtrlIdx,
 ...
 *              - If API optimization is enabled, parameter CtrlIdx is void
 *********************************************************************************************************************/
FUNC (Std_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_UpdatePhysAddrFilter(
          uint8                                   CtrlIdx,
  P2CONST(uint8, AUTOMATIC, ETH_30_TRICORE_APPL_DATA) PhysAddrPtr,
...
FUNC(Eth_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_WriteMii(
  ...
  uint8  RegIdx,
  uint16 RegVal);
# endif /* ETH_30_TRICORE_MII_INTERFACE */
 ...
 *              - If API optimization is enabled, parameter CtrlIdx is void
 **********************************************************************************************************************/
FUNC(Eth_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_ReadMii(
         uint8                                   CtrlIdx,
         uint8                                   TrcvIdx,
         uint8                                   RegIdx,
 ...
 *              - If API optimization is enabled, parameter CtrlIdx is void
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_GetCounterState(
         uint8                                   CtrlIdx,
        uint16                                   CtrOffs,
  P2VAR(uint32, AUTOMATIC, ETH_30_TRICORE_APPL_DATA) CtrValPtr);
# endif /* ETH_30_TRICORE_ENABLE_MIB_COUNTER */
 ...
 *              - If API optimization is enabled, parameter CtrlIdx is void
 **********************************************************************************************************************/
FUNC(BufReq_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_ProvideTxBuffer(
        uint8                                           CtrlIdx,
 ...
 *              - If API optimization is enabled, parameter CtrlIdx is void
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_Transmit(
          uint8                               CtrlIdx,
          uint8                               BufIdx,
          Eth_FrameType                       FrameType,
          boolean                             TxConfirmation,
          uint16                              LenByte,
  P2CONST(uint8, AUTOMATIC, ETH_30_TRICORE_CONST) PhysAddrPtr);
 ...
 **********************************************************************************************************************/
FUNC(void, ETH_30_TRICORE_CODE_ISR) Eth_30_Tricore_Receive(
        uint8                                             CtrlIdx,
  P2VAR(Eth_RxStatusType, AUTOMATIC, ETH_30_TRICORE_APPL_VAR) RxStatusPtr);
 ...
 *              - If API optimization is enabled, parameter CtrlIdx is void
 **********************************************************************************************************************/
FUNC(Std_ReturnType, ETH_30_TRICORE_CODE) Eth_30_Tricore_VTransmit(
  uint8                                    CtrlIdx,
  uint8                                    BufIdx,
  Eth_FrameType                            FrameType,
  boolean                                  TxConfirmation,
  uint16                                   LenByte,
  P2CONST(uint8, AUTOMATIC, ETH_30_TRICORE_CONST) PhysAddrPtrDst,
  P2CONST(uint8, AUTOMATIC, ETH_30_TRICORE_CONST) PhysAddrPtrSrc);
 ...
 *              - When interrupt mode is enabled this function must not be called except from the interrupt handler
 **********************************************************************************************************************/
FUNC(void, ETH_30_TRICORE_CODE_ISR) Eth_30_Tricore_TxConfirmation(
  uint8 CtrlIdx );
...
# endif /* ETH_30_TRICORE_VERSION_INFO_API */

# define ETH_30_TRICORE_STOP_SEC_CODE
# include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#endif /* ETH_30_TRICORE_H */

/**********************************************************************************************************************
 *  END OF FILE: Eth_30_Tricore.h
 *********************************************************************************************************************/
