...
# ----------   -------  ------ -----------------------------------------------#
# 2012-07-01   1.00.00  vismdr Initial Version                                #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 1.00.00                                                   #
###############################################################################
...
LIBRARIES_TO_BUILD      += CanNm
CanNm_FILES             = CanNm\CanNm.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += CanNm\CanNm.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CanNm_cfg.c $(GENDATA_DIR)\CanNm_Lcfg.c $(GENDATA_DIR)\CanNm_PBcfg.c
