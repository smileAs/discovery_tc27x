    ...
    P2VAR(NvM_RequestResultType, AUTOMATIC, NVM_APPL_DATA) RequestResultPtr)
{
    ...
    else if (NvM_NoOfBlockIds_t <= NVM_BLOCK_FROM_DCM_ID(BlockId))
    {
        detErrorId = NVM_E_PARAM_BLOCK_ID;
    }
...
NVM_LOCAL_INLINE boolean NvM_CheckBlockId(const NvM_BlockIdType BlockId)
{
    return (boolean)((NvM_NoOfBlockIds_t >= NVM_BLOCK_FROM_DCM_ID(BlockId)) && (0u != NVM_BLOCK_FROM_DCM_ID(BlockId))); /* COV_NVM_COVEREDINOTHERCFG */
}
# endif
