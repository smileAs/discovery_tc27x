###############################################################################
# File Name  : Wdg_30_TLF35584_defs.mak                                       #
...
# Mid          Matthias Scheid           Vector Informatik GmbH               #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Sign Description                                      #
# ----------   -------  ---- -------------------------------------------------#
# 2016-01-14   1.00     Mid  Adapted to module DrvWd_XTlf35584E .             #
# 2016-01-18   1.01     Mid  Removed WDG_OUTPUT_PATH from CC_INCLUDE_PATH     #
# 2016-08-08   1.02     Mid  Fixed WDG_CORE_PATH
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
WDG_CORE_PATH       =   $(SSC_ROOT)\Wdg_30_TLF35584


# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)


WDG_OUTPUT_PATH     =   $(GENDATA_DIR)
