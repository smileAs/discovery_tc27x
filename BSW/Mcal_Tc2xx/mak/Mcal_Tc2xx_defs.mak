...
# ----------   -------  ------  ----------------------------------------------#
# 2015-10-06    1.01    virgaj  MC-ISAR_AS3XX_AURIX_TC23X_AB_PB_BASE_V300     #
#								MC-ISAR_AS3XX_AURIX_TC23X_AB_PB_MEM_V300      #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
MCAL_CORE_PATH       = $(SSC_ROOT)\Mcal_Tc23x

# e.g.: CAN_OUTPUT_PATH = $(GENDATA_DIR)
MCAL_OUTPUT_PATH     = $(GENDATA_DIR)
...
#------------------------------------------------------------------------------------------
CC_INCLUDE_PATH     += $(MCAL_CORE_PATH) $(MCAL_OUTPUT_PATH)
CPP_INCLUDE_PATH    +=
ASM_INCLUDE_PATH    +=
