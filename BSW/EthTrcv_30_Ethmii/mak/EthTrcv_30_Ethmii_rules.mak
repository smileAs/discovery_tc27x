###############################################################################
# File Name  : EthTrcv_30_Ethmii_rules.mak                                   #
...
# --------     ---------------------     -------------------------------------#
# visfer       David Fessler             Vector Informatik GmbH               #
...
# ----------   ------- ------  -----------------------------------------------#
# 2014/12/02    1.00    visfer  Created                                       #
# 2015/02/13    1.01    vismha  Removed unused PB config parts                #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += EthTrcv_30_Ethmii
EthTrcv_30_Ethmii_FILES    = EthTrcv_30_Ethmii\EthTrcv_30_Ethmii.c EthTrcv_30_Ethmii\EthTrcv_30_Ethmii_LL.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += EthTrcv_30_Ethmii\EthTrcv_30_Ethmii.c EthTrcv_30_Ethmii\EthTrcv_30_Ethmii_LL.c
endif
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\EthTrcv_30_Ethmii_Lcfg.c $(GENDATA_DIR)\EthTrcv_30_Ethmii_HwCfg.c
