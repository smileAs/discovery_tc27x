...
# define ETHTSYN_STATE_SYNC_SEND_SEND_FOLLOW_UP                                    (3U)
# define ETHTSYN_STATE_SYNC_SEND_SITE_SYNC_SYNC_PENDING                            (4U)
# define ETHTSYN_STATE_SYNC_SEND_SITE_SYNC_SYNC_SEND_SYNC                          (5U)
# define ETHTSYN_STATE_SYNC_SEND_SITE_SYNC_SYNC_WAIT_FOLLOW_UP                     (6U)
# define ETHTSYN_STATE_SYNC_SEND_SITE_SYNC_SYNC_SEND_FOLLOW_UP                     (7U)
...
/* EthTSyn Common Message Header format */
...
/* EthTSyn Announce Message Format */
...
/* EthTSyn Signaling Message Format */
...
/* EthTSyn  Sync Message Format */
typedef struct EthTSyn_SyncMsgTypeStruct
{
  uint8 Reserved[10];
} EthTSyn_SyncMsgType;

/* EthTSyn Follow Up Format */
...
/* EthTSyn Follow_Up AR TLV Header */
...
/* EthTSyn Follow_Up AR Sub TLV abstract header. It is intended to cast to the corresponding AR Sub Tlv type */
...
/* EthTSyn Follow_Up AR Sub TLV UserData Secured/Not Secured */
...
/* EthTSyn Follow_Up AR Sub TLV OFS Secured/Not Secured */
...
/* EthTSyn  Pdelay Respond Follow Up Format */
...
/* EthTSyn Pdelay Request state-machine */
typedef struct EthTSyn_PdelayReqSmReqTypeStruct
{
  uint16                      SequenceId;
  uint32                      TxIntervalCnt;
...
/* EthTSyn Pdelay Response Request state-machine */
...
/* EthTSyn Pdelay Response state-machine */
...
/* EthTSyn Pdelay Request Response state-machine */
...
/* EthTSyn Pdelay Request FollowUp state-machine */
...
/* EthTSyn Sync Received Sync state-machine */
typedef struct EthTSyn_SyncReceiveSmSyncTypeStruct
{
  ...
  EthTSyn_PortIdentityType       SourcePortIdentity;
  EthTSyn_LogMessageIntervalType LogMessageInterval;
  EthTSyn_TimediffType           MinusLastOffset; /* Negative value of the last corrected offset */
# if (ETHTSYN_SWT_MGMT_SUPPORT == STD_ON)
...
/* EthTSyn Sync Received FollowUp state-machine */
...
/* EthTSyn Sync Received state-machine */
...
/* EthTSyn Announce Received state-machine */ /* Make only available when Announce Rx Support == STD_ON */
typedef struct EthTSyn_AnnounceReceiveSmTypeStruct
{
  uint32 RxTimeoutCnt;
} EthTSyn_AnnounceReceiveSmType;

/* EthTSyn Sync Send state-machine */
...
{
  EthTSyn_PortIdentityType PortIdentity;
} EthTSyn_GmPriorityType;

/* EthTSyn System State Type */
typedef struct EthTSyn_SystemTypeStruct
{
  EthTSyn_GmPriorityType GmPriority;
  boolean GmPresent;
} EthTSyn_SystemType;
...
typedef struct EthTSyn_SwtMgmt_MsgBufferTypeStruct
{
  ...
  uint8                              CtrlIdx;
  ETHTSYN_P2CONST(uint8)             RxBufAddr; /* Just used to assign the MgmtInfo/Ts indications to the message! */
...
/***********************************************************************************************************************
 * ETHTSYN VARIANT DEPENDENT TYPES
 **********************************************************************************************************************/
