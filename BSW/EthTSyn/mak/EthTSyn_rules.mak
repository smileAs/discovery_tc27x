...
# --------     ---------------------     -------------------------------------# 
# vislje       Jeroen Laverman           Vector Informatik GmbH               # 
# vissem       Michael Seidenspinner     Vector Informatik GmbH               # 
#-----------------------------------------------------------------------------# 
...
# 2016-07-29   2.00.00  EthTSyn Switch Management submodule source file added # 
#-----------------------------------------------------------------------------# 
# TemplateVersion = 1.0                                                       # 
# MAKEFILE        = 0.1                                                       # 
############################################################################### 
...
EthTSyn_FILES            = EthTSyn\EthTSyn.c EthTSyn\EthTSyn_SwtMgmt.c

ifeq ($(GET_IMPLEMENTION_FROM), LIB)
CC_FILES_TO_BUILD       += 
else
CC_FILES_TO_BUILD       += EthTSyn\EthTSyn.c EthTSyn\EthTSyn_SwtMgmt.c
endif
CPP_FILES_TO_BUILD      += 
ASM_FILES_TO_BUILD      += 
