...
#               C O P Y R I G H T                                             #
#-----------------------------------------------------------------------------#
# Copyright (c) 2011-2012 by Vector Informatik GmbH.  All rights reserved.    #
#                                                                             #
#-----------------------------------------------------------------------------#
...
# ----------   -------  ------ -----------------------------------------------#
# 2012/10/01   1.00.00  visrpp Creation for ASR 4.0.3                         #
# 2013/10/10   1.01.00  vismss Configurator suppport added                    #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += Csm
Csm_FILES                = Csm\Csm.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Csm\Csm.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Csm_Cfg.c
