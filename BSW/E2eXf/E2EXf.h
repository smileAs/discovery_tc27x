...
# define E2EXF_SW_MINOR_VERSION                  (1U)
...
# define E2EXF_SID_GET_VERSION_INFO              (0x05U) /*!< Service ID: E2EXf_GetVersionInfo() */
...
# ifndef E_OK
#  define E_OK                                   (0x00U) /*!< Error code: The communication is safe. */
# endif
# ifndef E_SAFETY_VALID_REP
...
# endif
# ifndef E_SAFETY_HARD_RUNTIMEERROR
 ...
 *  \param[inout] state                   Pointer to P01 state structure.
 ...
 *  \param[inout] state                   Pointer to P02 state structure.
 *  \return                               Standard return value, indicating success/error.
 *  \pre          Module is initialized.
 *  \context      TASK
 *  \reentrant    TRUE
 ...
 *  \param[inout] state                   Pointer to P04 state structure.
 *  \return                               Standard return value, indicating success/error.
 *  \pre          Module is initialized.
 *  \context      TASK
 *  \reentrant    TRUE
 ...
 *  \param[inout] state                   Pointer to P05 state structure.
 *  \return                               Standard return value, indicating success/error.
 *  \pre          Module is initialized.
 *  \context      TASK
 *  \reentrant    TRUE
 ...
 *  \param[inout] state                   Pointer to P06 state structure.
 *  \return                               Standard return value, indicating success/error.
 *  \pre          Module is initialized.
 *  \context      TASK
 *  \reentrant    TRUE
 ...
 *  \param[inout] state                   Pointer to P07 state structure.
 *  \return                               Standard return value, indicating success/error.
 *  \pre          Module is initialized.
 *  \context      TASK
 *  \reentrant    TRUE
 ...
 *  \param[inout] smState                 Pointer to SM state structure.
 *  \return                               Standard return value, indicating success/error.
 *  \pre          Module is initialized.
 *  \context      TASK
 *  \reentrant    TRUE
