 ...
 *    Generator:  -
 *
 *  Description:  Header file for type definitions of Diagnostic over IP
 *
 *********************************************************************************************************************/
...
typedef struct
{
  P2CONST(PduIdType, TYPEDEF, DOIP_CONST) ChannelColPtr;
...
typedef P2FUNC(Std_ReturnType, DOIP_CODE, DoIP_OemPayloadTypeFctPtrType) (uint16 RxPayloadType,
  const PduInfoType* RxUserData, DoIP_OemPayloadTypeFlagType Flags, uint16* TxPayloadType, PduInfoType* TxUserData);

typedef P2FUNC(Std_ReturnType, DOIP_CODE, DoIP_VerifyTargetAddrFctPtrType) (uint16 TargetAddr);
