 ...
 * VERSION CHECK
 **********************************************************************************************************************/
#if ( DRVTRANS_TLE7259LINDIOASR_VERSION != 0x0602u )  /* COV_LINTRCV_CONFIG XF */
...
# error "Module LinTrcv_30_Sbc: Static and Generated files are inconsistent!"
#endif
#if (DRVTRANS_LIN_30_TLE7259_GENTOOL_CFG5_MINOR_VERSION != 0x01U) /* COV_LINTRCV_CONFIG XF */
# error "Module LinTrcv_30_Sbc: Static and Generated files are inconsistent!"
#endif
...
# elif (LINTRCV_30_TLE7259_WAKEUPBYPINUSEDOFCHANNEL == STD_ON) /* COV_LINTRCV_CONFIG XX XF */
# else
...
# endif
...
#else
  LINTRCV_30_TLE7259_DUMMY_STATEMENT(LinTrcv_ErrorId); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */
#endif
  ...
  LINTRCV_30_TLE7259_DUMMY_STATEMENT(ConfigPtr); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */
#endif
...
)
{
  ...
  {
    LinTrcv_ErrorId = LINTRCV_30_TLE7259_E_INVALID_LIN_NETWORK;
  }
...
# endif
      ...
      default:
#if (LINTRCV_30_TLE7259_DEV_ERROR_DETECT == STD_ON)
        LinTrcv_ErrorId = LINTRCV_30_TLE7259_E_PARAM_TRCV_OPMODE;
#endif
        break;
    }
...
)
{
...
#endif
  {
    ...
    *Reason = LINTRCV_WU_NOT_SUPPORTED; /* SBSW_LINTRCV_PTR */
    LINTRCV_30_TLE7259_DUMMY_STATEMENT (LinTrcvIndex); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */
#endif
  }
...
# endif
      ...
      SchM_Exit_LinTrcv_30_Tle7259_LINTRCV_30_TLE7259_EXCLUSIVE_AREA_0();
#else
    LINTRCV_30_TLE7259_DUMMY_STATEMENT (TrcvWakeupMode); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */
    LINTRCV_30_TLE7259_DUMMY_STATEMENT (LinTrcvIndex); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */
#endif
  }
...
# if (LINTRCV_30_TLE7259_WAKEUPBYBUSUSEDOFCHANNEL == STD_ON)
      ...
      {
        if ((Dio_ReadChannel(LinTrcv_30_Tle7259_GetDioPinRxOfDioChannel(LinTrcvIndex)) == STD_LOW) && /* PRQA S 3415 */ /* MD_LINTRCV_3415 */
            (Dio_ReadChannel(LinTrcv_30_Tle7259_GetDioPinTxOfDioChannel(LinTrcvIndex)) == STD_HIGH))
        {
...
# if (LINTRCV_30_TLE7259_WAKEUPBYPINUSEDOFCHANNEL == STD_ON)
      ...
      {
        if ((Dio_ReadChannel(LinTrcv_30_Tle7259_GetDioPinRxOfDioChannel(LinTrcvIndex)) == STD_LOW) && /* PRQA S 3415 */ /* MD_LINTRCV_3415 */
            (Dio_ReadChannel(LinTrcv_30_Tle7259_GetDioPinTxOfDioChannel(LinTrcvIndex)) == STD_LOW))
        {
...
# endif
      ...
      if ((LinTrcv_WakeupDetected == 1) && (LinTrcv_30_Tle7259_ChannelData[LinTrcvIndex].LinTrcv_30_Tle7259_WakeupMode == LINTRCV_WUMODE_ENABLE))
      {
        LinTrcv_ReturnValTmp = E_OK;
        EcuM_SetWakeupEvent(LinTrcv_30_Tle7259_GetEcuMWakeupSourceIdOfChannel(LinTrcvIndex));
        LinIf_WakeupConfirmation(LinTrcv_30_Tle7259_GetEcuMWakeupSourceIdOfChannel(LinTrcvIndex));
...
)
{
  ...
  LinTrcv_ErrorId = LINTRCV_30_TLE7259_E_NO_ERROR;
