 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *  01.00.00  2016-11-07  viszda                Creation
 *********************************************************************************************************************/
...
/** \ingroup hlp */
#define Xcp_GetVal16(p)                                     ((uint16)(((CONSTP2CONST(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[0])          \
                                                  | (uint16)((uint16)(((CONSTP2CONST(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[1]) << 8u))

/** \ingroup hlp */
#define Xcp_GetVal32(p)                                     (((uint32)((CONSTP2CONST(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[0])          \
                                                  | (uint32)(((uint32)((CONSTP2CONST(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[1]) << 8u)   \
                                                  | (uint32)(((uint32)((CONSTP2CONST(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[2]) << 16u)  \
                                                  | (uint32)(((uint32)((CONSTP2CONST(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[3]) << 24u)) 

/* PRQA S 3412 8 */ /* MD_MSR_19.4 */
/** \ingroup hlp */
#define Xcp_PutVal16(p, data)                       (((P2VAR(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[0] = (uint8)(data));          \
                                                    (((P2VAR(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[1] = (uint8)((data) >> 8u)); 
/** \ingroup hlp */
#define Xcp_PutVal32(p, data)                       (((P2VAR(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[0] = (uint8)(data));          \
                                                    (((P2VAR(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[1] = (uint8)((data) >> 8u));  \
                                                    (((P2VAR(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[2] = (uint8)((data) >> 16u)); \
                                                    (((P2VAR(uint8, AUTOMATIC, XCP_VAR_NOINIT))(p))[3] = (uint8)((data) >> 24u)); 
