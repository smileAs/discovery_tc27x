...
# define CCL_ASR4COMMCFG5_VERSION                (0x0801u)
# define CCL_ASR4COMMCFG5_RELEASE_VERSION        (0x00u)
 ...
 * ComM_DeInit()
 *********************************************************************************************************************/
/*! \brief       This function de-initializes ComM and sets the initialization status to COMM_UNINIT.
 *               It stores non-volatile values in NVRAM.
 *  \details     This function is executed if all COMM channels are in state COMM_NO_COM_NO_PENDING_REQUEST.
