...
# --------     ---------------------     -------------------------------------#
# visml         Patrick Markl             Vector Informatik GmbH              #
# visazb        Alexander Zeeb            Vector Informatik GmbH              #
#-----------------------------------------------------------------------------#
#               R E V I S I O N   H I S T O R Y                               #
#-----------------------------------------------------------------------------#
# Date         Version  Signature   Description                               #
# ----------   -------  ---------- -------------------------------------------#
# 2013-04-12   1.00.00   visml      Creation                                  #
# 2013-06-04   1.00.01   visazb     Fixed case of "Dlt_FILES"                 #
# 2014-10-30   1.01.00   viszda     Dlt_Cfg.c created                         #
# 2015-03-03   1.02.00   viszda     Dlt_Cfg.c deleted and DltCom.c added      #
# 2015-07-24   1.03.00   viszda     Dlt_Cbk.c created                         #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
LIBRARIES_TO_BUILD      += Dlt
Dlt_FILES               = Dlt\Dlt.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Dlt\Dlt.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
