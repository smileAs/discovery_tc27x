...
# 2007/08/06   1.01     Svh  Adapted to AUTOSAR LIN                           #
# 2008/04/30   1.02     fbg  Changes for ASR library support                  #
#-----------------------------------------------------------------------------#
# TemplateVersion = 1.0                                                       #
# MAKEFILE        = 0.1                                                       #
###############################################################################
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Lin_PBcfg.c $(GENDATA_DIR)\Lin_Lcfg.c
