 ...
 * ECUM_WKSOURCE_CAN00_f26020e5 (EcuM_WakeupSourceType)(32UL) 
 * ECUM_WKSOURCE_CAN01_f26020e5 (EcuM_WakeupSourceType)(64UL) 
 * ECUM_WKSOURCE_CAN02_f26020e5 (EcuM_WakeupSourceType)(128UL) 
 * ECUM_WKSOURCE_LIN00_f26020e5 (EcuM_WakeupSourceType)(256UL) 
 */
...
FUNC(void, ECUM_CODE) EcuM_AL_DriverInitOne(void) 
{
  if(GetCoreID() == ECUM_CORE_ID_BSW)
  {
    ...
    Pwm_17_Gtm_Init( Pwm_ConfigRoot );
    Icu_17_GtmCcu6_Init( Icu_ConfigRoot );
    Uart_Init( Uart_ConfigRoot );
    IrqCan_Init();
    I2c_Init( I2c_ConfigRoot );
    Tlf35584_init();
  }
