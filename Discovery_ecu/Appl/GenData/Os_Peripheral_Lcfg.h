 ...
 *********************************************************************************************************************/
#if !defined (OS_PERIPHERAL_LCFG_H)                                                  /* PRQA S 0883 */ /* MD_Os_0883 */
...
extern CONSTP2CONST(Os_PeripheralConfigType, OS_CONST, OS_CONST) OsCfg_PeripheralRefs[OS_PERIPHERALID_COUNT + 1];
