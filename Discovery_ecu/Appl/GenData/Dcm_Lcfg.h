 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dcm_Lcfg.h
 *   Generation Time: 2018-07-31 15:38:41
...
# define DCM_LCFG_MAJOR_VERSION                                                 7u
# define DCM_LCFG_MINOR_VERSION                                                 2u
# define DCM_LCFG_PATCH_VERSION                                                 0u
/* ----------------------------------------------
 ~&&&   Function-like macros
---------------------------------------------- */
# define Dcm_ModeOnComControlModeChange(channelId, mode)                       ((void)(Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_CAN00_f26020e5_DcmCommunicationControl_ComMConf_ComMChannel_CAN00_f26020e5(mode))) /* PRQA S 3453 */ /* MD_MSR_19.7 */
/* ----------------------------------------------
...
typedef P2CONST(Dcm_CfgNetProtocolNotificationInfoType, TYPEDEF, DCM_CONST) Dcm_CfgNetProtocolNotificationInfoPtrType;                               /* PRQA S 0779 */ /* MD_Dcm_Understand_0779 */
...
struct DCM_CFGNETRXPDUINFOTYPE_TAG
{
  ...
  Dcm_NetConnRefMemType     ConnRef;    /*!< Reference to Dcm_CfgNetConnectionInfo[] */
};
...
struct DCM_CFGNETCONNECTIONTYPE_TAG
{
  ...
  Dcm_CfgNetNetIdRefMemType       NetworkIdRef;           /*!< Reference to Dcm_CfgNetConnComMChannelMap[] */
  Dcm_NetProtRefMemType           ProtRef;                /*!< Reference to Dcm_PbCfgNetProtocolInfo[] */

#if (DCM_NET_PERIODIC_TX_CONN_SPECIFIC_NUM_TX_OBJ_ENABLED  == STD_ON)                                                                                /* COV_DCM_UNSUPPORTED XF */
  Dcm_CfgNetPerTxPduIdRefMemType  PeriodicTxRef;          /*!< Reference to Dcm_PbCfgNetPerTxPduIdInfo[] */
...
struct DCM_CFGNETPROTOCOLTYPE_TAG
{
  ...
  Dcm_CfgNetBufferRefMemType  RxTxBufferRef;      /*!< Reference to Dcm_PbCfgNetBufferInfo[] */
...
struct DCM_NETTRANSPORTOBJECTTYPE_TAG
{
  ...
  Dcm_NetConnRefMemType           ConnId;                                  /*!< Reference to Dcm_PbCfgNetConnectionInfo[] */
  Dcm_CfgNetBufferRefMemType      BufferHdl;                               /*!< Reference to Dcm_PbRamNetBufferContext[] */
...
struct DCM_NETPERIODICTXOBJECTTYPE_TAG
{
  ...
  boolean                          IsReserved;                              /*!< Periodic message buffer state (TRUE - locked, FALSE - free) */
};
...
struct DCM_CFGSTATEPRECONDITIONINFOTYPE_TAG
{
  ...
  Dcm_CfgModeMgrRuleRefMemType         ModeRuleRef;   /*!< Reference to Dcm_CfgModeMgrRules[] */
#endif
...
struct DCM_CFGDIAGSERVICEINFOTYPE_TAG
{
  ...
  uint8                             ConfFuncRef;      /*!< Reference to the Dcm_CfgDiagSvcPostProcessors[] */
#if (DCM_DIAG_FAST_POST_PROCESSING_ENABLED == STD_ON)                                                                                                /* COV_DCM_SUPPORT_ALWAYS TX */
  uint8                             FastConfFuncRef;  /*!< Reference to the Dcm_CfgDiagSvcPostProcessors[] (if exist, fast post-processors are located right behind the normal post-processor) */
#endif
#if (DCM_PAGED_BUFFER_ENABLED == STD_ON)
  uint8                             UpdateFuncRef;    /*!< Reference to the Dcm_CfgDiagSvcUpdaters[] */
  uint8                             CancelFuncRef;    /*!< Reference to the Dcm_CfgDiagSvcCancellers[] */
#endif
};
...
extern CONST(uint8, DCM_CONST) Dcm_CfgDiagSvcIdLookUpTable[4];
...
extern CONST(Dcm_CfgDiagServiceInfoType, DCM_CONST) Dcm_CfgDiagServiceInfo[4];
/*! Indirection from diag service info to execution pre conditions */
extern CONST(Dcm_CfgStateRefMemType, DCM_CONST) Dcm_CfgDiagSvcIdExecPrecondTable[3];
/*! DCM service post processors */
extern CONST(Dcm_DiagSvcConfirmationFuncType, DCM_CONST) Dcm_CfgDiagSvcPostProcessors[4];
