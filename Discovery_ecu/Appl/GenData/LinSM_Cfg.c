...
/*lint -restore */
CONST(LinSM_ComMToLinSMChannelType, LINSM_CONST) LinSM_ComMToLinSMChannel[4] = {
  ...
  /*     3 */                          0U   /* [/ActiveEcuC/ComM/ComMConfigSet/LIN00_f26020e5] */
};
...
VAR(uLinSM_ComStateType, LINSM_VAR_NOINIT) LinSM_ComState;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
  ...
  /*     0 */  /* [/ActiveEcuC/LinSM/LinSMConfigSet/LIN00_f26020e5] */
