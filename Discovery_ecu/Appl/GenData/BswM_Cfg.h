...
#define BSWM_ATOMIC_BIT_ACCESS_IN_BITFIELD STD_ON /* /MICROSAR/EcuC/EcucGeneral/AtomicBitAccessInBitfield */
#endif
#ifndef BSWM_ATOMIC_VARIABLE_ACCESS
#define BSWM_ATOMIC_VARIABLE_ACCESS 32U /* /MICROSAR/EcuC/EcucGeneral/AtomicVariableAccess */
#endif
#ifndef BSWM_PROCESSOR_TC277
#define BSWM_PROCESSOR_TC277
#endif
...
/* -----------------------------------------------------------------------------
    &&&~ RULE DEFINES
 ----------------------------------------------------------------------------- */
#define BswMConf_BswMRule_ESH_RunToPostRun (15) 
#define BswMConf_BswMRule_ESH_WaitToShutdown (16) 
#define BswMConf_BswMRule_ESH_WakeupToPrep (18) 
#define BswMConf_BswMRule_ESH_WaitToWakeup (17) 
#define BswMConf_BswMRule_ESH_WakeupToRun (19) 
#define BswMConf_BswMRule_ESH_InitToWakeup (10) 
#define BswMConf_BswMRule_ESH_PostRunToPrepNested (13) 
#define BswMConf_BswMRule_ESH_PostRunNested (12) 
#define BswMConf_BswMRule_ESH_PostRun (11) 
#define BswMConf_BswMRule_ESH_PrepToWait (14) 
#define BswMConf_BswMRule_CC_CAN00_f26020e5_TX (2) 
#define BswMConf_BswMRule_CC_CAN00_f26020e5_RX_DM (1) 
#define BswMConf_BswMRule_CC_CAN00_f26020e5_RX (0) 
#define BswMConf_BswMRule_CC_CAN01_f26020e5_TX (5) 
#define BswMConf_BswMRule_CC_CAN01_f26020e5_RX_DM (4) 
#define BswMConf_BswMRule_CC_CAN01_f26020e5_RX (3) 
#define BswMConf_BswMRule_CC_CAN02_f26020e5_TX (8) 
#define BswMConf_BswMRule_CC_CAN02_f26020e5_RX_DM (7) 
#define BswMConf_BswMRule_CC_CAN02_f26020e5_RX (6) 
#define BswMConf_BswMRule_CC_LIN00_f26020e5_Normal_45618847 (9) 
...
#define BSWM_LINSMMAPPINGOFPCCONFIG                                   STD_ON
#define BSWM_LINSMSTATEOFPCCONFIG                                     STD_ON
#define BSWM_LINSCHEDULEMAPPINGOFPCCONFIG                             STD_ON
#define BSWM_LINSCHEDULESTATEOFPCCONFIG                               STD_ON
...
#define BSWM_SIZEOFLINSMMAPPINGOFPCCONFIG                             STD_ON
#define BSWM_SIZEOFLINSMSTATEOFPCCONFIG                               STD_ON
#define BSWM_SIZEOFLINSCHEDULEMAPPINGOFPCCONFIG                       STD_ON
#define BSWM_SIZEOFLINSCHEDULESTATEOFPCCONFIG                         STD_ON
...
#define BSWM_ISDEF_LINSMMAPPINGOFPCCONFIG                             STD_ON
#define BSWM_ISDEF_LINSMSTATEOFPCCONFIG                               STD_ON
#define BSWM_ISDEF_LINSCHEDULEMAPPINGOFPCCONFIG                       STD_ON
#define BSWM_ISDEF_LINSCHEDULESTATEOFPCCONFIG                         STD_ON
...
#define BSWM_EQ2_EXTERNALIDOFGENERICMAPPING                           230
#define BSWM_EQ2_IMMEDIATEUSERENDIDXOFGENERICMAPPING                  4U
#define BSWM_EQ2_IMMEDIATEUSERSTARTIDXOFGENERICMAPPING                3U
...
#define BSWM_EQ2_EXTERNALIDOFLINSMMAPPING                             ComMConf_ComMChannel_LIN00_f26020e5
#define BSWM_EQ2_IMMEDIATEUSERENDIDXOFLINSMMAPPING                    6U
#define BSWM_EQ2_IMMEDIATEUSERSTARTIDXOFLINSMMAPPING                  5U
#define BSWM_EQ2_IMMEDIATEUSERUSEDOFLINSMMAPPING                      TRUE
#define BSWM_EQ2_INITVALUEOFLINSMMAPPING                              LINSM_BSWM_NO_COM
#define BSWM_EQ2_EXTERNALIDOFLINSCHEDULEMAPPING                       ComMConf_ComMChannel_LIN00_f26020e5
#define BSWM_EQ2_IMMEDIATEUSERENDIDXOFLINSCHEDULEMAPPING              5U
#define BSWM_EQ2_IMMEDIATEUSERSTARTIDXOFLINSCHEDULEMAPPING            4U
...
#define BSWM_EQ2_LINSMMAPPINGOFPCCONFIG                               BswM_LinSMMapping
#define BSWM_EQ2_LINSMSTATEOFPCCONFIG                                 BswM_LinSMState
#define BSWM_EQ2_LINSCHEDULEMAPPINGOFPCCONFIG                         BswM_LinScheduleMapping
#define BSWM_EQ2_LINSCHEDULESTATEOFPCCONFIG                           BswM_LinScheduleState
...
typedef BswM_LinSMMappingIterType BswM_LinSMStateIterType;

/**   \brief  type used to iterate BswM_LinScheduleState */
typedef BswM_LinScheduleMappingIterType BswM_LinScheduleStateIterType;
...
typedef struct sBswM_ActionListQueueStructTag
{
  ...
  BswM_ActionListQueueType AL_CC_AL_CAN01_f26020e5_TX_Disable[1];
  BswM_ActionListQueueType AL_CC_AL_CAN01_f26020e5_TX_EnableNoinit[1];
  BswM_ActionListQueueType AL_CC_AL_CAN01_f26020e5_Disable_DM[1];
  BswM_ActionListQueueType AL_CC_AL_CAN01_f26020e5_Enable_DM[1];
  BswM_ActionListQueueType AL_CC_AL_CAN01_f26020e5_RX_Disable[1];
  BswM_ActionListQueueType AL_CC_AL_CAN01_f26020e5_RX_EnableNoinit[1];
  BswM_ActionListQueueType AL_CC_AL_CAN02_f26020e5_TX_Disable[1];
  BswM_ActionListQueueType AL_CC_AL_CAN02_f26020e5_TX_EnableNoinit[1];
  BswM_ActionListQueueType AL_CC_AL_CAN02_f26020e5_Disable_DM[1];
  BswM_ActionListQueueType AL_CC_AL_CAN02_f26020e5_Enable_DM[1];
  BswM_ActionListQueueType AL_CC_AL_CAN02_f26020e5_RX_Disable[1];
  BswM_ActionListQueueType AL_CC_AL_CAN02_f26020e5_RX_EnableNoinit[1];
  BswM_ActionListQueueType AL_CC_AL_LIN00_f26020e5_Normal_45618847_Disable[1];
  BswM_ActionListQueueType AL_CC_AL_LIN00_f26020e5_Normal_45618847_Enable[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  BswM_ActionListQueueType raw[32];
