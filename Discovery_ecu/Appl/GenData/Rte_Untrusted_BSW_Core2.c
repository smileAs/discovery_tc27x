...
uint32 core2_counter_10ms = 0;


FUNC(void, RTE_CODE) Rte_InitMemory_Untrusted_BSW_Core2(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
}
 ...
 *********************************************************************************************************************/
TASK(Default_BSW_Async_Task_Core2) /* PRQA S 3408, 1503 */ /* MD_Rte_3408, MD_MSR_14.1 */
{
  ...
  core2_counter_10ms++;
    ...
    if (core2_counter_10ms % 100==1)
    {
        Dio_FlipChannel(DIO_CHANNEL_15_5);
    }
