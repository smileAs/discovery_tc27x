 ...
 *********************************************************************************************************************/
/*! \brief        Receives the given items from the IOC.
 *  \details      The received data is only valid, if IOC_E_OK is returned.
 *
 *  \param[out]   Arg0  Data read from the IOC. Parameter must not be NULL.
 *
 *  \returns      For further information see Os_Ioc08Receive(), Os_Ioc16Receive(), Os_Ioc32Receive() or
 *                Os_IocRefReceive().
 *
 *  \context      ANY
 *
 ...
 *  \pre          -
 *********************************************************************************************************************/
Std_ReturnType IocReceive_OsIocCommunication
(
  uint32 *Arg0
);
 ...
 *  \details        -
 *
 *  \returns        For further information see Os_Ioc08Empty(), Os_Ioc16Empty(), Os_Ioc32Empty() or
 *                  Os_IocRefEmpty().
 *
 *  \context        ANY
 *
 ...
 *********************************************************************************************************************/
/*! \brief        Sends the given items to the IOC.
 *  \details      -
 *
 *  \param[in]    Arg0  The data to write to the IOC. Parameter must not be NULL.
 *
 *  \returns      For further information see Os_Ioc08Send(), Os_Ioc16Send(), Os_Ioc32Send() or Os_IocRefSend().
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE if concurrent access is prevented by configuration.
 ...
 *  \pre          -
 *********************************************************************************************************************/
Std_ReturnType IocSend_OsIocCommunication
(
  uint32 Arg0
);
