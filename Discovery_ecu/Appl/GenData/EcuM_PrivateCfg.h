...
/** 
  ...
  \{
*/ 
#define EcuM_SetCoreStatus(Index, Value)                              EcuM_GetCoreStatusOfPCConfig()[(Index)] = (Value)
...
/** 
  ...
  \{
*/ 
#define EcuM_IncCoreStatus(Index)                                     EcuM_GetCoreStatus(Index)++
...
/** 
  ...
  \{
*/ 
#define EcuM_DecCoreStatus(Index)                                     EcuM_GetCoreStatus(Index)--
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(EcuM_WakeupSourceListType, ECUM_CONST) EcuM_WakeupSourceList[9];
#define ECUM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(EcuM_CoreStatusType, ECUM_VAR_NOINIT) EcuM_CoreStatus[3];
