...
# define OS_DEFAULT_INIT_TASK_CORE0_CODE
# define OS_DEFAULT_INIT_TASK_CORE1_CODE
# define OS_DEFAULT_INIT_TASK_CORE2_CODE
# define OS_KEY_EVENT_CODE
# define OS_LINISR_1_CODE
# define OS_UART_ISRERROR0_CODE
# define OS_UART_ISRRECEIVE0_CODE
# define OS_UART_ISRTRANSMIT0_CODE
