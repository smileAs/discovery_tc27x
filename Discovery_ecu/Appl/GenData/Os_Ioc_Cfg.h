...
/* IOC communication defines: OsIocCommunication */
# define OS_CFG_SIZE_IOC_OSIOCCOMMUNICATION_BUFFER       (11UL)
# define OS_CFG_NUM_IOC_OSIOCCOMMUNICATION_CALLBACKS     (0UL)
