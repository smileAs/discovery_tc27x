 ...
 *********************************************************************************************************************/
#if !defined (OS_TIMINGPROTECTION_CFG_H)                                             /* PRQA S 0883 */ /* MD_Os_0883 */
...
/*! Defines whether timing protection is active (STD_ON) or not (STD_OFF). */
# define OS_CFG_TIMING_PROTECTION                (STD_OFF)
