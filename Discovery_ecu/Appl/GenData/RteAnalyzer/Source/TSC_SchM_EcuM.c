...
void TSC_EcuM_SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_0(void)
{
  SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_0();
}
void TSC_EcuM_SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_0(void)
{
  SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_0();
}
void TSC_EcuM_SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_1(void)
{
  SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_1();
}
void TSC_EcuM_SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_1(void)
{
  SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_1();
}
void TSC_EcuM_SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_2(void)
{
  SchM_Enter_EcuM_ECUM_EXCLUSIVE_AREA_2();
}
void TSC_EcuM_SchM_Exit_EcuM_ECUM_EXCLUSIVE_AREA_2(void)
{
