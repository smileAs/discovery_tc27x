 ...
 *
 *   Description:  C-Code implementation template for SW-C <Os_OsCore_Core2_swc>
 *********************************************************************************************************************/
...
#include "Rte_Os_OsCore_Core2_swc.h" /* PRQA S 0857 */ /* MD_MSR_1.1_857 */
#include "TSC_Os_OsCore_Core2_swc.h"
