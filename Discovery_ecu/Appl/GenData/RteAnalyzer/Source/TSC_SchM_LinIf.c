...
void TSC_LinIf_SchM_Enter_LinIf_LINIF_EXCLUSIVE_AREA_0(void)
{
  SchM_Enter_LinIf_LINIF_EXCLUSIVE_AREA_0();
}
void TSC_LinIf_SchM_Exit_LinIf_LINIF_EXCLUSIVE_AREA_0(void)
{
  SchM_Exit_LinIf_LINIF_EXCLUSIVE_AREA_0();
}
void TSC_LinIf_SchM_Enter_LinIf_LINIF_EXCLUSIVE_AREA_1(void)
{
  SchM_Enter_LinIf_LINIF_EXCLUSIVE_AREA_1();
}
void TSC_LinIf_SchM_Exit_LinIf_LINIF_EXCLUSIVE_AREA_1(void)
{
