...
void TSC_ComM_SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0(void)
{
  SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_0();
}
void TSC_ComM_SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0(void)
{
  SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_0();
}
void TSC_ComM_SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_1(void)
{
  SchM_Enter_ComM_COMM_EXCLUSIVE_AREA_1();
}
void TSC_ComM_SchM_Exit_ComM_COMM_EXCLUSIVE_AREA_1(void)
{
