 ...
 *********************************************************************************************************************/
  ...
  TSC_Spi_SchM_Enter_Spi_AsyncTransmit();
  TSC_Spi_SchM_Exit_Spi_AsyncTransmit();
  TSC_Spi_SchM_Enter_Spi_Cancel();
  TSC_Spi_SchM_Exit_Spi_Cancel();
  TSC_Spi_SchM_Enter_Spi_DeInit();
  TSC_Spi_SchM_Exit_Spi_DeInit();
  TSC_Spi_SchM_Enter_Spi_GetSequenceResult();
  TSC_Spi_SchM_Exit_Spi_GetSequenceResult();
  TSC_Spi_SchM_Enter_Spi_Init();
  TSC_Spi_SchM_Exit_Spi_Init();
  TSC_Spi_SchM_Enter_Spi_SyncTransmit();
  TSC_Spi_SchM_Exit_Spi_SyncTransmit();
  TSC_Spi_SchM_Enter_Spi_WriteIB();
  TSC_Spi_SchM_Exit_Spi_WriteIB();
