 ...
 *   DCM_ENUM_DefaultSession (1U)
 *   DCM_ENUM_ProgrammingSession (2U)
 *   DCM_ENUM_ExtendedSession (3U)
 ...
 * Mode Interfaces:
 * ================
 *   Std_ReturnType Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_CAN00_f26020e5_DcmCommunicationControl_ComMConf_ComMChannel_CAN00_f26020e5(Dcm_CommunicationModeType mode)
 ...
 *   - RTE_MODE_DcmDiagnosticSessionControl_ExtendedSession
 *   - RTE_MODE_DcmDiagnosticSessionControl_ProgrammingSession
 ...
 *********************************************************************************************************************/
  ...
  **********************************************************/

  {
    ...
    Dcm_FctPtr = (FncPtrType)Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_CAN00_f26020e5_DcmCommunicationControl_ComMConf_ComMChannel_CAN00_f26020e5; /* PRQA S 0313 */ /* MD_Rte_TestCode */
  }
  fct_status = TSC_Dcm_Rte_Switch_DcmCommunicationControl_ComMConf_ComMChannel_CAN00_f26020e5_DcmCommunicationControl_ComMConf_ComMChannel_CAN00_f26020e5(RTE_MODE_DcmCommunicationControl_DCM_ENABLE_RX_TX_NORM);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
  ...
  fct_status = TSC_Dcm_Rte_Switch_DcmDiagnosticSessionControl_DcmDiagnosticSessionControl(RTE_MODE_DcmDiagnosticSessionControl_DefaultSession);
  switch (fct_status)
  {
    case RTE_E_OK:
      fct_error = 0;
...
static void Dcm_TestDefines(void)
{
  ...
  Dcm_DiagnosticSessionControlType Test_Dcm_DiagnosticSessionControlType_V_1 = DCM_ENUM_DefaultSession;
  Dcm_DiagnosticSessionControlType Test_Dcm_DiagnosticSessionControlType_V_2 = DCM_ENUM_ProgrammingSession;
  Dcm_DiagnosticSessionControlType Test_Dcm_DiagnosticSessionControlType_V_3 = DCM_ENUM_ExtendedSession;
  ...
  Dcm_DiagnosticSessionControlType Test_DcmDiagnosticSessionControl_MV_1 = RTE_MODE_DcmDiagnosticSessionControl_DefaultSession;
  Dcm_DiagnosticSessionControlType Test_DcmDiagnosticSessionControl_MV_2 = RTE_MODE_DcmDiagnosticSessionControl_ProgrammingSession;
  Dcm_DiagnosticSessionControlType Test_DcmDiagnosticSessionControl_MV_3 = RTE_MODE_DcmDiagnosticSessionControl_ExtendedSession;
