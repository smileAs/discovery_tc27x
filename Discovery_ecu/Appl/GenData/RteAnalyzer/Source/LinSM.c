 ...
 *
 *   Description:  C-Code implementation template for BSW Module <LinSM>
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Schedulable Entity Name: LinSM_MainFunction
 *
 *********************************************************************************************************************/

FUNC(void, LINSM_CODE) LinSM_MainFunction(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: LinSM_MainFunction
 *********************************************************************************************************************/

  TSC_LinSM_SchM_Enter_LinSM_LINSM_EXCLUSIVE_AREA_0();
  TSC_LinSM_SchM_Exit_LinSM_LINSM_EXCLUSIVE_AREA_0();
  TSC_LinSM_SchM_Enter_LinSM_LINSM_EXCLUSIVE_AREA_1();
  TSC_LinSM_SchM_Exit_LinSM_LINSM_EXCLUSIVE_AREA_1();
  TSC_LinSM_SchM_Enter_LinSM_LINSM_EXCLUSIVE_AREA_2();
  TSC_LinSM_SchM_Exit_LinSM_LINSM_EXCLUSIVE_AREA_2();
  TSC_LinSM_SchM_Enter_LinSM_LINSM_EXCLUSIVE_AREA_3();
  TSC_LinSM_SchM_Exit_LinSM_LINSM_EXCLUSIVE_AREA_3();
