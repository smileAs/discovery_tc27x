...
/* X-Signal defines for core: OsCore_Core0 */
# define OS_CFG_NUM_XSIG_OSCORE_CORE0_ISRS     (1UL)
# define OS_CFG_SIZE_OSCORE_CORE0_SEND0_XSIGNALISR_OSCORE_CORE1_RECV0_BUFFER     (2UL)
# define OS_CFG_SIZE_OSCORE_CORE0_SEND1_XSIGNALISR_OSCORE_CORE2_RECV0_BUFFER     (2UL)
# define OS_CFG_NUM_ISR_XSIGNALISR_OSCORE_CORE0_PORTS     (2UL)

/* X-Signal defines for core: OsCore_Core1 */
# define OS_CFG_NUM_XSIG_OSCORE_CORE1_ISRS     (1UL)
# define OS_CFG_SIZE_OSCORE_CORE1_SEND0_XSIGNALISR_OSCORE_CORE0_RECV0_BUFFER     (2UL)
# define OS_CFG_SIZE_OSCORE_CORE1_SEND1_XSIGNALISR_OSCORE_CORE2_RECV1_BUFFER     (2UL)
# define OS_CFG_NUM_ISR_XSIGNALISR_OSCORE_CORE1_PORTS     (2UL)

/* X-Signal defines for core: OsCore_Core2 */
# define OS_CFG_NUM_XSIG_OSCORE_CORE2_ISRS     (1UL)
# define OS_CFG_SIZE_OSCORE_CORE2_SEND0_XSIGNALISR_OSCORE_CORE0_RECV1_BUFFER     (2UL)
# define OS_CFG_SIZE_OSCORE_CORE2_SEND1_XSIGNALISR_OSCORE_CORE1_RECV1_BUFFER     (2UL)
# define OS_CFG_NUM_ISR_XSIGNALISR_OSCORE_CORE2_PORTS     (2UL)
