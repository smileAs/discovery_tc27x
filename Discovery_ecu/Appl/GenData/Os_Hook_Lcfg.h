 ...
 *********************************************************************************************************************/
#if !defined (OS_HOOK_LCFG_H)                                                        /* PRQA S 0883 */ /* MD_Os_0883 */
...
extern CONST(Os_HookInitHookConfigType, OS_CONST) OsCfg_Hook_Os_CoreInitHook_OsCore_Core0;

/*! Hook configuration data: StartupHook_OsCore_Core0 */
extern CONST(Os_HookCallbackConfigType, OS_CONST) OsCfg_Hook_StartupHook_OsCore_Core0;

/*! Hook configuration data: ShutdownHook_OsCore_Core0 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ShutdownHook_OsCore_Core0;

/*! Hook configuration data: ErrorHook_OsCore_Core0 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ErrorHook_OsCore_Core0;
...
extern CONST(Os_HookInitHookConfigType, OS_CONST) OsCfg_Hook_Os_CoreInitHook_OsCore_Core1;

/*! Hook configuration data: StartupHook_OsCore_Core1 */
extern CONST(Os_HookCallbackConfigType, OS_CONST) OsCfg_Hook_StartupHook_OsCore_Core1;

/*! Hook configuration data: ShutdownHook_OsCore_Core1 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ShutdownHook_OsCore_Core1;

/*! Hook configuration data: ErrorHook_OsCore_Core1 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ErrorHook_OsCore_Core1;
...
extern CONST(Os_HookInitHookConfigType, OS_CONST) OsCfg_Hook_Os_CoreInitHook_OsCore_Core2;

/*! Hook configuration data: StartupHook_OsCore_Core2 */
extern CONST(Os_HookCallbackConfigType, OS_CONST) OsCfg_Hook_StartupHook_OsCore_Core2;

/*! Hook configuration data: ShutdownHook_OsCore_Core2 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ShutdownHook_OsCore_Core2;

/*! Hook configuration data: ErrorHook_OsCore_Core2 */
extern CONST(Os_HookStatusHookConfigType, OS_CONST) OsCfg_Hook_ErrorHook_OsCore_Core2;
...
extern CONSTP2CONST(Os_HookConfigType, OS_CONST, OS_CONST) OsCfg_HookRefs[OS_CFG_NUM_HOOKS + 1];
