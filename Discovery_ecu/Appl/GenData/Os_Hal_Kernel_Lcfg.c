...
CONSTP2CONST(Os_CoreConfigType, OS_CONST, OS_CONST) OsCfg_CoreRefs[OS_COREID_COUNT + 1] =
{
  ...
  OS_CORE_CASTCONFIG_COREASR_2_CORE(OsCfg_Core_OsCore_Core1),
  OS_CORE_CASTCONFIG_COREASR_2_CORE(OsCfg_Core_OsCore_Core2),
  NULL_PTR
};
...
CONSTP2CONST(Os_Hal_ContextStackConfigType, OS_CONST, OS_CONST) OsCfg_Stack_KernelStacks[OS_CFG_COREPHYSICALID_COUNT + 1] =
{
  ...
  &OsCfg_Hal_Stack_OsCore_Core1_Kernel,
  &OsCfg_Hal_Stack_OsCore_Core2_Kernel,
  NULL_PTR
};
