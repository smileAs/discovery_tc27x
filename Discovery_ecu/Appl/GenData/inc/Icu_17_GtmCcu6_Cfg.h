...
#define ICU_MAX_EDGE_DETECT_QM_CCU6_CHANNELS  (1U)
#define ICU_MAX_EDGE_DETECT_QM_ERU_CHANNELS  (1U)
...
#define ICU_MAX_QM_GTM_CHANNELS   (0U)
 
#define ICU_MAX_QM_CCU6_CHANNELS          (1U)

#define ICU_MAX_QM_ERU_CHANNELS          (1U)
    
#define ICU_MAX_QM_CHANNELS          (2U)
...
#ifndef IcuConf_IcuChannel_IcuChannel
#define IcuConf_IcuChannel_IcuChannel          ((Icu_17_GtmCcu6_ChannelType)0)
#endif

#ifndef IcuConf_IcuChannel_IcuChannel_001
#define IcuConf_IcuChannel_IcuChannel_001          ((Icu_17_GtmCcu6_ChannelType)1)
#endif
...
#define ICU_QM_CCU6_SIGEDGE_USED     (STD_ON)
...
*/
#define ICU_ERU_SIGEDGE_USED     (STD_ON)
/*
Configuration:ICU_ERU_SIGEDGE_USED (Vendor Specific)
