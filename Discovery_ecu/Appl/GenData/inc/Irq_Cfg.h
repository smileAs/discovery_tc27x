...
#define IRQ_QSPI2_RX_TOS            (IRQ_TOS_CPU1)
...
/* Macro for Dma_Irq.c*/
#define IRQ_DMA_CHANNEL0_USED        (IRQ_DMA_USED_MCALSPI_TX)
#define IRQ_DMA_CHANNEL0_PARAM       (0U)
#define IRQ_DMA_CHANNEL1_USED        (IRQ_DMA_USED_MCALSPI_RX)
...
#define IRQ_DMA_CHANNEL5_USED        (IRQ_DMA_USED_MCALSPI_RX)
#define IRQ_DMA_CHANNEL5_PARAM       (2U)
#define IRQ_DMA_CHANNEL6_USED        (IRQ_DMA_USED_MCALSPI_TX)
#define IRQ_DMA_CHANNEL6_PARAM       (3U)
#define IRQ_DMA_CHANNEL7_USED        (IRQ_DMA_USED_MCALSPI_RX)
...
#define IRQ_ASCLIN_CHANNEL3_USED      (IRQ_ASCLIN_AVAILABLE)
