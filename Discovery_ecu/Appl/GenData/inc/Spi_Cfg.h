...
*/
#define SPI_MAXIMUM_SEQUENCE (4U)
...
/* The generated macro may exceeds 31 characters to follow Autosar naming
   conventions*/
#define SpiConf_SpiJob_SpiJobPMIC ((Spi_JobType)0U)
/* The generated macro may exceeds 31 characters to follow Autosar naming
   conventions*/
#define SpiConf_SpiJob_SpiJobRTK ((Spi_JobType)1U)
/* The generated macro may exceeds 31 characters to follow Autosar naming
   conventions*/
#define SpiConf_SpiJob_SpiJobSOC ((Spi_JobType)2U)
/* The generated macro may exceeds 31 characters to follow Autosar naming
   conventions*/
#define SpiConf_SpiJob_SpiJobSD ((Spi_JobType)3U)
/*
Configuration Options:
...
/* The generated macro may exceeds 31 characters to follow Autosar naming
   conventions*/
#define SpiConf_SpiSequence_SpiSequencePMIC ((Spi_SequenceType)0U)
/* The generated macro may exceeds 31 characters to follow Autosar naming
   conventions*/
#define SpiConf_SpiSequence_SpiSequenceRTK ((Spi_SequenceType)1U)
/* The generated macro may exceeds 31 characters to follow Autosar naming
   conventions*/
#define SpiConf_SpiSequence_SpiSequenceSOC ((Spi_SequenceType)2U)
/* The generated macro may exceeds 31 characters to follow Autosar naming
   conventions*/
#define SpiConf_SpiSequence_SpiSequenceSD ((Spi_SequenceType)3U)
...
MRSTxB : 1
*/
#define SPI_QSPI0_MRIS_SEL (1U)
#define SPI_QSPI1_MRIS_SEL (0U)
#define SPI_QSPI2_MRIS_SEL (3U)
...
#define SPI_QSPI2_HWTYPE  (SYNC_BUS)
...
*/
#define IRQ_QSPI0_DMA_TX_OR_ERR_PRIO (IRQ_DMA_CHANNEL0_SR_PRIO)
#define IRQ_QSPI0_DMA_RX_OR_ERR_PRIO (IRQ_DMA_CHANNEL1_SR_PRIO)
#define IRQ_QSPI1_DMA_TX_OR_ERR_PRIO (IRQ_DMA_CHANNEL2_SR_PRIO)
#define IRQ_QSPI1_DMA_RX_OR_ERR_PRIO (IRQ_DMA_CHANNEL3_SR_PRIO)
#define IRQ_QSPI2_DMA_TX_OR_ERR_PRIO (IRQ_DMA_CHANNEL4_SR_PRIO)
#define IRQ_QSPI2_DMA_RX_OR_ERR_PRIO (IRQ_DMA_CHANNEL5_SR_PRIO)
#define IRQ_QSPI3_DMA_TX_OR_ERR_PRIO (IRQ_DMA_CHANNEL6_SR_PRIO)
#define IRQ_QSPI3_DMA_RX_OR_ERR_PRIO (IRQ_DMA_CHANNEL7_SR_PRIO)
/*
  Transmit and Receive Dma Channel IRQ CAT.
*/
#define IRQ_QSPI0_DMA_TX_OR_ERR_CAT (IRQ_DMA_CHANNEL0_SR_CAT)
#define IRQ_QSPI0_DMA_RX_OR_ERR_CAT (IRQ_DMA_CHANNEL1_SR_CAT)
#define IRQ_QSPI1_DMA_TX_OR_ERR_CAT (IRQ_DMA_CHANNEL2_SR_CAT)
#define IRQ_QSPI1_DMA_RX_OR_ERR_CAT (IRQ_DMA_CHANNEL3_SR_CAT)
#define IRQ_QSPI2_DMA_TX_OR_ERR_CAT (IRQ_DMA_CHANNEL4_SR_CAT)
#define IRQ_QSPI2_DMA_RX_OR_ERR_CAT (IRQ_DMA_CHANNEL5_SR_CAT)
#define IRQ_QSPI3_DMA_TX_OR_ERR_CAT (IRQ_DMA_CHANNEL6_SR_CAT)
#define IRQ_QSPI3_DMA_RX_OR_ERR_CAT (IRQ_DMA_CHANNEL7_SR_CAT)
